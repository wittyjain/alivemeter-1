        ...
        <div class="dvWrapper">
          <div style=" padding:0px 0px 35px 0px">
           <div class="health_dashboard_div_left" style="padding-top:25px;">
              <div class="dvFloat">
                <div style="float:left; padding:0px 0px 10px 0px;"> <a href="health_dash_board_medication.html"><img src="images/nutritionist/medication_h.jpg" alt=""></a> </div>
              </div>
              <div class="dvFloat">
              ...
              <div  style="width:99%; border:solid 0px red;">
                ...
                <div class="dvFloat formpadding1">
                  <table cellpadding="0" cellspacing="0"  style="width:100%" >
                    ...
                    <tr>
                       <td class="tdborder" style="padding-left:20px;">Crocin Cough Syrup </td>
                       <td class="tdborder" style="padding-left:20px;">1 spoon</td>
                       <td class="tdborder" style="padding-left:20px;">4</td>
                       <td class="tdborder" style="padding-left:20px;">yes </td>
                       <td class="tdborder" style="padding-left:20px;">yes </td>
                       <td class="tdborder" style="padding-left:20px;">ok</td>
                       <td class="tdborder" style="padding-left:20px;"><table cellpadding="0" cellspacing="0"  style="width:100%" >
                ...
                <div class="dvFloat formpadding1" style="padding:10px 0px 5px 0px; border-bottom: solid 1px #e1e1e1;"> <a onClick="showform();" style="cursor:pointer"><img src="images/nutritionist/add_to_list.jpg" alt=""></a> </div>
                    <div id="divShowHideForm" style="display: none">
                <div class="dvFloat formpadding1">
                  <div class="formlabelHDB1">
                    <label class="formlabelHDB">Medicine<span class="redtxt">*</span> </label>
                  </div>
                  <div class="formcontrol2">
                    <input type="text" name="txt_HD_Medicine" id="txt_HD_Medicine" value="" />
                  </div>
                </div>
                <div class="dvFloat formpadding1">
                  <div class="formlabelHDB1">
                    <label class="formlabelHDB">Dosage<span class="redtxt">*</span> </label>
                  </div>
                  <div class="formcontrol2">
                    <input type="text" name="txt_HD_Dosage" id="txt_HD_Dosage" value="" />
                  </div>
                </div>
                <div class="dvFloat formpadding1">
                  <div class="formlabelHDB1">
                    <label class="formlabelHDB">Duration <span class="redtxt">*</span> </label>
                  </div>
                  <div class="formcontrol2">
                    <input type="text" name="txt_HD_Duration" id="txt_HD_Duration " value="" />
                    <div class="div_input_text1" style="font-size: 12px;">(days/ week) </div>
                  </div>
                </div>
                <div class="dvFloat formpadding1">
                  <div class="formlabelHDB1">
                    <label class="formlabelHDB">Currently Taking this Medicine<span class="redtxt">*</span> </label>
                  </div>
                  <div class="formcontrol2">
                    <input type="text" name="txt_HD_Currently_Medicine" id="txt_HD_Currently_Medicine " value="" />
                  </div>
                </div>
                <div class="dvFloat formpadding1">
                  <div class="formlabelHDB1">
                    <label class="formlabelHDB">Followed Prescription<span class="redtxt">*</span> </label>
                  </div>
                  <div class="formcontrol2">
                    <input type="text" name="txt_HD_Followed_Prescription" id="txt_HD_Followed_Prescription" value="" />
                  </div>
                </div>
                <div class="dvFloat formpadding1">
                  <div class="formlabelHDB1">
                    <label class="formlabelHDB">Health Problem<span class="redtxt">*</span> </label>
                  </div>
                  <div class="formcontrol2">
                    <input type="text" name="txt_HD_Health_Problem" id="txt_HD_Health_Problem " value="" />
                  </div>
                </div>
                <div class="dvFloat formpadding1">
                  <div class="formlabelHDB1">
                    <label class="formlabelHDB">Instruction For Medicine </label>
                  </div>
                  <div class="formcontrol2">
                    <textarea id="txt_HD_Instruction_For_Medicine" name="txt_HD_Instruction_For_Medicine"></textarea>
                  </div>
                </div>
                <div class="dvFloat formpadding1">
                  <div class="formlabelHDB1">
                ...
                <div id="divIntake_Reminder" style="display:none ">
                    ...
                    <div class="formcontrol2">
                      <div class="dvFloat">
                        <div style="float:left; padding:0px 15px 0px 0px">
                          <select id="cmb_HD_Intake_Reminder_Start_Date" name="cmb_HD_Intake_Reminder_Start_Date" tabindex="1" class="existing_event" style="width: 0px;">
                        ...
                        <div style="float:left; padding:0px 15px 0px 0px">
                          <select id="cmb_HD_Intake_Reminder_Start_Month" name="cmb_HD_Intake_Reminder_Start_Month" tabindex="1" class="existing_event" style="width: 0px;">
                  ...
                  <div class="dvFloat formpadding1">
                    ...
                    <div class="formcontrol2">
                      <div class="dvFloat">
                        <div style="float:left; padding:0px 15px 0px 0px">
                          <select id="cmb_HD_Intake_Reminder_End_Date" name="cmb_HD_Intake_Reminder_End_Date" tabindex="1" class="existing_event" style="width: 0px;">
                            <option value="DD">DD</option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                        ...
                        <div style="float:left; padding:0px 15px 0px 0px">
                          <select id="cmb_HD_Intake_Reminder_End_Month" name="cmb_HD_Intake_Reminder_End_Month" tabindex="1" class="existing_event" style="width: 0px;">
                            <option value="MM">MM</option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                      ...
                      <div class="formcontrol2">
                        <div class="dvFloat">
                          <div style="float:left; padding:0px 5px 0px 0px">
                            <div style="float:left; padding:0px 5px 0px 0px">
                              <select id="chk_Daily_Frequency_HH_Morning" name="chk_Daily_Frequency_HH_Morning" tabindex="1" class="existing_event" style="width: 0px;" disabled>
                                <option value="HH">HH</option>
                              </select>
                            </div>
                            <div style="float:left; padding:0px 5px 0px 0px">
                              <select id="chk_Daily_Frequency_Min_Morning" name="chk_Daily_Frequency_Min_Morning"  tabindex="1" class="existing_event" style="width: 0px;" disabled>
                          ...
                          <div style="float:left; padding:0px 5px 0px 0px">
                            <div style="float:left; padding:0px 5px 0px 0px">
                              <select id="chk_Daily_Frequency_HH_Afternoon" name="chk_Daily_Frequency_HH_Afternoon"  tabindex="1" class="existing_event" style="width: 0px;" disabled>
                                <option value="HH">HH</option>
                              </select>
                            </div>
                            <div style="float:left; padding:0px 5px 0px 0px">
                              <select id="chk_Daily_Frequency_Min_Afternoon" title="chk_Daily_Frequency_Min_Afternoon"  tabindex="1" class="existing_event" style="width: 0px;" disabled>
                                <option value="Min">Min</option>
                              </select>
                            </div>
                          </div>
                          <div style="float:left; padding:0px 5px 0px 0px">
                            <div style="float:left; padding:0px 5px 0px 0px">
                              <select id="chk_Daily_Frequency_HH_Evening" title="chk_Daily_Frequency_HH_Evening"  tabindex="1" class="existing_event" style="width: 0px;" disabled>
                                <option value="HH">HH</option>
                              </select>
                            </div>
                            <div style="float:left; padding:0px 5px 0px 0px">
                              <select id="chk_Daily_Frequency_Min_Evening" name="chk_Daily_Frequency_Min_Evening" tabindex="1" class="existing_event" style="width: 0px;" disabled>
                                <option value="Min">Min</option>
                              </select>
                            </div>
                          </div>
                          <div style="float:left; padding:0px 5px 0px 0px">
                            <div style="float:left; padding:0px 5px 0px 0px">
                              <select id="chk_Daily_Frequency_HH_Night" name="chk_Daily_Frequency_HH_Night"  tabindex="1" class="existing_event" style="width: 0px;" disabled>
                                <option value="HH">HH</option>
                              </select>
                            </div>
                            <div style="float:left; padding:0px 5px 0px 0px">
                              <select id="chk_Daily_Frequency_Min_Night" name="chk_Daily_Frequency_Min_Night" tabindex="1" class="existing_event" style="width: 0px;" disabled>
                                <option value="Min">Min</option>
                              </select>
                            </div>
                          </div>
                ...
                <div id="divPurchase_Reminder" style="display:none ">
                  <div class="dvFloat formpadding1">
                    ...
                    <div class="formcontrol2">
                      <div class="dvFloat">
                        <div style="float:left; padding:0px 15px 0px 0px">
                          <select id="cmb_HD_Purchase_Reminder_Date" name="cmb_HD_Purchase_Reminder_Date"  tabindex="1" class="existing_event" style="width: 0px;">
                            <option value="DD">DD</option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                        ...
                        <div style="float:left; padding:0px 15px 0px 0px">
                          <select id="cmb_HD_Purchase_Reminder_Month" name="cmb_HD_Purchase_Reminder_Month"  tabindex="1" class="existing_event" style="width: 0px;">
                            <option value="MM">MM</option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
