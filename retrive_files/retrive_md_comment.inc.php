...
<?php
	...
	if($nume1 !="0")
	{
		...
		$pagingLink1 = getPagingLinkBackEndFrontEnd($nume1,$page_count,'dir=listing/grid_view',$newpagenumber1,$strHostName."/page.php");
	}
...
<center>
  ...
  <div class="DvFloat" style="margin-bottom:30px;">
          ...
          <tbody>
            ...
            <?php 
			$page=1;$page_count=5;$newpagenumber="2"; $nume="25";
           ...
           <?php if(isset($_SESSION['UserDocID'])) { ?>
            <tr>
                  <td colspan="6" style="text-align:right; padding:10px 0;"><a href="<?php echo $strHostName;?>/page_doctor.php?dir=doctor/md_comments&patient_id=<?php echo $converter->encode($_GET['patient_id']);?>" class="button4" style="width:200px; text-align:center; float:right;" target="_blank">View All MD Comments </a></td>
       		 </tr>
        
        <?php } else { ?>
        
         <tr>
                  <td colspan="6" style="text-align:right; padding:10px 0;"><a href="<?php echo $strHostName;?>/page_doctor.php?dir=md/md_comments&patient_id=<?php echo $converter->encode($_GET['patient_id']);?>" class="button4" style="width:200px; text-align:center; float:right;" target="_blank">View All MD Comments </a></td>
       		 </tr>
        <?php } ?>
