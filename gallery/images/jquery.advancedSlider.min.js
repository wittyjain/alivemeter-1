...
a.settings.autoToggle&&Eb()},function(){ea=false;a.settings.autoToggle&&Fb();if(a.settings.timerAnimation&&a.settings.timerToggle&&T!="stopped"&&!U){var c=s.find(".timer-animation");w?c.hide():c.stop().animate({opacity:1},a.settings.timerFadeDuration)}if(Ia&&a.settings.lightboxIconToggle){c=u.find(".lightbox-icon");w?c.css("opacity",0):c.stop().animate({opacity:1},a.settings.lightboxIconFadeDuration)}a.settings.pauseSlideshowOnHover&&!Aa&&!sb&&!N&&Ba();ua&&a.settings.captionToggle&&tb();if(a.settings.slideArrows&&
a.settings.slideArrowsToggle)w?s.find(".slide-arrows a").stop().hide():s.find(".slide-arrows a").stop().animate({opacity:1},a.settings.slideArrowsHideDuration);if(a.settings.slideshowControls&&a.settings.slideshowControlsToggle)w?s.find(".slideshow-controls").stop().hide():s.find(".slideshow-controls").stop().animate({opacity:0},a.settings.slideshowControlsHideDuration)});a.settings.border||u.css("border","none");a.settings.glow||u.css({"box-shadow":"none","-moz-box-shadow":"none","-webkit-box-shadow":"none"});
...
"hidden");a.settings.slideArrows&&u.find(".slide-arrows").css("visibility","visible");a.settings.slideButtons&&s.find(".slide-buttons").css("visibility","hidden");a.settings.slideshowControls&&u.find(".slideshow-controls").css("visibility","hidden");a.settings.lightboxIcon&&u.find(".lightbox-icon").css("visibility","hidden");if(a.settings.thumbnailType=="scroller"||a.settings.thumbnailType=="tooltipAndScroller")s.find(".thumbnail-scroller").css("visibility","hidden")}else{a.settings.timerAnimation&&
