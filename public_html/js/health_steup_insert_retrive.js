function RetriveReocrds_Main(pageURL,dvName,pageno)
{
	...
	if (pageURL=="Doctor_Comment_Ins")
	{
		...
		pageURL=hostname+"/retrive_files/retrive_doctor_comment.inc.php?patient_id="+document.getElementById("txtPatientID").value+"&page="+pageno;
	}
	if (pageURL=="MD_Comment_Ins")
	{
		//alert (document.getElementById("txtPatientID").value);
		pageURL=hostname+"/retrive_files/retrive_md_comment.inc.php?patient_id="+document.getElementById("txtPatientID").value+"&page="+pageno;
	}
	...
	if (pageURL=="Post_Comment")
	{
		...
		(document.getElementById("txtArticleId").value);
	...
	if (pageURL=="User_Reviews")
	{
		...
		pageURL=hostname+"/retrive_files/retrive_user_reviews.inc.php?cid="+document.getElementById("txtReviewMailID").value+"&userid="+document.getElementById("txtUserID").value;
	}
...
function RetriveReocrds_DailyTracking(type,dvName)
{
	...
	xmlhttp.onreadystatechange=function()
	{
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200)
		{
			if(document.getElementById(dvName)==null)
			{
...
function uploadFile(MainForm) {
		
		
		var fd = new FormData(); //$('#form1').serialize(); //
		var ufType= document.getElementById('txt_Type').value;
		...
		if (ufType=="Allergies")
		{
			var RandomID=document.getElementById('txt_Random_ID_all').value;
		...
		{		
			if (ufType=="Allergies")
			{
				RandomID =document.getElementById("txt_Random_ID1_all").value;
				//alert(RandomID);
				document.getElementById("txt_Random_ID_all").value=document.getElementById("txt_Random_ID1_all").value;
				//document.getElementById("imgLoader").style.display="";
			}
			else
			{
				RandomID =document.getElementById("txt_Random_ID1").value;
				document.getElementById("txt_Random_ID").value=document.getElementById("txt_Random_ID1").value;
				//document.getElementById("imgLoader").style.display="";
			}
		}
		else
		{
			if (ufType=="Allergies")
			{
				document.getElementById("txt_Random_ID1_all").value=document.getElementById("txt_Random_ID_all").value;
			}
			else
			{
	...
	//alert ("a"+RandomID);
			...
			if (xmlhttp.readyState == 4 && xmlhttp.status == 200)
			{
				...
				//return false;
				 if (Type=="Main")
				 {
					...
					// alert (document.getElementById("cmb_Prescription_Reports_Doc_pres").value);
					 
					 if(document.getElementById("cmb_Prescription_Reports_Doc_pres").value=="3")
					 {
						 redirectURL(hostname+"/page.php?dir=health/radiology_report");
					 }
					 
					  if( document.getElementById("cmb_Prescription_Reports_Doc_pres").value=="2")
					 {
						 redirectURL(hostname+"/page.php?dir=health/lab_report");
					 }
		...
		document.getElementById("aViewFile" ).innerHTML="";
		document.getElementById("dvViewFile" ).value="";
...
//alert (document.getElementById('txt_Type').value);
		...
		xmlhttp.open("POST", hostname+"/includes/upload_files.inc.php?Type="+Type+"&RandomID="+RandomID);
		xmlhttp.send(fd);
...
function checkduplication(type, row)
{
		...
		if (type=="Blood_Pressure")
		{
				...
				{
					alert ("Enter your blood pressure result in this format (80/100).");
...
function Doc_Consult_Ins(row)
{
	...
	{
		alert ("Enter consulted doctor name.");
	...
	document.getElementById("dvTotalReports").innerHTML="0";
	...
	var alivem="http://"+ location.host+"";
	
	var hurl=alivem+"/page.php?dir=health/prescription";
...
function Medication_Ins(row)
{
	...
	{
		alert ("Enter dosage as per suggested format.");
	...
	{
		alert ("Enter duration of medicine intake.");
	...
	if(document.getElementById("Chk_MD_Daily_Frequency_Morning").checked==true){
			...
			if(document.getElementById("Chk_MD_Daily_Frequency_HH_Morning").value=="0")
			{
				alert ("Please enter morning daily frequency hours.");
				document.getElementById("Chk_MD_Daily_Frequency_HH_Morning").focus();
				return false;
			}
			
			if(document.getElementById("Chk_MD_Daily_Frequency_Min_Morning").value=="Min")
			{	
				alert ("Please enter morning daily frequency minutes.");
				document.getElementById("Chk_MD_Daily_Frequency_Min_Morning").focus();
				return false;
			}
	 ...
	 if(document.getElementById("Chk_MD_Daily_Frequency_Afternoon").checked==true){
			...
			//	document.getElementById("Chk_MD_Daily_Frequency_Min_Afternoon").style.opacity="1.0";
				...
				if(document.getElementById("Chk_MD_Daily_Frequency_HH_Afternoon").value=="0")
				{
					alert ("Please enter afternoon daily frequency hours.");
					document.getElementById("Chk_MD_Daily_Frequency_HH_Afternoon").focus();
					return false;
				}
				
				if(document.getElementById("Chk_MD_Daily_Frequency_Min_Afternoon").value=="Min")
				{
					alert ("Please enter afternoon daily frequency minutes.");
					document.getElementById("Chk_MD_Daily_Frequency_Min_Afternoon").focus();
					return false;
				}
	...
	if(document.getElementById("Chk_MD_Daily_Frequency_Evening").checked==true){
				...
				if(document.getElementById("Chk_MD_Daily_Frequency_HH_Evening").value=="0")
				{
					alert ("Please enter evening daily frequency hours.");
					document.getElementById("Chk_MD_Daily_Frequency_HH_Evening").focus();
					return false;
				}
				
				if(document.getElementById("Chk_MD_Daily_Frequency_Min_Evening").value=="Min")
				{
					alert ("Please enter evening daily frequency minutes.");
					document.getElementById("Chk_MD_Daily_Frequency_Min_Evening").focus();
					return false;
				}
...
if(document.getElementById("Chk_MD_Daily_Frequency_Night").checked==true){
			...
			//	document.getElementById("Chk_MD_Daily_Frequency_Min_Night").style.opacity="1.0";
				...
				if(document.getElementById("Chk_MD_Daily_Frequency_HH_Night").value=="0")
				{
					alert ("Please enter night daily frequency hours.");
					document.getElementById("Chk_MD_Daily_Frequency_HH_Night").focus();
					return false;
				}
				
				if(document.getElementById("Chk_MD_Daily_Frequency_Min_Night").value=="Min")
				{
					alert ("Please enter night daily frequency minutes.");
					document.getElementById("Chk_MD_Daily_Frequency_Min_Night").focus();
					return false;
				}
...
//	var purchase_reminder = $( "#Chk_MD_Setup_Purchase_Reminder" ).val();
	...
	document.getElementById("Chk_MD_Daily_Frequency_Min_Morning" ).value="0";
	...
	document.getElementById("cmb_MD_Intake_Reminder_Start_Month" ).value="0";
	document.getElementById("cmb_MD_Intake_Reminder_End_Month" ).value="0";
	document.getElementById("Chk_MD_Daily_Frequency_HH_Morning" ).value="0";
	document.getElementById("Chk_MD_Daily_Frequency_Min_Afternoon" ).value="0";
	...
	var hurl=alivem+"/page.php?dir=health/medication";
...
function ShowReports(id,type)
{
	...
	if (window.XMLHttpRequest)
			...
			{	
				...
				document.getElementById("imgLoader").style.display="none";
				 ...
				 if(id!=""){
					 ...
					 {
						 if(document.getElementById("dvUploadRep")!=null)
						 {
						 	document.getElementById("dvUploadRep" ).style.display="";
						}

						 if(document.getElementById("dvUploadRep1")!=null)
						 {
		...
		xmlhttp.open("GET",hostname+"/includes/show_reports.inc.php?cid="+id+"&type="+type,true);
		xmlhttp.send();
}
		...
		{	
			 ...
			 for (var i = 0; i < data.records.length; ++i) {
				 day=data.records[i].consult_day;
					...
					document.getElementById("txt_Dc_Height" ).value=document.getElementById("txt_Dc_Height" ).value.replace('\\', '');
					
					document.getElementById("txt_Dc_Weight" ).value=data.records[i].weight;	
					document.getElementById("txt_Dc_Weight" ).value=document.getElementById("txt_Dc_Weight" ).value.replace('\\', '');
					
					document.getElementById("txt_Dc_Temperature" ).value=data.records[i].temperature;	
					document.getElementById("txt_Dc_Temperature" ).value=document.getElementById("txt_Dc_Temperature" ).value.replace('\\', '');
					
					document.getElementById("txt_Dc_Pulse" ).value=data.records[i].pulse;
					document.getElementById("txt_Dc_Pulse" ).value=document.getElementById("txt_Dc_Pulse" ).value.replace('\\', '');
					
					document.getElementById("txt_Dc_Blood_Pressure" ).value=data.records[i].blood_pressure;	
					document.getElementById("txt_Dc_Blood_Pressure" ).value=document.getElementById("txt_Dc_Blood_Pressure" ).value.replace('\\', '');
					
					document.getElementById("txt_Dc_Breathing_Rate" ).value=data.records[i].breathing_rate;	
					document.getElementById("txt_Dc_Breathing_Rate" ).value=document.getElementById("txt_Dc_Breathing_Rate" ).value.replace('\\', '');
					
					document.getElementById("txt_Dc_Body_Mass_index" ).value=data.records[i].body_mass_index;
					document.getElementById("txt_Dc_Body_Mass_index" ).value=document.getElementById("txt_Dc_Body_Mass_index" ).value.replace('\\', '');
					
					document.getElementById("txt_Dc_Resting_Heart_Rate" ).value=data.records[i].resting_heart_rate;
					document.getElementById("txt_Dc_Resting_Heart_Rate" ).value=document.getElementById("txt_Dc_Resting_Heart_Rate" ).value.replace('\\', '');
					
					document.getElementById("txt_Dc_Note" ).value=data.records[i].notes;
					document.getElementById("txt_Dc_Note" ).value=document.getElementById("txt_Dc_Note" ).value.replace('\\', '');
					
					document.getElementById("txt_Dc_Health_Problem" ).value=data.records[i].health_problem;
					document.getElementById("txt_Dc_Health_Problem" ).value=document.getElementById("txt_Dc_Health_Problem" ).value.replace('\\', '');
					
					document.getElementById("cmb_Diagnosed_Condition" ).value=data.records[i].diagnosed_cond;	
					document.getElementById("cmb_Diagnosed_Condition" ).value=document.getElementById("cmb_Diagnosed_Condition" ).value.replace('\\', '');
		...
		{	
			 ...
			 for (var i = 0; i < data.records.length; ++i) {
				 day=data.records[i].consult_day;
					...
					document.getElementById("txt_MD_Medicine" ).value=document.getElementById("txt_MD_Medicine" ).value.replace('\\', '');
					
					document.getElementById("txt_MD_Dosage" ).value=data.records[i].dosage;
					document.getElementById("txt_MD_Dosage" ).value=document.getElementById("txt_MD_Dosage" ).value.replace('\\', '');
					
					document.getElementById("txt_MD_Duration" ).value=data.records[i].duration;
					document.getElementById("txt_MD_Duration" ).value=document.getElementById("txt_MD_Duration" ).value.replace('\\', '');
					
					document.getElementById("txt_MD_Health_Problem" ).value=data.records[i].health_problem;	
					document.getElementById("txt_MD_Health_Problem" ).value=document.getElementById("txt_MD_Health_Problem" ).value.replace('\\', '');
					
					document.getElementById("txt_MD_Instruction_For_Medicine" ).value=data.records[i].notes;
					document.getElementById("txt_MD_Instruction_For_Medicine" ).value=document.getElementById("txt_MD_Instruction_For_Medicine" ).value.replace('\\', '');
...
function Allergies_Ins(row)
{
	...
	var random_id = $( "#txt_Random_ID_all" ).val();	
...
//	alert(random_id);
	...
	document.getElementById("txt_AL_Allergic_Status" ).value="0";
...
////	alert ("dfdf");
	...
	var aurl=alivem+"/page.php?dir=health/allergies";
	...
	var d = new Date();
	var n = d.getTime();
	document.getElementById("txt_Random_ID_all" ).value=n*44;		
	document.getElementById("dvUploadGallery1").innerHTML="";
	document.getElementById("dvTotalReports1").innerHTML="0";
	...
	xmlhttp.onreadystatechange=function()
	{
		...
		{	
			 ...
			 for (var i = 0; i < data.records.length; ++i) {
				...
				document.getElementById("txt_AL_Allergicto" ).value=document.getElementById("txt_AL_Allergicto" ).value.replace('\\', '');
				
				document.getElementById("txt_AL_Allergic_Reaction" ).value=data.records[i].reaction;
				document.getElementById("txt_AL_Allergic_Reaction" ).value=document.getElementById("txt_AL_Allergic_Reaction" ).value.replace('\\', '');
				...
				document.getElementById("ShowADiv" ).style.display="";
			...
			document.getElementById("txt_Random_ID_all" ).value=document.getElementById("txt_Allergies_ID" ).value;
			RetriveReocrds_Upload("dvUploadGallery", Type);
...
function Immunization_Ins(row)
{
	...
	var hurl=alivem+"/page.php?dir=health/immunization";
	...
	xmlhttp.onreadystatechange=function()
	{
		...
		{	
			 ...
			 for (var i = 0; i < data.records.length; ++i) {
				...
				document.getElementById("txt_immunization_Name" ).value=document.getElementById("txt_immunization_Name" ).value.replace('\\', '');
...
function Hospital_Ins(row)
{
	...
	///alert (hospitalization_date);
	
	///alert (discharge_date);
	
	if(hospitalization_date > discharge_date)
	{
		alert ("Discharge date should be greater than hospitalization date.");
		document.getElementById("cmb_Hospitalization_Discharge_Date").focus();	
		return false;
	}
	...
	{
		alert ("You cannot choose next date of Hospitalization.");
		document.getElementById("cmb_Hospitalization_Date").focus();	
		return false;
	}
	...
	{
		alert ("You cannot choose next date of discharge.");
		document.getElementById("cmb_Hospitalization_Discharge_Date").focus();	
		return false;
	}
...
*/
	...
	var hurl=alivem+"/page.php?dir=health/hospitalization";
		...
		{	
			 ...
			 for (var i = 0; i < data.records.length; ++i) {
				 day=data.records[i].consult_day;
					 ...
					 document.getElementById("txt_Hospitalization_Hospital_Name" ).value=document.getElementById("txt_Hospitalization_Hospital_Name" ).value.replace('\\', '');
					 ...
					 document.getElementById("ddl_Doc_Consulted_hospital" ).value=data.records[i].doctor_id;	
					  ...
					  document.getElementById("txt_Hospitalization_Reason_of_Admission" ).value=document.getElementById("txt_Hospitalization_Reason_of_Admission" ).value.replace('\\', '');
					  
					  document.getElementById("txt_Hospitalization_Diagnosis" ).value=data.records[i].diagnosis;
					  document.getElementById("txt_Hospitalization_Diagnosis" ).value=document.getElementById("txt_Hospitalization_Diagnosis" ).value.replace('\\', '');
					 ...
					 document.getElementById("txt_Hospitalization_Diagnosis_Summary" ).value=data.records[i].diagnosis_summary ;
					  document.getElementById("txt_Hospitalization_Diagnosis_Summary" ).value=document.getElementById("txt_Hospitalization_Diagnosis_Summary" ).value.replace('\\', '');
					 
					 document.getElementById("txt_Hospitalization_Doctor_Instruction" ).value=data.records[i].doctor_instruction ;
					 document.getElementById("txt_Hospitalization_Doctor_Instruction" ).value=document.getElementById("txt_Hospitalization_Doctor_Instruction" ).value.replace('\\', '');
...
function Family_History_Ins(row)
{
	...
	if(document.getElementById("txt_FamilyHistory_Relation").value=="")
	{
	...
	document.getElementById("txt_FamilyHistory_Relation" ).value="";
		...
		{	
			 ...
			 for (var i = 0; i < data.records.length; ++i) {
				...
				ChangeEditImage(eid,'fam');
				 ...
				 document.getElementById("txt_FamilyHistory_Relation" ).value=document.getElementById("txt_FamilyHistory_Relation" ).value.replace('\\', '');
				 
				 document.getElementById("txt_FamilyHistory_MedicalCondition" ).value=data.records[i].medical_condition;
				 document.getElementById("txt_FamilyHistory_MedicalCondition" ).value=document.getElementById("txt_FamilyHistory_MedicalCondition" ).value.replace('\\', '');
				 
				 document.getElementById("txt_FamilyHistory_CauseDeath" ).value=data.records[i].death_cause;
				 document.getElementById("txt_FamilyHistory_CauseDeath" ).value=document.getElementById("txt_FamilyHistory_CauseDeath" ).value.replace('\\', '');
				 
				 document.getElementById("dvEditFamily" ).style.display="";
				 document.getElementById("ShowFDiv" ).style.display="";
		 		 //document.getElementById("rededitbtnfamily"+eid).style.display="";
				 //document.getElementById("editbtnfamily"+eid).style.display="none";
				
				if(document.getElementById("dvFamilyNA" )!=null)
				{
					 document.getElementById("dvFamilyNA" ).style.display="none";
				}
				
				if(document.getElementById("dvFamilyNA1" )!=null)
				{
...
function Blood_Pressure_Ins(row)
{
	...
	document.getElementById("cmb_DelTrack_Day" ).value="0";
	document.getElementById("cmb_DelTrack_Month" ).value="0";
	document.getElementById("cmb_DelTrack_Year" ).value="0";
	...
	var alivem="http://"+ location.host+"";
	var hurl=alivem+"/page.php?dir=health/daily_tracking";
	...
	xmlhttp.onreadystatechange=function()
	{
		...
		{	
			 ...
			 for (var i = 0; i < data.records.length; ++i) {
				 ...
				 document.getElementById("txt_DelTrack_Unit" ).value=document.getElementById("txt_DelTrack_Unit" ).value.replace('\\', '');
...
function Life_Style_Ins(row)
{
	...
	var spirit_goal = $( "#txt_LSSpirit_Goal" ).val();
	
	var beer = $( "#txt_LSBeer" ).val();
	var beer_goal = $( "#txt_LSBeer_Goal" ).val();
	
	var cigarette = $( "#txt_LSCigarette" ).val();
	var cigarette_goal = $( "#txt_LSCigarette_Goal" ).val();
	
	var life_style_sleep = $( "#txt_LSSleep" ).val();
	var life_style_sleep_goal = $( "#txt_LSSleep_Goal" ).val();
	...
	var url_param="life_style_id="+life_style_id+"&spirit="+spirit+"&spirit_goal="+spirit_goal+"&beer="+beer+"&beer_goal="+beer_goal+"&cigarette_goal="+cigarette_goal+"&cigarette="+cigarette+"&life_style_sleep="+life_style_sleep+"&life_style_sleep_goal="+life_style_sleep_goal+"&physical_stress="+physical_stress+"&physical_stress_details="+physical_stress_details+"&mental_stress="+mental_stress+"&mental_stress_details="+mental_stress_details+"&life_style_day="+life_style_day+"&life_style_month="+life_style_month+"&life_style_year="+life_style_year+"&insert_type=Life_Style_Ins";
	...
	.done(function(data) {
			...
			if(document.getElementById("Dashboard_LifeStyle" )!=null)
			{
				SetLifeStyleGoal('');
			}
			else
	...
	{		
		...
		document.getElementById("txt_LSSpirit_Goal" ).value="";
		document.getElementById("txt_LSBeer_Goal" ).value="";
		document.getElementById("txt_LSCigarette_Goal" ).value="";
		document.getElementById("txt_LSSleep_Goal" ).value="";
		
		document.getElementById("txt_LSPhysicalStress" ).value="0";
		document.getElementById("txt_LSPhysicalStresstxt" ).value="";
		document.getElementById("txt_LSMentalStress" ).value="0";
		document.getElementById("txt_LSMentalStresstxt" ).value="";
		document.getElementById("Date_LS_Day" ).value="0";
		document.getElementById("Date_LS_Month" ).value="0";
		document.getElementById("Date_LS_Year" ).value="0";
	...
	document.getElementById("txt_LSSpirit" ).focus();
	
	
	
	var alivem="http://"+ location.host+"";
	
	var hurl=alivem+"/page.php?dir=daily_tracking/lifestyle";
...
function SetLifeStyleGoal(type)
{
	  if (window.XMLHttpRequest)
		{// for IE7+, Firefox, Chrome, Opera, Safaricodes
			xmlhttp = new XMLHttpRequest();
			...
			if (xmlhttp.readyState == 4 && xmlhttp.status == 200)
				...
				///	 alert (message);
					...
					if(message[0].trim()=="true") {
						//alert("success");
						document.getElementById("txt_LSSpirit_Goal" ).value=message[1];
						document.getElementById("txt_LSBeer_Goal" ).value=message[2];
						document.getElementById("txt_LSCigarette_Goal" ).value=message[3];
						document.getElementById("txt_LSSleep_Goal" ).value=message[4];
					}
	 ...
	 xmlhttp.open("GET",hostname+"/includes/life_style_goal.inc.php", true);
	 xmlhttp.send();
}
	...
	xmlhttp.onreadystatechange=function()
	{
		...
		{	
			 ...
			 for (var i = 0; i < data.records.length; ++i) {
				...
				document.getElementById("txt_LSSpirit" ).value=document.getElementById("txt_LSSpirit" ).value.replace('\\', '');
				
				document.getElementById("txt_LSBeer" ).value=data.records[i].beer;
				document.getElementById("txt_LSBeer" ).value=document.getElementById("txt_LSBeer" ).value.replace('\\', '');
				
				document.getElementById("txt_LSCigarette" ).value=data.records[i].cigarette;
				document.getElementById("txt_LSCigarette" ).value=document.getElementById("txt_LSCigarette" ).value.replace('\\', '');
				
				document.getElementById("txt_LSSleep" ).value=data.records[i].life_style_sleep;
				document.getElementById("txt_LSSleep" ).value=document.getElementById("txt_LSSleep" ).value.replace('\\', '');
				
				document.getElementById("txt_LSSpirit_Goal" ).value=data.records[i].spirit_goal;
				document.getElementById("txt_LSSpirit_Goal" ).value=document.getElementById("txt_LSSpirit_Goal" ).value.replace('\\', '');
				
				document.getElementById("txt_LSBeer_Goal" ).value=data.records[i].beer_goal;
				document.getElementById("txt_LSBeer_Goal" ).value=document.getElementById("txt_LSBeer_Goal" ).value.replace('\\', '');
				
				document.getElementById("txt_LSCigarette_Goal" ).value=data.records[i].cigarette_goal;
				document.getElementById("txt_LSCigarette_Goal" ).value=document.getElementById("txt_LSCigarette_Goal" ).value.replace('\\', '');
				
				document.getElementById("txt_LSSleep_Goal" ).value=data.records[i].life_style_sleep_goal;
				document.getElementById("txt_LSSleep_Goal" ).value=document.getElementById("txt_LSSleep_Goal" ).value.replace('\\', '');
				...
				document.getElementById("txt_LSPhysicalStresstxt" ).value=document.getElementById("txt_LSPhysicalStresstxt" ).value.replace('\\', '');
				...
				document.getElementById("txt_LSMentalStresstxt" ).value=document.getElementById("txt_LSMentalStresstxt" ).value.replace('\\', '');
...
$(document).ready(function() {
	...
	////alert (url_param);
		...
		///	alert (HID);
			...
			document.getElementById("cardiacProblemsYes" ).focus();
			...
			RetriveReocrds_Main("Health_Problems","dvHealth_Problems")
			 ...
			 var alivem="http://"+ location.host+"";
				...
				var hurl=alivem+"/page.php?dir=health/setup#";
				var durl=alivem+"/page.php?dir=health/health_problems";
				...
				else
				{
					...
					document.getElementById("dvEditHealth").style.display="none";
				   document.getElementById("ShowHPDiv").style.display="";
				   
				   
				   if(document.getElementById("HideHPDivLink" )!=null)
					{
				   		document.getElementById("HideHPDivLink").style.display="none";
					}
					
					
					if(document.getElementById("ShowHPDivLink" )!=null)
					{
...
console.log(url_param);
	...
	//alert("Record saved successfully.");
	document.getElementById("DT_FBS_Date" ).focus();
	
	
	var alivem="http://"+ location.host+"";
	
	var hurl=alivem+"/page.php?dir=daily_tracking/sugar_profile";
	...
	xmlhttp.onreadystatechange=function()
	{
		...
		{	
			 ...
			 for (var i = 0; i < data.records.length; ++i) {
				...
				document.getElementById("txt_Result_FBS" ).value=document.getElementById("txt_Result_FBS" ).value.replace('\\', '');
				
				document.getElementById("txt_Result_PPBS" ).value=data.records[i].post_parandial_result;
				document.getElementById("txt_Result_PPBS" ).value=document.getElementById("txt_Result_PPBS" ).value.replace('\\', '');
				
				document.getElementById("txt_Result_UBS" ).value=data.records[i].urine_blood_result;	
				document.getElementById("txt_Result_UBS" ).value=document.getElementById("txt_Result_UBS" ).value.replace('\\', '');
				
				document.getElementById("txt_Result_RBS" ).value=data.records[i].random_blood_sugar_result;	
				document.getElementById("txt_Result_RBS" ).value=document.getElementById("txt_Result_RBS" ).value.replace('\\', '');
				
				document.getElementById("txt_Range_FBS" ).value=data.records[i].fasting_blood_sugar_range;		
				document.getElementById("txt_Range_FBS" ).value=document.getElementById("txt_Range_FBS" ).value.replace('\\', '');
				
				document.getElementById("txt_Range_FBS1" ).value=data.records[i].fasting_blood_sugar_range1;		
				document.getElementById("txt_Range_FBS1" ).value=document.getElementById("txt_Range_FBS1" ).value.replace('\\', '');
				
				document.getElementById("txt_Range_PPBS" ).value=data.records[i].post_parandial_range;		
				document.getElementById("txt_Range_PPBS" ).value=document.getElementById("txt_Range_PPBS" ).value.replace('\\', '');
				
				document.getElementById("txt_Range_PPBS1" ).value=data.records[i].post_parandial_range1;		
				document.getElementById("txt_Range_PPBS1" ).value=document.getElementById("txt_Range_PPBS1" ).value.replace('\\', '');
				
				document.getElementById("txt_Range_UBS" ).value=data.records[i].urine_blood_range;		
				document.getElementById("txt_Range_UBS" ).value=document.getElementById("txt_Range_UBS" ).value.replace('\\', '');
				
				document.getElementById("txt_Range_UBS1" ).value=data.records[i].urine_blood_range1;			
				document.getElementById("txt_Range_UBS1" ).value=document.getElementById("txt_Range_UBS1" ).value.replace('\\', '');
				
				document.getElementById("txt_Range_RBS" ).value=data.records[i].random_blood_sugar_range;		
				document.getElementById("txt_Range_RBS" ).value=document.getElementById("txt_Range_RBS" ).value.replace('\\', '');
				
				document.getElementById("txt_Range_RBS1" ).value=data.records[i].random_blood_sugar_range1;	
				document.getElementById("txt_Range_RBS1" ).value=document.getElementById("txt_Range_RBS1" ).value.replace('\\', '');
				
				document.getElementById("txt_Unit_FBS" ).value=data.records[i].fasting_blood_sugar_unit;		
				document.getElementById("txt_Unit_FBS" ).value=document.getElementById("txt_Unit_FBS" ).value.replace('\\', '');
				
				document.getElementById("txt_Unit_PPBS" ).value=data.records[i].post_parandial_unit;		
				document.getElementById("txt_Unit_PPBS" ).value=document.getElementById("txt_Unit_PPBS" ).value.replace('\\', '');
				
				document.getElementById("txt_Unit_UBS" ).value=data.records[i].urine_blood_unit;		
				document.getElementById("txt_Unit_UBS" ).value=document.getElementById("txt_Unit_UBS" ).value.replace('\\', '');
				
				document.getElementById("txt_Unit_RBS" ).value=data.records[i].random_blood_sugar_unit;		
				document.getElementById("txt_Unit_RBS" ).value=document.getElementById("txt_Unit_RBS" ).value.replace('\\', '');
				
				document.getElementById("dvEditSugar" ).style.display="";
				document.getElementById("ShowSDiv" ).style.display="";

				//document.getElementById("rededitbtnSugar"+eid).style.display="";
				//document.getElementById("editbtnSugar"+eid).style.display="none"; 
				
				if(document.getElementById("dvSugarProfileNA" )!=null)
				 {
					 	document.getElementById("dvSugarProfileNA" ).style.display="none";
				 }
				 
				 if(document.getElementById("dvSugarProfileNA1" )!=null)
				 {
...
function Lipid_Profile_Ins(row)
{
	...
	var cholesterol_unit = $( "#txt_Unit_Cholesterol" ).val();	
			...
			if(ldl_day=="0" || hdl_day=="0" || cholesterol_day=="0"|| triglyceride_blood_sugar_day=="0"|| triglyceride_blood_sugar_month=="0"|| ldl_month=="0"|| cholesterol_month=="0"|| hdl_month=="0"|| triglyceride_blood_sugar_year=="0"|| hdl_year=="0"|| ldl_year=="0"|| cholesterol_year=="0" )
			{
				alert ("Please enter atleast one lipid profile date. ");
				return false;
			}
			...
			if(triglyceride_blood_sugar_result=="" && ldl_result=="" && hdl_result=="" && cholesterol_result=="")
			{
				alert ("Please enter atleast one lipid profile result. ");
				return false;
			}
	...
	var hurl=alivem+"/page.php?dir=health/setup#";
	var durl=alivem+"/page.php?dir=daily_tracking/lipid_profile";
...
document.getElementById("Lipid_Triglyceride_Date" ).focus();
	...
	xmlhttp.onreadystatechange=function()
	{
		...
		{	
			 ...
			 for (var i = 0; i < data.records.length; ++i) {
				...
				document.getElementById("txt_Result_Triglyceride" ).value=document.getElementById("txt_Result_Triglyceride" ).value.replace('\\', '');
				
				document.getElementById("txt_Result_LDL" ).value=data.records[i].ldl_result;	
				document.getElementById("txt_Result_LDL" ).value=document.getElementById("txt_Result_LDL" ).value.replace('\\', '');
				
				document.getElementById("txt_Result_HDL" ).value=data.records[i].hdl_result;	
				document.getElementById("txt_Result_HDL" ).value=document.getElementById("txt_Result_HDL" ).value.replace('\\', '');
				
				document.getElementById("txt_Result_Cholesterol" ).value=data.records[i].cholesterol_result;	
				document.getElementById("txt_Result_Cholesterol" ).value=document.getElementById("txt_Result_Cholesterol" ).value.replace('\\', '');
				
				document.getElementById("txt_Range_Triglyceride" ).value=data.records[i].triglyceride_blood_sugar_range;		
				document.getElementById("txt_Range_Triglyceride" ).value=document.getElementById("txt_Range_Triglyceride" ).value.replace('\\', '');
				
				document.getElementById("txt_Range_Triglyceride1" ).value=data.records[i].triglyceride_blood_sugar_range1;		
				document.getElementById("txt_Range_Triglyceride1" ).value=document.getElementById("txt_Range_Triglyceride1" ).value.replace('\\', '');
				
				document.getElementById("txt_Range_LDL" ).value=data.records[i].ldl_range;		
				document.getElementById("txt_Range_LDL" ).value=document.getElementById("txt_Range_LDL" ).value.replace('\\', '');
				
				document.getElementById("txt_Range_LDL1" ).value=data.records[i].ldl_range1;		
				document.getElementById("txt_Range_LDL1" ).value=document.getElementById("txt_Range_LDL1" ).value.replace('\\', '');
				
				document.getElementById("txt_Range_HDL" ).value=data.records[i].hdl_range;		
				document.getElementById("txt_Range_HDL" ).value=document.getElementById("txt_Range_HDL" ).value.replace('\\', '');
				
				document.getElementById("txt_Range_HDL1" ).value=data.records[i].hdl_range1;			
				document.getElementById("txt_Range_HDL1" ).value=document.getElementById("txt_Range_HDL1" ).value.replace('\\', '');
				
				document.getElementById("txt_Range_Cholesterol" ).value=data.records[i].cholesterol_range;		
				document.getElementById("txt_Range_Cholesterol" ).value=document.getElementById("txt_Range_Cholesterol" ).value.replace('\\', '');
				
				document.getElementById("txt_Range_Cholesterol1" ).value=data.records[i].cholesterol_range1;	
				document.getElementById("txt_Range_Cholesterol1" ).value=document.getElementById("txt_Range_Cholesterol1" ).value.replace('\\', '');
				
				document.getElementById("txt_Unit_Triglyceride" ).value=data.records[i].triglyceride_blood_sugar_unit;		
				document.getElementById("txt_Unit_Triglyceride" ).value=document.getElementById("txt_Unit_Triglyceride" ).value.replace('\\', '');
				
				document.getElementById("txt_Unit_LDL" ).value=data.records[i].ldl_unit;		
				document.getElementById("txt_Unit_LDL" ).value=document.getElementById("txt_Unit_LDL" ).value.replace('\\', '');
				
				document.getElementById("txt_Unit_HDL" ).value=data.records[i].hdl_unit;		
				document.getElementById("txt_Unit_HDL" ).value=document.getElementById("txt_Unit_HDL" ).value.replace('\\', '');
				
				document.getElementById("txt_Unit_Cholesterol" ).value=data.records[i].cholesterol_unit;		
				document.getElementById("txt_Unit_Cholesterol" ).value=document.getElementById("txt_Unit_Cholesterol" ).value.replace('\\', '');
				
				document.getElementById("dvEditLipid" ).style.display="";
				document.getElementById("ShowLPDiv" ).style.display="";

				//document.getElementById("rededitbtnLipid"+eid).style.display="";
				//document.getElementById("editbtnLipid"+eid).style.display="none";
				
				if(document.getElementById("dvLipidProfileNA" )!=null)
				 {
					 	document.getElementById("dvLipidProfileNA" ).style.display="none";
				 }
				 
				 
				 if(document.getElementById("dvLipidProfileNA1" )!=null)
				 {
...
function Health_Problem_Retrive_By_Id(id, eid)
{
	var message="";
	var day="";
	if (window.XMLHttpRequest)
	...
	xmlhttp.onreadystatechange=function()
	{
		...
		{	
			 ...
			 for (var i = 0; i < data.records.length; ++i) {
				   ...
				   ChangeEditImage(eid,'hp');
					
					
				   document.getElementById("txt_Health_Problem_ID" ).value=data.records[i].health_problem_id;	
				   /// document.getElementById("txt_HP_Problem_Type1").value=data.records[i].problem_type;	
				   document.getElementById("cardiacProblemsNo" ).checked=true;
				   document.getElementById("EyerelatedProblemsNo" ).checked=true;
				   document.getElementById("FaceProblemsNo" ).checked=true;
				   document.getElementById("BloodcirculationNo" ).checked=true;
				  ...
				  document.getElementById("dvEditHealth").style.display="";
				   document.getElementById("ShowHPDiv").style.display="";
				...
				if(document.getElementById("dvHPNA" )!=null)
				{
					document.getElementById("dvHPNA" ).style.display="none";
				}
				
				if(document.getElementById("dvHPNA1" )!=null)
				{
					document.getElementById("dvHPNA1" ).style.display="none";
				}
			 	...
			 	Health_Problem_Details_Retrive_By_Id(id, eid);
...
function Health_Problem_Details_Retrive_By_Id(id, eid)
{
	var message="";
	var day="";
	...
	xmlhttp.onreadystatechange=function()
	{
		...
		{	
			...
			ChangeEditImage(eid,'hp');
			 ...
			 for (var i = 0; i < data.records.length; ++i) {
				   if (data.records[i].problem_type=="Cardiac"){SetData_Helth_Problem(a,data,i); 
				   		document.getElementById("txtAddCardProb").value=a;
				    	document.getElementById("DvCardProblem"+a).style.display='';
						a=a+1;
				   		
				   }
				   
				   if (data.records[i].problem_type=="Eye"){SetData_Helth_Problem(b,data,i);
				   		document.getElementById("txtAddEyeProb").value=b;
					   document.getElementById("DvEyeProblem"+b).style.display='';
					   b=b+1;
				   }
				   
				 
				   if (data.records[i].problem_type=="Kidney"){SetData_Helth_Problem(c,data,i);
						document.getElementById("txtAddKidneyProb").value=c;
					   document.getElementById("DvKidneyProblem"+c).style.display='';
						c=c+1; 
					}
				   if (data.records[i].problem_type=="Circulation"){SetData_Helth_Problem(d,data,i); 
						document.getElementById("txtAddCirculationProb").value=d;
					   document.getElementById("DvCirculationProblem"+d).style.display='';
						d=d+1; 
				   }
				   if (data.records[i].problem_type=="Skin"){SetData_Helth_Problem(e,data,i);	
						document.getElementById("txtAddSkinProb").value=e;
					   document.getElementById("DvSkinProblem"+e).style.display='';
						e=e+1; 
				   }
				   if (data.records[i].problem_type=="Digestive"){SetData_Helth_Problem(f,data,i); 
					document.getElementById("txtAddDigestiveProb").value=f;
					   document.getElementById("DvDigestiveProblem"+f).style.display='';
						f=f+1; 
				   }
				   if (data.records[i].problem_type=="JointPaints"){SetData_Helth_Problem(g,data,i); 
					document.getElementById("txtAddJointPaintsProb").value=g;
					   document.getElementById("DvJointPaintsProblem"+g).style.display='';
							g=g+1; 
				   }
				   if (data.records[i].problem_type=="Constipation"){SetData_Helth_Problem(h,data,i); 
				   document.getElementById("txtAddConstipationProb").value=h;
					   document.getElementById("DvConstipationProblem"+h).style.display='';
					h=h+1; 
				   }
				   if (data.records[i].problem_type=="Other"){SetData_Helth_Problem(j,data,i);  
				   document.getElementById("txtAddOtherProb").value=j;
					   document.getElementById("DvOtherProblem"+j).style.display='';
					j=j+1;
				   }
...
function SetData_Helth_Problem(iNumber,data,i)
{
   ...
   document.getElementById("ddl_HP_Problem_Year"+iNumber).value=data.records[i].diag_year;
    ...
    document.getElementById("ddl_Health_Problem"+iNumber).value=data.records[i].doctor_id;
}
...
function ShowDoctor()
{
	...
	if(document.getElementById("Consulted_of_problem1").checked)
	{
		document.getElementById("dvDocNameShow").style.display="none";
		document.getElementById("dvDocCommentShow").style.display="none";
	}
	else
	{
		document.getElementById("dvDocNameShow").style.display="";
		document.getElementById("dvDocCommentShow").style.display="";
	}
}
...
function Compose_Ins(row)
{
	...
	if(document.getElementById("cmb_Inbox_Query_Type").value=="1")
	{
		...
		if(document.getElementById("txt_Inbox_Subject").value=="")
		{
			alert ("Please enter Subject.");
			document.getElementById("txt_Inbox_Subject").focus();
			return false;
		}
	...
	if(query_type=="1")
	{
		...
		doc_comment = doc_comment.replace(/\r?\n/g, '<br />');
		//var upload_report = $( "#flPhoto" ).val();	
		
		
		
		var upload_report = document.getElementById('flPhoto').files[0];	
	...
	else if(query_type=="2")
	{
		...
		//alert (queryno);
		if(document.getElementById("cmb_Inbox_User_Query").value=="")
		{
			alert ("Please enter your query.");
			document.getElementById("cmb_Inbox_User_Query").focus();
			return false;
		}
		...
		var subject= $( "#txtQuerySubject"+queryno).val();
	...
	var url_param="query_type="+query_type+"&body_area="+body_area+"&suffer_from="+suffer_from+"&doctor_id="+doctor_id+"&last_occurrency_day="+last_occurrency_day+"&last_occurrency_month="+last_occurrency_month+"&last_occurrency_year="+last_occurrency_year+"&doc_comment="+doc_comment+"&doctor_consulted="+doctor_consulted+"&video_query_requirement="+video_query_requirement+"&mail_id="+mail_id+"&complaint="+complaint+"&upload_report="+upload_report+"&status="+status+"&queryid="+queryid+"&prescription_report="+prescription_report+"&lab_test_report="+lab_test_report+"&radiology_report="+radiology_report+"&prescription_type="+prescription_type+"&lab_test_type="+lab_test_type+"&radiology_type="+radiology_type+"&symptoms="+symptoms+"&insert_type=Compose_Ins"+"&subject="+subject;
	
	 //alert (url_param);
	
		xmlhttp.open("POST",hostname+"/includes/add_records.inc.php?" + url_param);
		xmlhttp.send(fd);
	...
	//RetriveReocrds_Main('Compose_Ins','dvCompose');
	 ...
	 redirectURL(hostname+"/page.php?dir=inbox/view_mails&status=inbox&folderid="+folder_id);
...
function Calorie_Details_Ins(row)
{
	...
	document.getElementById("Weight_Day" ).value="0";	
	document.getElementById("Weight_Month" ).value="0";	
	document.getElementById("Weight_Year" ).value="0";
	document.getElementById("Waist_Day" ).value="0";
	document.getElementById("Waist_Month" ).value="0";
	document.getElementById("Waist_Year" ).value="0";
	...
	document.getElementById("Arms_Month" ).value="0";
	...
	document.getElementById("Weight_Day" ).focus();
	RetriveReocrds_Main('CalorieDet','dvCalorieDet');
	 alert("Record saved successfully.");
	redirectURL(hostname+"/page.php?dir=calories/setup4");
}
...
/*	if(document.getElementById("txtHospital").value=="0")
	...
	var user_count = $( "#txtUserCountnut" ).val();
	var password = $( "#password" ).val();

	var url_param="doctor_name="+doctor_name+"&hospital_name="+hospital_name+"&hospital_address="+hospital_address+"&hospital_city="+hospital_city+"&hospital_area="+hospital_area+"&specialization="+specialization+"&contact="+contact+"&email="+email+"&doctor_id="+doctor_id+"&type="+type+"&user_count="+user_count+"&password="+password+"&insert_type=Doctor_Ins";
	...
	document.getElementById("txtUserCount" ).value="";	
	document.getElementById("password" ).value="";	
	
	if (document.getElementById("dvDoctor")!=null)
	{
		RetriveReocrds_Main('Doctor','dvDoctor');
	}
		...
		{	
			 ...
			 for (var i = 0; i < data.records.length; ++i) {
				// day=data.records[i].consult_day;
					...
					document.getElementById("txtUserCountnut" ).value=data.records[i].user_count;
					document.getElementById("password" ).value=data.records[i].password;
		...
		xmlhttp.onreadystatechange=function()
		{
			...
			{	
				...
				// alert(message);
				 ...
				 for(var i=1;i<49;i++)
				 {
					document.getElementById("ddl_Health_Problem"+i).innerHTML=message;	 
				 }
...
function Food_Delete_By_Id(id,deleted_id,type,date)
{
		...
		xmlhttp.onreadystatechange=function()
		{
			...
			{	
				...
				if (type=="BreakFast")
				{
					...
					pageURL=hostname+"/includes/get_result_nutrition.inc.php?type="+type+"&date="+today+"&Receipe_id=0&delete_type=delete";
					//parent.document.getElementById("ifBreakFast").src= pageURL;
				}
				if (type=="Lunch")
				{
					pageURL=hostname+"/includes/get_result_nutrition.inc.php?type="+type+"&date="+today+"&LReceipe_id=0&delete_type=delete";
					///parent.document.getElementById("ifBreakFast").src= pageURL;
				}
				if (type=="Dinner")
				{
					pageURL=hostname+"/includes/get_result_nutrition.inc.php?type="+type+"&date="+today+"&DReceipe_id=0&delete_type=delete";
					//parent.document.getElementById("ifBreakFast").src= pageURL;
				}
				if (type=="Snacks")
				{
					pageURL=hostname+"/includes/get_result_nutrition.inc.php?type="+type+"&date="+today+"&SReceipe_id=0&delete_type=delete";
					//parent.document.getElementById("ifBreakFast").src= pageURL;
				}
...
function Exercise_Delete_By_Id(id,deleted_id,date)
{
		...
		xmlhttp.onreadystatechange=function()
		{
			...
			{	
				...
				/// alert(message);
				 ...
				 ////alert (document.getElementById("tr_exercise_"+deleted_id).style.display);
				 GetDailyUpdates(date);
			///alert (parent.document.getElementById("txtExerciseId"));
				if(parent.document.getElementById("txtExerciseId")!=null)
				{
					parent.document.getElementById("txtExerciseId").value="0";
				}
...
function Pincode_Delete_By_Id(id,deleted_id)
{
		...
		xmlhttp.onreadystatechange=function()
		{
			...
			{	
				 message = xmlhttp.responseText;
				 //alert(message);
				 document.getElementById("tr_pincode_ts_"+deleted_id).style.display='none';
			}
		}
		xmlhttp.open("GET",hostname+"/includes/delete_reocrds.inc.php?insert_type=Pincode&cid="+id,true);
		xmlhttp.send();
...
function setsugardate()
{
		...
		if(fbday!="0")
		{
			...
			/*document.getElementById('DT_PPBS_Date').disabled="true";
			document.getElementById('DT_RBS_Date').disabled="true";
			document.getElementById('DT_UBS_Date').disabled="true";*/
		}
		
		
		if(fbmonth!="0")
		{
			document.getElementById('DT_PPBS_Month').value = document.getElementById('DT_FBS_Month').value;
			document.getElementById('DT_UBS_Month').value = document.getElementById('DT_FBS_Month').value;
			document.getElementById('DT_RBS_Month').value = document.getElementById('DT_FBS_Month').value;
			
			/*document.getElementById('DT_PPBS_Month').disabled="true";
			document.getElementById('DT_UBS_Month').disabled="true";
			document.getElementById('DT_RBS_Month').disabled="true";*/
		}
		
		if(fbyear!="0")
		{
			document.getElementById('DT_PPBS_Year').value = document.getElementById('DT_FBS_Year').value;
			document.getElementById('DT_UBS_Year').value = document.getElementById('DT_FBS_Year').value;
			document.getElementById('DT_RBS_Year').value = document.getElementById('DT_FBS_Year').value;
			
			/*document.getElementById('DT_PPBS_Year').disabled="true";
			document.getElementById('DT_UBS_Year').disabled="true";
			document.getElementById('DT_RBS_Year').disabled="true";*/
		}
		...
		if(ppbsday!="0")
		{
			...
			/*document.getElementById('DT_FBS_Date').disabled="true";
			document.getElementById('DT_UBS_Date').disabled="true";
			document.getElementById('DT_RBS_Date').disabled="true";*/
		}
		...
		if(ppbsmonth!="0")
		{
			document.getElementById('DT_FBS_Month').value = document.getElementById('DT_PPBS_Month').value;
			document.getElementById('DT_UBS_Month').value = document.getElementById('DT_PPBS_Month').value;
			document.getElementById('DT_RBS_Month').value = document.getElementById('DT_PPBS_Month').value;
			
			/*document.getElementById('DT_FBS_Month').disabled="true";
			document.getElementById('DT_UBS_Month').disabled="true";
			document.getElementById('DT_RBS_Month').disabled="true";*/
		}
		...
		if(ppbsyear!="0")
		{
			document.getElementById('DT_FBS_Year').value = document.getElementById('DT_PPBS_Year').value;
			document.getElementById('DT_UBS_Year').value = document.getElementById('DT_PPBS_Year').value;
			document.getElementById('DT_RBS_Year').value = document.getElementById('DT_PPBS_Year').value;
			
			/*document.getElementById('DT_FBS_Year').disabled="true";
			document.getElementById('DT_UBS_Year').disabled="true";
			document.getElementById('DT_RBS_Year').disabled="true";*/
		}
		...
		if(ubmonth!="0")
		{
			document.getElementById('DT_FBS_Month').value = document.getElementById('DT_UBS_Month').value;
			document.getElementById('DT_PPBS_Month').value = document.getElementById('DT_UBS_Month').value;
			document.getElementById('DT_RBS_Month').value = document.getElementById('DT_UBS_Month').value;
		...
		if(ubyear!="0")
		{
			document.getElementById('DT_FBS_Year').value = document.getElementById('DT_UBS_Year').value;
			document.getElementById('DT_PPBS_Year').value = document.getElementById('DT_UBS_Year').value;
			document.getElementById('DT_RBS_Year').value = document.getElementById('DT_UBS_Year').value;
		...
		if(rbmonth!="0")
		{
			document.getElementById('DT_FBS_Month').value = document.getElementById('DT_RBS_Month').value;
			document.getElementById('DT_PPBS_Month').value = document.getElementById('DT_RBS_Month').value;
			document.getElementById('DT_UBS_Month').value = document.getElementById('DT_RBS_Month').value;
		...
		if(rbyear!="0")
		{
			document.getElementById('DT_FBS_Year').value = document.getElementById('DT_RBS_Year').value;
			document.getElementById('DT_PPBS_Year').value = document.getElementById('DT_RBS_Year').value;
			document.getElementById('DT_UBS_Year').value = document.getElementById('DT_RBS_Year').value;
...
function checkduplicationprofile(type, row)
{
		...
		if (type=="Sugar_Profile")
		{
				...
				result_fbs = $( "#txt_Result_FBS" ).val();
				result_ppbs = $( "#txt_Result_PPBS" ).val();
				result_ubs = $( "#txt_Result_UBS" ).val();
				result_rbs = $( "#txt_Result_RBS" ).val();
		
						
			if(fbday=="0" || ppbsday=="0" || ubday=="0"|| rbday=="0"|| fbmonth=="0"|| ppbsmonth=="0"|| ubmonth=="0"|| rbmonth=="0"|| fbyear=="0"|| ppbsyear=="0"|| ubyear=="0"|| rbyear=="0" )
			{
				alert ("Please select date. To enter results for multiple dates you have to make a new entry.");
				return false;
			}
			
			if(result_fbs=="" &&  result_ppbs=="" && result_ubs=="" && result_rbs=="")
			{
				alert ("Please enter atleast one sugar profile result. ");
				return false;
			}
		...
		{
				///alert (type);
				day = $( "#Lipid_Triglyceride_Date" ).val();
				month = $( "#Lipid_Triglyceride_Month" ).val();
				year = $( "#Lipid_Triglyceride_Year" ).val();
				edit_id = $( "#txt_Lipid_Profile_ID" ).val();
				date=year+"-"+month+"-"+day;
		...
		if (type=="Life_Style")
		{
				///alert (type);
				day = $( "#Date_LS_Day" ).val();
				month = $( "#Date_LS_Month" ).val();
				year = $( "#Date_LS_Year" ).val();
				edit_id = $( "#txt_Life_Style_ID" ).val();
				date=year+"-"+month+"-"+day;
				...
				var life_style_year = $( "#Date_LS_Year" ).val();
					...
					{
						alert ("Please enter sleep details.");
					...
					{
						alert ("Do you suffer from any physical stress? If NO, select NA from the drop down.");
					...
					{
						alert ("Do you suffer from any mental stress? If NO, select NA from the drop down.");
					...
					if(life_style_day=="0" && life_style_month=="0" && life_style_year=="0")
					{
						alert ("Please select life style date. ");
						return false;
					}
		...
		{
				day = $( "#Weight_Day" ).val();
				month = $( "#Weight_Month" ).val();
				year = $( "#Weight_Year" ).val();
				edit_id = $( "#txtCalorieDetID" ).val();
				date=year+"-"+month+"-"+day;
			...
			if(current_weight_day=="0" || current_waist_day=="0" || current_hips_day=="0"|| current_arms_day=="0"|| current_weight_month=="0"|| current_waist_month=="0"|| current_hips_month=="0"|| current_arms_month=="0"|| current_weight_year=="0"|| current_hips_year=="0"|| current_arms_year=="0"|| current_waist_year=="0" )
			{
				alert ("Please enter atleast one measurement date. ");
				return false;
			}
			
			if(curr_wgt=="" &&  current_waist=="" && current_hips=="" && current_arm=="")
			{
				alert ("Please enter atleast one measurement. ");
				return false;
			}
...
function Doctor_Comment(row)
{
	...
	if (type=="MD")
	{
		...
		doctor_advice = doctor_advice.replace(/\r?\n/g, '<br />');
		var doctor_internal_advice = $( "#txtMDInternalAdvicePatient" ).val();
		doctor_internal_advice = doctor_internal_advice.replace(/\r?\n/g, '<br />');
...
function MD_Comment(row, rejected)
{
	...
	md_advice = md_advice.replace(/\r?\n/g, '<br />');
	
	var md_internal_advice = $( "#txtInternalAdvicePatient" ).val();
	md_internal_advice = md_internal_advice.replace(/\r?\n/g, '<br />');
	...
	var time_slot = $( "#ddl_App_Slot" ).val();	
	...
	if(video_query=="1" && rejected!="1")
	{
		...
		//	alert(current_date);
			...
			var timeval = md_ap_date > yesterday;
			var todayval = (md_ap_date!=yesterday);
	...
	if(rejected=="0")
		...
		else
		{
			...
			/*if ($("#txtInternalAdvicePatient" ).val()=="")
			{
				alert("Please enter internal advice.");
				$("#txtInternalAdvicePatient" ).focus();
				return false;
			}*/
		}
	...
	if(confirm(msg))
	{
		...
		var url_param="patient_id="+patient_id+"&ref_doctor_id="+ref_doctor_id+"&md_advice="+md_advice+"&md_internal_advice="+md_internal_advice+"&type="+type+"&md_id="+md_id+"&comment_id="+comment_id+"&compose_id="+compose_id+"&accept_id="+accept_id+"&rejected="+rejected+"&app_day="+app_day+"&app_month="+app_month+"&app_year="+app_year+"&time_from="+time_from+"&time_to="+time_to+"&time_slot="+time_slot+"&hospital_id="+hospital_id+"&hospital_name="+hospital_name+"&video_query="+video_query+"&doc_comment_id="+doc_comment_id+"&insert_type=MD_Comment_Ins";
...
function SendSuggestion(row)
{
	...
	var subject = $( "#txtNutSubject" ).val();

	//alert(comment);
	
	var url_param="patient_id="+patient_id+"&nutritionist_id="+nutritionist_id+"&comment_id="+comment_id+"&compose_id="+compose_id+"&comment="+comment+"&subject="+subject+"&insert_type=SendReply";
...
function Add_Comment(row)
{
	...
	if(document.getElementById("txtNutComment").value=="" && document.getElementById("txtConsComment").value=="" && document.getElementById("txtPhysicalActivityComment").value=="" && document.getElementById("txtSizeComment").value=="")
	{
		alert ("Please enter any one comment to reply.");
...
function MD_App(row)
{
	...
	if((app_from < selected_hr) && (current_date==md_ap_date))
	{
		alert("Schedule your appointment at least post an hour from now.");
		document.getElementById("ddl_App_From").focus();
		return false;
	}
	...
	if((app_to < app_from))
	{
		alert("Please select correct time duration for appointment schedule.");
		document.getElementById("ddl_App_To").focus();
		return false;
	}
	...
	var doc_comment_id= $( "#txtDocCommentId" ).val();
	var folderid = $( "#txtFolderId" ).val();
	
	var videolink = $( "#txtLink" ).val();

	//alert(compose_id);
	
	var url_param="app_id="+app_id+"&hospital_id="+hospital_id+"&md_id="+md_id+"&app_name="+app_name+"&app_day="+app_day+"&app_month="+app_month+"&app_year="+app_year+"&time_from="+time_from+"&time_to="+time_to+"&time_slot="+time_slot+"&other_app="+other_app+"&notes="+notes+"&created_by="+created_by+"&created_type="+created_type+"&other_hospital_name="+other_hospital_name+"&patient_id="+patient_id+"&compose_id="+compose_id+"&accept_id="+accept_id+"&doc_comment_id="+doc_comment_id+"&folderid="+folderid+"&videolink="+videolink+"&insert_type=MD_App";
		...
		{	
			 ...
			 for (var i = 0; i < data.records.length; ++i) {
				 day=data.records[i].consult_day;
					...
					document.getElementById("txtLink" ).value=data.records[i].videolink;
...
function Exercise_Delete_By_Id_1(id,deleted_id)
{
   // alert (id);
		...
		xmlhttp.onreadystatechange=function()
		{
			...
			{	
				 message = xmlhttp.responseText;
				// alert(message);
				 document.getElementById("tr_exercise_ts_"+deleted_id).style.display='none';
				 GetDailyUpdates();
			}
		}
		xmlhttp.open("GET",hostname+"/includes/delete_reocrds.inc.php?insert_type=Exercises&cid="+id,true);
		xmlhttp.send();
...
function setmeasurementdate()
{
		current_weight_day = $( "#Weight_Day" ).val();	
		current_weight_month = $( "#Weight_Month" ).val();	
		current_weight_year = $( "#Weight_Year" ).val();
		curr_wgt = $( "#txtWeightResult" ).val();
		
		current_waist_day = $( "#Waist_Day" ).val();	
		current_waist_month = $( "#Waist_Month" ).val();	
		current_waist_year = $( "#Waist_Year" ).val();
		current_waist = $( "#txtWaistResult" ).val();
		
		current_hips_day = $( "#Hips_Day" ).val();	
		current_hips_month = $( "#Hips_Month" ).val();	
		current_hips_year = $( "#Hips_Year" ).val();
		current_hips = $( "#txtHipsResult" ).val();
		
		current_arms_day = $( "#Arms_Day" ).val();	
		current_arms_month = $( "#Arms_Month" ).val();	
		current_arms_year = $( "#Arms_Year" ).val();
		current_arm = $( "#txtArmsResult" ).val();
		
		
		
		if(current_weight_day!="0")
		{
			document.getElementById('Waist_Day').value = document.getElementById('Weight_Day').value;
			document.getElementById('Hips_Day').value = document.getElementById('Weight_Day').value;
			document.getElementById('Arms_Day').value = document.getElementById('Weight_Day').value;
		}
		
		
		if(current_weight_month!="0")
		{
			document.getElementById('Waist_Month').value = document.getElementById('Weight_Month').value;
			document.getElementById('Hips_Month').value = document.getElementById('Weight_Month').value;
			document.getElementById('Arms_Month').value = document.getElementById('Weight_Month').value;
		}
		
		if(current_weight_year!="0")
		{
			document.getElementById('Waist_Year').value = document.getElementById('Weight_Year').value;
			document.getElementById('Hips_Year').value = document.getElementById('Weight_Year').value;
			document.getElementById('Arms_Year').value = document.getElementById('Weight_Year').value;
		}
		
		if(current_waist_day!="0")
		{
			document.getElementById('Weight_Day').value = document.getElementById('Waist_Day').value;
			document.getElementById('Hips_Day').value = document.getElementById('Waist_Day').value;
			document.getElementById('Arms_Day').value = document.getElementById('Waist_Day').value;
		}
		
		
		if(current_waist_month!="0")
		{
			document.getElementById('Weight_Month').value = document.getElementById('Waist_Month').value;
			document.getElementById('Hips_Month').value = document.getElementById('Waist_Month').value;
			document.getElementById('Arms_Month').value = document.getElementById('Waist_Month').value;
		}
		
		
		
		if(current_waist_year!="0")
		{
			document.getElementById('Weight_Year').value = document.getElementById('Waist_Year').value;
			document.getElementById('Hips_Year').value = document.getElementById('Waist_Year').value;
			document.getElementById('Arms_Year').value = document.getElementById('Waist_Year').value;
		}
		
			
		if(current_hips_day!="0")
		{
			document.getElementById('Waist_Day').value = document.getElementById('Hips_Day').value;
			document.getElementById('Weight_Day').value = document.getElementById('Hips_Day').value;
			document.getElementById('Arms_Day').value = document.getElementById('Hips_Day').value;
		}
		
		
		
		if(current_hips_month!="0")
		{
			document.getElementById('Waist_Month').value = document.getElementById('Hips_Month').value;
			document.getElementById('Hips_Month').value = document.getElementById('Hips_Month').value;
			document.getElementById('Arms_Month').value = document.getElementById('Hips_Month').value;
		}
		
		
		
		if(current_hips_year!="0")
		{
			document.getElementById('Weight_Year').value = document.getElementById('Hips_Year').value;
			document.getElementById('Waist_Year').value = document.getElementById('Hips_Year').value;
			document.getElementById('Arms_Year').value = document.getElementById('Hips_Year').value;
		}
		
		
		
		if(current_arms_day!="0")
		{
			document.getElementById('Waist_Day').value = document.getElementById('Arms_Day').value;
			document.getElementById('Weight_Day').value = document.getElementById('Arms_Day').value;
			document.getElementById('Hips_Day').value = document.getElementById('Arms_Day').value;
		}
		
		
		
		if(current_arms_month!="0")
		{
			document.getElementById('Weight_Month').value = document.getElementById('Arms_Month').value;
			document.getElementById('Waist_Month').value = document.getElementById('Arms_Month').value;
			document.getElementById('Hips_Month').value = document.getElementById('Arms_Month').value;
		}
		
		
		
		if(current_arms_year!="0")
		{
			document.getElementById('Weight_Year').value = document.getElementById('Arms_Year').value;
			document.getElementById('Waist_Year').value = document.getElementById('Arms_Year').value;
			document.getElementById('Hips_Year').value = document.getElementById('Arms_Year').value;
		}
...
function setsugardate_lipid()
{
		ltday = $( "#Lipid_Triglyceride_Date" ).val();
		llday = $( "#lipid_LDL_Date" ).val();
		lhday = $( "#lipid_HDL_Date" ).val();
		lcday = $( "#lipid_Cholesterol_Date" ).val();
		
		ltmonth = $( "#Lipid_Triglyceride_Month" ).val();
		llmonth = $( "#lipid_LDL_Month" ).val();
		lhmonth = $( "#lipid_HDL_Month" ).val();
		lcmonth = $( "#lipid_Cholesterol_Month" ).val();
		
		
		ltyear = $( "#Lipid_Triglyceride_Year" ).val();
		llyear = $( "#lipid_LDL_Year" ).val();
		lhyear = $( "#lipid_HDL_Year" ).val();
		lcyear = $( "#lipid_Cholesterol_Year" ).val();
		...
		if(ltday!="0")
		{
			document.getElementById('lipid_LDL_Date').value = document.getElementById('Lipid_Triglyceride_Date').value;
			document.getElementById('lipid_HDL_Date').value = document.getElementById('Lipid_Triglyceride_Date').value;
			document.getElementById('lipid_Cholesterol_Date').value = document.getElementById('Lipid_Triglyceride_Date').value;
		}
		
		
		if(ltmonth!="0")
		{
			document.getElementById('lipid_LDL_Month').value = document.getElementById('Lipid_Triglyceride_Month').value;
			document.getElementById('lipid_HDL_Month').value = document.getElementById('Lipid_Triglyceride_Month').value;
			document.getElementById('lipid_Cholesterol_Month').value = document.getElementById('Lipid_Triglyceride_Month').value;
		}
		
		if(ltyear!="0")
		{
			document.getElementById('lipid_LDL_Year').value = document.getElementById('Lipid_Triglyceride_Year').value;
			document.getElementById('lipid_HDL_Year').value = document.getElementById('Lipid_Triglyceride_Year').value;
			document.getElementById('lipid_Cholesterol_Year').value = document.getElementById('Lipid_Triglyceride_Year').value;
		}
		...
		if(llday!="0")
		{
			document.getElementById('Lipid_Triglyceride_Date').value = document.getElementById('lipid_LDL_Date').value;
			document.getElementById('lipid_HDL_Date').value = document.getElementById('lipid_LDL_Date').value;
			document.getElementById('lipid_Cholesterol_Date').value = document.getElementById('lipid_LDL_Date').value;
		}
		
		
		if(llmonth!="0")
		{
			document.getElementById('Lipid_Triglyceride_Month').value = document.getElementById('lipid_LDL_Month').value;
			document.getElementById('lipid_HDL_Month').value = document.getElementById('lipid_LDL_Month').value;
			document.getElementById('lipid_Cholesterol_Month').value = document.getElementById('lipid_LDL_Month').value;
		}
		
		if(llyear!="0")
		{
			document.getElementById('Lipid_Triglyceride_Year').value = document.getElementById('lipid_LDL_Year').value;
			document.getElementById('lipid_HDL_Year').value = document.getElementById('lipid_LDL_Year').value;
			document.getElementById('lipid_Cholesterol_Year').value = document.getElementById('lipid_LDL_Year').value;
		}
		...
		if(lhday!="0")
		{
			document.getElementById('lipid_LDL_Date').value = document.getElementById('lipid_HDL_Date').value;
			document.getElementById('lipid_HDL_Date').value = document.getElementById('lipid_HDL_Date').value;
			document.getElementById('lipid_Cholesterol_Date').value = document.getElementById('lipid_HDL_Date').value;
		}
		
		
		if(lhmonth!="0")
		{
			document.getElementById('Lipid_Triglyceride_Month').value = document.getElementById('lipid_HDL_Month').value;
			document.getElementById('lipid_LDL_Month').value = document.getElementById('lipid_HDL_Month').value;
			document.getElementById('lipid_Cholesterol_Month').value = document.getElementById('lipid_HDL_Month').value;
		}
		
		if(lhyear!="0")
		{
			document.getElementById('Lipid_Triglyceride_Year').value = document.getElementById('lipid_HDL_Year').value;
			document.getElementById('lipid_LDL_Year').value = document.getElementById('lipid_HDL_Year').value;
			document.getElementById('lipid_Cholesterol_Year').value = document.getElementById('lipid_HDL_Year').value;
		}
		...
		if(lcday!="0")
		{
			document.getElementById('lipid_LDL_Date').value = document.getElementById('lipid_Cholesterol_Date').value;
			document.getElementById('lipid_HDL_Date').value = document.getElementById('lipid_Cholesterol_Date').value;
			document.getElementById('lipid_HDL_Date').value = document.getElementById('lipid_Cholesterol_Date').value;
		}
		...
		if(lcmonth!="0")
		{
			document.getElementById('Lipid_Triglyceride_Month').value = document.getElementById('lipid_Cholesterol_Month').value;
			document.getElementById('lipid_LDL_Month').value = document.getElementById('lipid_Cholesterol_Month').value;
			document.getElementById('lipid_HDL_Month').value = document.getElementById('lipid_Cholesterol_Month').value;
		}
		
		if(lcyear!="0")
		{
			document.getElementById('Lipid_Triglyceride_Year').value = document.getElementById('lipid_Cholesterol_Year').value;
			document.getElementById('lipid_LDL_Year').value = document.getElementById('lipid_Cholesterol_Year').value;
			document.getElementById('lipid_HDL_Year').value = document.getElementById('lipid_Cholesterol_Year').value;
		}
}
...
function RetriveReocrds_Uploaded_Gallery(dvName,Type,id)
{
	//alert (dvName);
	//alert (Type);
//	alert (id);
	...
	//alert (hostname+"/retrive_files/retrive_uploaded_gallery.inc.php?insert_type=uploadFile&type="+Type+"&id="+id);
	xmlhttp.open("GET",hostname+"/retrive_files/retrive_uploaded_gallery.inc.php?insert_type=uploadFile&type="+Type+"&id="+id,true);
	xmlhttp.send();
...
function AdditionalReports() {
		...
		fd.append("txtMailID", document.getElementById('txtMailID').value);
		fd.append("txtUploadAdd", document.getElementById('txtUploadAdd').value);
		...
		xmlhttp.open("POST", hostname+"/includes/upload_additional.inc.php?Type="+Type+"&RandomID="+RandomID);
		xmlhttp.send(fd);
...
function CheckDateDuplicatation(strdate, type)
{
	if (window.XMLHttpRequest)
	{// for IE7+, Firefox, Chrome, Opera, Safaricodes
		xmlhttp = new XMLHttpRequest();
	...
	xmlhttp.onreadystatechange=function()
	{
	 ...
	 xmlhttp.open("GET",hostname+"/includes/duplicate_date.inc.php?strdate="+strdate+"&type="+type, true);
	 xmlhttp.send();	
}
