		...
		<li>
			<a href="#" class="button_s"> <span class="txt">Pinaki Guin</span> <span class="ar">&#9660;</span> </a>
			 <ul style="width: 247px; background-color: #83a819;">
				  <li style="border-bottom: solid 1px #aac457;"><a href="#">My Profile</a></li>
                        ...
                        <div  style="width:98%; border:solid 0px red;">
                          ...
                          <div class="dvFloat formpadding"  style="padding:10px 0px 15px 0px">
                            ...
                            <div style="float: right; border: solid 0px #006600;">
                              <div style=" width:84px; height:30px; float:left; padding-right:10px;"> <a href="#" class="button4">SUBMIT</a></div>
                              <div style=" width:156px; height:30px; float:left; padding-right:10px;"> <a href="#" class="button2" >NOT APPLICABLE</a></div>
                              <div style=" width:156px; height:30px; float:right; padding-right:0px;"> <a href="#" class="button2" >SKIP FOR NOW</a></div>
                            </div>
                          </div>
                          <div class="dvFloat formpadding1"  style="padding:0px 0px 25px 0px">
                            <div class="formlabel1-1p">&nbsp;</div>
                    ...
                    <div id="tabs3ab" class="tabcontent1a">
                      <div  style="width:98%; border:solid 0px red;">
                        ...
                        <div class="dvFloat formpadding1">
                          ...
                          <div class="formcontrol2">
                            <input type="text" name="txt_LSSpirit" id="txt_LSSpirit" value="" placeholder="Set Goal" />
                          </div>
                        </div>
                        <div class="dvFloat formpadding1">
                          <div class="formlabel1">
                          ...
                          <div class="formcontrol2">
                            <input type="text" name="txt_LSBeer" id="txt_LSBeer" value=""  placeholder="Set Goal"/>
                          </div>
                        </div>
                        <div class="dvFloat formpadding1">
                          <div class="formlabel1">
                          ...
                          <div class="formcontrol2">
                            <input type="text" name="txt_LSCigarette" id="txt_LSCigarette" value="" placeholder="Set Goal"/>
                          </div>
                        </div>
                        <div class="dvFloat formpadding1">
                          <div class="formlabel1">
                          ...
                          <div class="formcontrol2">
                            <input type="text" name="txt_LSSleep" id="txt_LSSleep" value="" placeholder="Set Goal" />
                          </div>
                        </div>
                        <div class="dvFloat formpadding1">
                          <div class="formlabel1">
