...
function show1p(){ document.getElementById('divShowHidep').style.display ='block'; } 
function show2p(){ document.getElementById('divShowHidep').style.display = 'none'; }
function show3p(){ document.getElementById('divShowHide1p').style.display ='block'; } 
function show4p(){ document.getElementById('divShowHide1p').style.display = 'none'; }
function show19p(){ document.getElementById('divShowHide9p').style.display ='block'; } 
function show20p(){ document.getElementById('divShowHide9p').style.display = 'none'; }
function show21p(){ document.getElementById('divShowHide10p').style.display ='block'; } 
function show22p(){ document.getElementById('divShowHide10p').style.display = 'none'; }
function show5p(){ document.getElementById('divShowHide2p').style.display ='block'; } 
function show6p(){ document.getElementById('divShowHide2p').style.display = 'none'; }
function show7p(){ document.getElementById('divShowHide3p').style.display ='block'; } 
function show8p(){ document.getElementById('divShowHide3p').style.display = 'none'; }
function show9p(){ document.getElementById('divShowHide4p').style.display ='block'; } 
function show10p(){ document.getElementById('divShowHide4p').style.display = 'none'; }
function show11p(){ document.getElementById('divShowHide5p').style.display ='block'; } 
function show12p(){ document.getElementById('divShowHide5p').style.display = 'none'; }
function show13p(){ document.getElementById('divShowHide6p').style.display ='block'; } 
function show14p(){ document.getElementById('divShowHide6p').style.display = 'none'; }
function show15p(){ document.getElementById('divShowHide7p').style.display ='block'; } 
function show16p(){ document.getElementById('divShowHide7p').style.display = 'none'; }
function show17p(){ document.getElementById('divShowHide8p').style.display ='block'; } 
function show18p(){ document.getElementById('divShowHide8p').style.display = 'none'; }
  ...
  <div class="head">
    ...
    <div class="n_o">
      <div class="l_o">
		...
		<li>
			<a href="#" class="button_s"> <span class="txt">Pinaki Guin</span> <span class="ar">&#9660;</span> </a>
			 <ul style="width: 247px; background-color: #83a819;">
                ...
                <li style="border-top: solid 1px #aac457;padding-top:0px;margin-top:5px;"><a href="#">Logout</a></li>
			</ul>
		</li></ul>
          ...
          <div style="float:left; padding:0px 0px 0px 0px; height:50px; border:solid 0px red;">
            <ul class="calorie_setup">
              <li class="active"  style="width:350px;">
                <div>
                  <div class="Step_title_d_Grey"><a href="health_dash_board.html" title="Step 2" style="padding:0px; margin:0px; text-align:left;color:#7ca500">Health dashboard </a></div>
              ...
              <li class="current" style="width:237px;">
                <div>
                  <div class="Step_title_d_Grey_small"><a href="calorie_setup3.html" title="Step 2" style="padding:0px; margin:0px; text-align:left">Upload Reports</a></div>
      ...
      <div class="dvFloat">
        <div class="dvWrapper">
          <div style=" padding:0px 0px 35px 0px">
              ...
              <div class="dvFloat">
                <div style="float:left; padding:0px 0px 10px 0px;"> <a href="health_dash_board_health_problem.html"><img src="images/nutritionist/health_problems_h.jpg" alt=""></a> </div>
              </div>
              <div class="dvFloat">
                <div style="float:left; padding:0px 0px 10px 0px;"> <a href="health_dash_board_daily_tracking.html"><img src="images/nutritionist/daily_tracking.jpg" alt=""></a> </div>
              </div>
            </div>
            <div class="health_dashboard_div_right">
              <div class="dvFloat" style="border-bottom:solid 1px #e4e4e4;">
                <div  style="padding:0px 0px 0px 0px; float:right;  ">
                  <table cellspacing="0" cellpadding="0" style="width:30%; border:solid 0px #000000">
                    <tr>
                      <td style="text-align:right; padding:0px 0px;vertical-align:middle"><a style="cursor: pointer;" target="_parent" onClick="javascript:Popup.showModal('dvpopup-form',null,null,{'screenColor':'#333333','screenOpacity':.6});" > <img src="images/nutritionist/daily_tracking_app.jpg" alt="" align="absmiddle"> </a> </td>
                      <td style="text-align:right; padding:0px 10px;vertical-align:middle"><a href="#"  onClick="javascript:Popup.showModal('dvpopup-form2',null,null,{'screenColor':'#333333','screenOpacity':.6});"><img src="images/nutritionist/health_setup.jpg" alt="" align="absmiddle"></a></td>
                    </tr>
                  </table>
                </div>
              </div>
              <div style="width:99%; border:solid 0px red;">
                  <div class="dvFloat formpadding" style="padding:0px;">
                    <div class="formlabelHDB" style="padding:0px;">
                      <label class="formlabelHDB" style="padding:0px;">
                  ...
                  <div class="dvFloat formpadding1" style="padding:10px 0px 5px 0px; border-bottom: solid 1px #e1e1e1;"> <a onClick="showform();" style="cursor:pointer"><img src="images/nutritionist/add_to_list.jpg" alt=""></a> </div> <div id="divShowHideForm" style="display: none">
                  <div class="dvFloat formpadding1">
                    <div class="formlabelHDB1">
                      <label class="formlabelHDB">Do you face any Cardiac Problems ?</label>
                    </div>
                    <div class="formcontrol2">
                      <div style="float:left; text-align:left; width:30%; border:solid 0px red;">
                        <input type="radio" id="cardiacProblemsYes" name="cardiacProblems" value="Yes"  onclick="show1();">
                        <label for="Yes">Yes</label>
                        &nbsp;&nbsp;
                        <input type="radio" id="cardiacProblemsNo" name="cardiacProblems" value="No" checked  onclick="show2();">
                        <label for="No">No</label>
                        &nbsp;&nbsp; </div>
                    </div>
                  </div>
                  <div class="dvFloat formpadding1" id="divShowHide" style="display: none">
                      ...
                      <table cellpadding="0" cellspacing="0" style="width:100%; border:solid 0px #000000">
                        ...
                        <tr>
                          ...
                          <td style="padding-top: 5px;"><div style="float:left; padding:0px 5px 0px 0px">
                              <select  id="cmb_Report_Day" name="cmb_Report_Day" tabindex="1" class="existing_event" style="width: 0px;">
                            ...
                            <div style="float:left; padding:0px 5px 0px 0px">
                              <select id="cmb_Report_Date" name="cmb_Report_Date" tabindex="1" class="existing_event" style="width: 0px;">
                            ...
                            <div style="float:left; padding:0px 0px 0px 0px">
                              <select  id="cmb_Report_Year" name="cmb_Report_Year" tabindex="1" class="existing_event" style="width: 0px;">
                          ...
                          <td style="padding-top: 5px; text-align:left" valign="top" ><select id="cmb_Consulting_Specialist" name="cmb_Consulting_Specialist" tabindex="1" class="existing_event" style="width: 100px;">
                            	...
                            	<form method="post" id="signup" action="">
                                    ...
                                    <div class="clickhere_dv" style="border-bottom: solid 0px #d4d4d4;">
                                        ...
                                        <div style="width: 42%; float: left; border: solid 0px #003300; padding-left: 2px; text-align: left;">
                                            <input class="saveclickbtn" value="Save" type="submit" />
                                        </div>
                                        <div style="width: 47%; float: right; border: solid 0px #990033; padding-right: 8px;">
                                            <input class="cancleclickbtn" value="Cancel" type="submit" />
                                        </div>
                                    </div>
                                        </div>
                                    </div>
                  ...
                  <div class="dvFloat formpadding1" >
                    <div class="formlabelHDB1">
                      <label class="formlabelHDB">Do you face any Eye related Problems ?</label>
                    </div>
                    <div class="formcontrol2">
                      <div style="float:left; text-align:left; width:30%; border:solid 0px red;">
                        <input type="radio" id="EyerelatedProblemsYes" name="EyerelatedProblems" value="Yes" onClick="show3();">
                        <label for="Yes">Yes</label>
                        &nbsp;&nbsp;
                        <input type="radio" id="EyerelatedProblemsNo" name="EyerelatedProblems" value="No" checked onClick="show4();">
                        <label for="No">No</label>
                        &nbsp;&nbsp; </div>
                    </div>
                  </div>
                  <div class="dvFloat formpadding1" id="divShowHide1" style="display: none">
                    <div class="dvFloat" style="padding-top: 0px;">
                      <table cellpadding="0" cellspacing="0" style="width:100%; border:solid 0px #000000">
                        <tr>
                          <td style="width:4%;padding-left:0px;">Problem</td>
                        ...
                        <tr>
                          ...
                          <td style="padding-top: 5px;"><div style="float:left; padding:0px 5px 0px 0px">
                              <select  id="cmb_Report_Day1" name="cmb_Report_Day1" tabindex="1" class="existing_event" style="width: 0px;">
                                <option value="DD">DD</option>
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                            ...
                            <div style="float:left; padding:0px 5px 0px 0px">
                              <select  id="cmb_Report_Date1" name="cmb_Report_Date1" tabindex="1" class="existing_event" style="width: 0px;">
                                <option value="MM">MM</option>
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                            ...
                            <div style="float:left; padding:0px 0px 0px 0px">
                              <select  id="cmb_Report_Year1" name="cmb_Report_Year1" tabindex="1" class="existing_event" style="width: 0px;">
                                <option value="YYYY">YYYY</option>
                                <option>2006</option>
                                <option>2007</option>
                                <option>2008</option>
                          ...
                          <td style="padding-top: 5px; text-align:left" valign="top" ><select id="cmb_Consulting_Specialist1" name="cmb_Consulting_Specialist1" tabindex="1" class="existing_event" style="width: 100px;">
                              <option value="0">Select</option>
                            </select></td>
                        </tr>
                        <tr>
                          ...
                          <td style="padding-left:0px;">&nbsp;</td>
                          <td style="padding-left:0px; font-size: 12px; padding-top: 7px; vertical-align: top;">Did not find your Doctor in List? <br>
                            <span style="text-decoration: underline;"><a href="" class="btnclickhere1">Click  here</a></span> to Add One 
                            <div class="frmclickhere1" id="2">
                            	<form method="post" id="signup" action="">
                                	<div style="border-bottom: solid 2px #d4d4d4; background-color: #f7f8f3; padding: 12px 11px; float: left; width: 95%; font-size: 14px; font-weight: bold;">
                                    	Add Doctor                                    </div>
                                    <div class="clickhere_dv">
                  ...
                  <div class="dvFloat formpadding1">
                    <div class="formlabelHDB1">
                      <label class="formlabelHDB">Do you face any kidney related Problems ?</label>
                    </div>
                    <div class="formcontrol2">
                      <div style="float:left; text-align:left; width:30%; border:solid 0px red;">
                    ...
                    <div class="dvFloat" style="padding-top: 0px;">
                      <table cellpadding="0" cellspacing="0" style="width:100%; border:solid 0px #000000">
                        ...
                        <tr>
                          ...
                          <td style="padding-top: 5px;"><div style="float:left; padding:0px 5px 0px 0px">
                              <select  id="cmb_Report_Day2" name="cmb_Report_Day2" tabindex="1" class="existing_event" style="width: 0px;">
                                <option value="DD">DD</option>
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                            ...
                            <div style="float:left; padding:0px 5px 0px 0px">
                              <select  id="cmb_Report_Date2" name="cmb_Report_Date2" tabindex="1" class="existing_event" style="width: 0px;">
                                <option value="MM">MM</option>
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                            ...
                            <div style="float:left; padding:0px 0px 0px 0px">
                              <select  id="cmb_Report_Year2" name="cmb_Report_Year2" tabindex="1" class="existing_event" style="width: 0px;">
                                <option value="YYYY">YYYY</option>
                                <option>2006</option>
                                <option>2007</option>
                                <option>2008</option>
                          ...
                          <td style="padding-top: 5px; text-align:left" valign="top" ><select id="cmb_Consulting_Specialist2" name="cmb_Consulting_Specialist2" tabindex="1" class="existing_event" style="width: 100px;">
                              <option value="0">Select</option>
                            </select></td>
                        </tr>
                        <tr>
                  ...
                  <div class="dvFloat formpadding1">
                    <div class="formlabelHDB1">
                      <label class="formlabelHDB">Do you face any problems with blood Circulation                       and Sensation ?</label>
                    </div>
                    <div class="formcontrol2">
                      <div style="float:left; text-align:left; width:30%; border:solid 0px red;">
                    ...
                    <div class="dvFloat" style="padding-top: 0px;">
                      <table cellpadding="0" cellspacing="0" style="width:100%; border:solid 0px #000000">
                        ...
                        <tr>
                          ...
                          <td style="padding-top: 5px;"><div style="float:left; padding:0px 5px 0px 0px">
                              <select  id="cmb_Report_Day3" name="cmb_Report_Day3" tabindex="1" class="existing_event" style="width: 0px;">
                                <option value="DD">DD</option>
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                            ...
                            <div style="float:left; padding:0px 5px 0px 0px">
                              <select  id="cmb_Report_Date3" name="cmb_Report_Date3" tabindex="1" class="existing_event" style="width: 0px;">
                                <option value="MM">MM</option>
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                            ...
                            <div style="float:left; padding:0px 0px 0px 0px">
                              <select  id="cmb_Report_Year3" name="cmb_Report_Year3" tabindex="1" class="existing_event" style="width: 0px;">
                                <option value="YYYY">YYYY</option>
                                <option>2006</option>
                                <option>2007</option>
                                <option>2008</option>
                          ...
                          <td style="padding-top: 5px; text-align:left" valign="top" ><select id="cmb_Consulting_Specialist3" name="cmb_Consulting_Specialist3" tabindex="1" class="existing_event" style="width: 100px;">
                              <option value="0">Select</option>
                            </select></td>
                        </tr>
                        <tr>
                  ...
                  <div class="dvFloat formpadding1">
                    <div class="formlabelHDB1">
                      <label class="formlabelHDB">Do you face any Skin related Problems ?</label>
                    </div>
                    <div class="formcontrol2">
                      <div style="float:left; text-align:left; width:30%; border:solid 0px red;">
                    ...
                    <div class="dvFloat" style="padding-top: 0px;">
                      <table cellpadding="0" cellspacing="0" style="width:100%; border:solid 0px #000000">
                        ...
                        <tr>
                          ...
                          <td style="padding-top: 5px;"><div style="float:left; padding:0px 5px 0px 0px">
                              <select  id="cmb_Report_Day4" name="cmb_Report_Day4" tabindex="1" class="existing_event" style="width: 0px;">
                                <option value="DD">DD</option>
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                            ...
                            <div style="float:left; padding:0px 5px 0px 0px">
                              <select  id="cmb_Report_Date4" name="cmb_Report_Date4" tabindex="1" class="existing_event" style="width: 0px;">
                                <option value="MM">MM</option>
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                            ...
                            <div style="float:left; padding:0px 0px 0px 0px">
                              <select  id="cmb_Report_Year4" name="cmb_Report_Year4" tabindex="1" class="existing_event" style="width: 0px;">
                                <option value="YYYY">YYYY</option>
                                <option>2006</option>
                                <option>2007</option>
                                <option>2008</option>
                          ...
                          <td style="padding-top: 5px; text-align:left" valign="top" ><select id="cmb_Consulting_Specialist4" name="cmb_Consulting_Specialist4" tabindex="1" class="existing_event" style="width: 100px;">
                              <option value="0">Select</option>
                            </select></td>
                        </tr>
                        <tr>
                  ...
                  <div class="dvFloat formpadding1">
                    <div class="formlabelHDB1">
                      <label class="formlabelHDB">Do you face any digestive Problems ?</label>
                    </div>
                    <div class="formcontrol2">
                      <div style="float:left; text-align:left; width:30%; border:solid 0px red;">
                    ...
                    <div class="dvFloat" style="padding-top: 0px;">
                      <table cellpadding="0" cellspacing="0" style="width:100%; border:solid 0px #000000">
                        ...
                        <tr>
                          ...
                          <td style="padding-top: 5px;"><div style="float:left; padding:0px 5px 0px 0px">
                              <select  id="cmb_Report_Day5" name="cmb_Report_Day5" tabindex="1" class="existing_event" style="width: 0px;">
                                <option value="DD">DD</option>
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                            ...
                            <div style="float:left; padding:0px 5px 0px 0px">
                              <select  id="cmb_Report_Date5" name="cmb_Report_Date5" tabindex="1" class="existing_event" style="width: 0px;">
                                <option value="MM">MM</option>
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                            ...
                            <div style="float:left; padding:0px 0px 0px 0px">
                              <select id="cmb_Report_Year5" name="cmb_Report_Year5" tabindex="1" class="existing_event" style="width: 0px;">
                                <option value="YYYY">YYYY</option>
                                <option>2006</option>
                                <option>2007</option>
                                <option>2008</option>
                          ...
                          <td style="padding-top: 5px; text-align:left" valign="top" ><select id="cmb_Consulting_Specialist5" name="cmb_Consulting_Specialist5" tabindex="1" class="existing_event" style="width: 100px;">
                              <option value="0">Select</option>
                            </select></td>
                        </tr>
                        <tr>
                  ...
                  <div class="dvFloat formpadding1">
                    <div class="formlabelHDB1">
                      <label class="formlabelHDB">Do you face any joint pains ?</label>
                    </div>
                    <div class="formcontrol2">
                      <div style="float:left; text-align:left; width:30%; border:solid 0px red;">
                    ...
                    <div class="dvFloat" style="padding-top: 0px;">
                      <table cellpadding="0" cellspacing="0" style="width:100%; border:solid 0px #000000">
                        ...
                        <tr>
                          ...
                          <td style="padding-top: 5px;"><div style="float:left; padding:0px 5px 0px 0px">
                              <select  id="cmb_Report_Day6"  name="cmb_Report_Day6" tabindex="1" class="existing_event" style="width: 0px;">
                                <option value="DD">DD</option>
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                            ...
                            <div style="float:left; padding:0px 5px 0px 0px">
                              <select  id="cmb_Report_Date6"  title="cmb_Report_Date6"  tabindex="1" class="existing_event" style="width: 0px;">
                                <option value="MM">MM</option>
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                            ...
                            <div style="float:left; padding:0px 0px 0px 0px">
                              <select  id="cmb_Report_Year6" name="cmb_Report_Year6" tabindex="1" class="existing_event" style="width: 0px;">
                                <option value="YYYY">YYYY</option>
                                <option>2006</option>
                                <option>2007</option>
                                <option>2008</option>
                          ...
                          <td style="padding-top: 5px; text-align:left" valign="top" ><select id="cmb_Consulting_Specialist6" name="cmb_Consulting_Specialist6" tabindex="1" class="existing_event" style="width: 100px;">
                              <option value="0">Select</option>
                            </select></td>
                        </tr>
                        <tr>
                  ...
                  <div class="dvFloat formpadding1">
                    <div class="formlabelHDB1">
                      <label class="formlabelHDB">Do you suffer from constipation ?</label>
                    </div>
                    <div class="formcontrol2">
                      <div style="float:left; text-align:left; width:30%; border:solid 0px red;">
...
                         </div>
                    ...
                    <div class="dvFloat" style="padding-top: 0px;">
                      <table cellpadding="0" cellspacing="0" style="width:100%; border:solid 0px #000000">
                        ...
                        <tr>
                          ...
                          <td style="padding-top: 5px;"><div style="float:left; padding:0px 5px 0px 0px">
                              <select  id="cmb_Report_Day7"  name="cmb_Report_Day7" tabindex="1" class="existing_event" style="width: 0px;">
                                <option value="DD">DD</option>
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                            ...
                            <div style="float:left; padding:0px 5px 0px 0px">
                              <select id="cmb_Report_Date7" name="cmb_Report_Date7" tabindex="1" class="existing_event" style="width: 0px;">
                                <option value="MM">MM</option>
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                            ...
                            <div style="float:left; padding:0px 0px 0px 0px">
                              <select  id="cmb_Report_Year7"  name="cmb_Report_Year7" tabindex="1" class="existing_event" style="width: 0px;">
                                <option value="YYYY">YYYY</option>
                                <option>2006</option>
                                <option>2007</option>
                                <option>2008</option>
                          ...
                          <td style="padding-top: 5px; text-align:left" valign="top" ><select id="cmb_Consulting_Specialist7" name="cmb_Consulting_Specialist7" tabindex="1" class="existing_event" style="width: 100px;">
                              <option value="0">Select</option>
                            </select></td>
                        </tr>
                        <tr>
                  ...
                  <div class="dvFloat formpadding1">
                    <div class="formlabelHDB1">
                      <label class="formlabelHDB">Do you face any Other Problems ? </label>
                    </div>
                    <div class="formcontrol2">
                      <div style="float:left; text-align:left; width:30%; border:solid 0px red;">
                    ...
                    <div class="dvFloat" style="padding-top: 0px;">
                      <table cellpadding="0" cellspacing="0" style="width:100%; border:solid 0px #000000">
                        ...
                        <tr>
                          ...
                          <td style="padding-top: 5px;"><div style="float:left; padding:0px 5px 0px 0px">
                              <select  id="cmb_Report_Day8"  name="cmb_Report_Day8" tabindex="1" class="existing_event" style="width: 0px;">
                                <option value="DD">DD</option>
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                            ...
                            <div style="float:left; padding:0px 5px 0px 0px">
                              <select  id="cmb_Report_Date8"  name="cmb_Report_Date8" tabindex="1" class="existing_event" style="width: 0px;">
                                <option value="MM">MM</option>
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                            ...
                            <div style="float:left; padding:0px 0px 0px 0px">
                              <select  id="cmb_Report_Year8"  name="cmb_Report_Year8" tabindex="1" class="existing_event" style="width: 0px;">
                                <option value="YYYY">YYYY</option>
                                <option>2006</option>
                                <option>2007</option>
                                <option>2008</option>
                          ...
                          <td style="padding-top: 5px; text-align:left" valign="top" ><select id="cmb_Consulting_Specialist8" name="cmb_Consulting_Specialist8" tabindex="1" class="existing_event" style="width: 100px;">
                              <option value="0">Select</option>
                            </select></td>
                        </tr>
                        <tr>
              ...
              <div id="tabs6a1a" class="tabcontent">
                <div style="width:99%; border:solid 0px red;">
                  ...
                  <div class="dvFloat formpadding1">
                    ...
                    <div class="formcontrol2">
                      <div style="float:left; text-align:left; width:30%; border:solid 0px red;">
                        <input type="radio" id="cardiacProblemsYes" name="cardiacProblems" value="Yes"  onclick="show19p();">
                        <label for="Yes">Yes</label>
                        &nbsp;&nbsp;
                        <input type="radio" id="cardiacProblemsNo" name="cardiacProblems" value="No" checked  onclick="show20p();">
                        <label for="No">No</label>
                        &nbsp;&nbsp; </div>
                    </div>
                  </div>
                  <div class="dvFloat formpadding1" id="divShowHide9p" style="display: none">
                    <div class="dvFloat" style="padding-top: 0px;">
                      <table cellpadding="0" cellspacing="0" style="width:100%; border:solid 0px #000000">
                        <tr>
                          <td style="width:4%;padding-left:0px;">Problem</td>
                  ...
                  <div class="dvFloat formpadding1" >
                    ...
                    <div class="formcontrol2">
                      <div style="float:left; text-align:left; width:30%; border:solid 0px red;">
                        <input type="radio" id="EyerelatedProblemsYes" name="EyerelatedProblems" value="Yes" onClick="show21p();">
                        <label for="Yes">Yes</label>
                        &nbsp;&nbsp;
                        <input type="radio" id="EyerelatedProblemsNo" name="EyerelatedProblems" value="No" checked onClick="show22p();">
                        <label for="No">No</label>
                        &nbsp;&nbsp; </div>
                    </div>
                  </div>
                  <div class="dvFloat formpadding1" id="divShowHide10p" style="display: none">
                    <div class="dvFloat" style="padding-top: 0px;">
                      <table cellpadding="0" cellspacing="0" style="width:100%; border:solid 0px #000000">
                        <tr>
                          <td style="width:4%;padding-left:0px;">Problem</td>
                  ...
                  <div class="dvFloat formpadding1">
                    ...
                    <div class="formcontrol2">
                      <div style="float:left; text-align:left; width:30%; border:solid 0px red;">
                        <input type="radio" id="FaceProblemsYes" name="FaceProblems" value="Yes"  onclick="show5p();">
                        <label for="Yes">Yes</label>
                        &nbsp;&nbsp;
                        <input type="radio" id="FaceProblemsNo" name="FaceProblems" value="No" checked  onclick="show6p();">
                        <label for="No">No</label>
                        &nbsp;&nbsp; </div>
                    </div>
                  </div>
                  <div class="dvFloat formpadding1" id="divShowHide2p" style="display: none">
                    <div class="dvFloat" style="padding-top: 0px;">
                      <table cellpadding="0" cellspacing="0" style="width:100%; border:solid 0px #000000">
                        <tr>
                          <td style="width:4%;padding-left:0px;">Problem</td>
                  ...
                  <div class="dvFloat formpadding1">
                    ...
                    <div class="formcontrol2">
                      <div style="float:left; text-align:left; width:30%; border:solid 0px red;">
                        <input type="radio" id="BloodcirculationYes" name="Bloodcirculation" value="Yes"  onclick="show7p();">
                        <label for="Yes">Yes</label>
                        &nbsp;&nbsp;
                        <input type="radio" id="BloodcirculationNo" name="Bloodcirculation" value="No" checked  onclick="show8p();">
                        <label for="No">No</label>
                        &nbsp;&nbsp; </div>
                    </div>
                  </div>
                  <div class="dvFloat formpadding1" id="divShowHide3p" style="display: none">
                    <div class="dvFloat" style="padding-top: 0px;">
                      <table cellpadding="0" cellspacing="0" style="width:100%; border:solid 0px #000000">
                        <tr>
                          <td style="width:4%;padding-left:0px;">Problem</td>
                  ...
                  <div class="dvFloat formpadding1">
                    ...
                    <div class="formcontrol2">
                      <div style="float:left; text-align:left; width:30%; border:solid 0px red;">
                        <input type="radio" id="FaceskinProblemsYes" name="FaceskinProblems" value="Yes"  onclick="show9p();">
                        <label for="Yes">Yes</label>
                        &nbsp;&nbsp;
                        <input type="radio" id="FaceskinProblemsNo" name="FaceskinProblems" value="No" checked  onclick="show10p();">
                        <label for="No">No</label>
                        &nbsp;&nbsp; </div>
                    </div>
                  </div>
                  <div class="dvFloat formpadding1" id="divShowHide4p" style="display: none">
                    <div class="dvFloat" style="padding-top: 0px;">
                      <table cellpadding="0" cellspacing="0" style="width:100%; border:solid 0px #000000">
                        <tr>
                          <td style="width:4%;padding-left:0px;">Problem</td>
                  ...
                  <div class="dvFloat formpadding1">
                    ...
                    <div class="formcontrol2">
                      <div style="float:left; text-align:left; width:30%; border:solid 0px red;">
                        <input type="radio" id="DigestiveProblemsYes" name="DigestiveProblems" value="Yes" checked  onclick="show11p();">
                        <label for="Yes">Yes</label>
                        &nbsp;&nbsp;
                        <input type="radio" id="DigestiveProblemsNo" name="DigestiveProblems" value="No" checked  onclick="show12(p);">
                        <label for="No">No</label>
                        &nbsp;&nbsp; </div>
                    </div>
                  </div>
                  <div class="dvFloat formpadding1" id="divShowHide5p" style="display: none">
                    <div class="dvFloat" style="padding-top: 0px;">
                      <table cellpadding="0" cellspacing="0" style="width:100%; border:solid 0px #000000">
                        <tr>
                          <td style="width:4%;padding-left:0px;">Problem</td>
                  ...
                  <div class="dvFloat formpadding1">
                    ...
                    <div class="formcontrol2">
                      <div style="float:left; text-align:left; width:30%; border:solid 0px red;">
                        <input type="radio" id="JointpainsProblemsYes" name="JointpainsProblems" value="Yes" onClick="show13p();">
                        <label for="Yes">Yes</label>
                        &nbsp;&nbsp;
                        <input type="radio" id="JointpainsProblemsNo" name="JointpainsProblems" value="No" checked onClick="show14p();">
                        <label for="No">No</label>
                        &nbsp;&nbsp; </div>
                    </div>
                  </div>
                  <div class="dvFloat formpadding1" id="divShowHide6p" style="display: none">
                    <div class="dvFloat" style="padding-top: 0px;">
                      <table cellpadding="0" cellspacing="0" style="width:100%; border:solid 0px #000000">
                        <tr>
                          <td style="width:4%;padding-left:0px;">Problem</td>
                  ...
                  <div class="dvFloat formpadding1">
                    ...
                    <div class="formcontrol2">
                      <div style="float:left; text-align:left; width:30%; border:solid 0px red;">
                        <input type="radio" id="ConstipationProblemsYes" name="ConstipationProblems" value="Yes" onClick="show15p();">
                        <label for="Yes">Yes</label>
                        &nbsp;&nbsp;
                        <input type="radio" id="ConstipationProblemsNo" name="ConstipationProblems" value="No" checked onClick="show16p();">
                        <label for="No">No</label>
                      </div>
                         </div>
                  </div>
                  <div class="dvFloat formpadding1" id="divShowHide7p" style="display: none">
                    <div class="dvFloat" style="padding-top: 0px;">
                      <table cellpadding="0" cellspacing="0" style="width:100%; border:solid 0px #000000">
                        <tr>
                          <td style="width:4%;padding-left:0px;">Problem</td>
                  ...
                  <div class="dvFloat formpadding1">
                    ...
                    <div class="formcontrol2">
                      <div style="float:left; text-align:left; width:30%; border:solid 0px red;">
                        <input type="radio" id="OtherProblemsYes" name="OtherProblems" value="Yes" onClick="show17p();">
                        <label for="Yes">Yes</label>
                        &nbsp;&nbsp;
                        <input type="radio" id="OtherProblemsNo" name="OtherProblems" value="No" checked onClick="show18p();">
                        <label for="No">No</label>
                        &nbsp;&nbsp; </div>
                    </div>
                  </div>
                  <div class="dvFloat formpadding1" id="divShowHide8p" style="display: none">
                    <div class="dvFloat" style="padding-top: 0px;">
                      <table cellpadding="0" cellspacing="0" style="width:100%; border:solid 0px #000000">
                        <tr>
                          <td style="width:4%;padding-left:0px;">Problem</td>
                        ...
                        <div  style="width:98%; border:solid 0px red;">
                          ...
                          <div class="dvFloat formpadding1">
                            ...
                            <div class="formcontrol2">
                              <div class="dvFloat">
                                <div style="float:left; padding:0px 15px 0px 0px">
                                  <select id="cmb_DelTrack_Date" title="" style="width:60px;">
                                    <option value="DD">DD</option>
                                    <option>1</option>
                                    <option>2</option>
                                    <option>3</option>
