                 ...
                 <h1 class="f_red" style="text-align: left; font-size: 20px; margin-bottom: 7px; text-transform:uppercase">old queries</h1>
                	  <div class="DvFloat">
                        <table border="0" cellpadding="0" cellspacing="0" style="width:1000px;">
                            ...
                            <td class="lightInboxbg21" style="border-bottom:solid 1px #fff; width:250px;">Complaint</td>
                            ...
                            <td class="lightInboxbg21" style="border-bottom:solid 1px #fff;">MD Reply</td>
                          </tr>
                              ...
                              <?php  while($get_array = mysql_fetch_array( $retrive_Array )){
								...
								if($answered_date=="")
								 ...
								 else
								 {
									...
									$doc_reply=GetValue("select comment_id as col from tbl_doctor_comment where compose_id=".$get_array['compose_id'],"col");
								//	Alert ($doc_reply);
                           ...
                           <tr>
                            ...
                            <td class="lightInboxbg5"><?php echo $md_name;?></td>
                             <td class="lightInboxbg5"><?php 
							 	$md_reply=GetValue("select comment_id as col from ".MD_Comment." where compose_id=".$get_array['compose_id'],"col");
								$reject_reply=GetValue("select rejected as col from ".MD_Comment." where compose_id=".$get_array['compose_id'],"col");
							 	if($md_reply>0 && $reject_reply=="0")
								{
									echo "Yes";
								}
								else if($md_reply>0 && $reject_reply=="1")
								{
									echo "Reject";
								}
								else if ($referto>0)
