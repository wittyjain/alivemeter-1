...
<?php
	...
	$active_count = GetValue("SELECT Count(*) as col FROM  ".Users." where parent_id=$user_id or user_id=$user_id order by user_id", "col"); 
...
<section>
  <div class="top_ou">
    <div class="top_in" style="border: solid 0px #000066;">
      ...
      <div class="cal_12">
          <div class="DvFloat" style="z-index:1; position:relative; margin-top:0px;">
          	<div class="afmleft">Aligned Family Member</div>
            <div class="afmright" style="padding-right:15px;"><span id="dvTotalMemCount"><?php echo $active_count;?></span><span class="f_grey">/4</span></div>
          </div>
           <div class="afm">
           	<ul>
					<?php 
             	 ...
             	 <li id="dv_User_<?php echo $get_array['user_id']*121;?>" style="display:''">
               		<div class="DvFloat">
                        ...
                        <div class="redtitle" style="padding:0px;">
                        	 <?php if($get_array['parent_id']=="0") { ?>
                             
                             <a href="<?php echo $strHostName;?>/page.php?dir=registration/step1&cid=<?php echo $converter->encode($get_array['user_id']);?>&record=<?php echo $converter->encode($get_array['user_id']);?>&mode=<?php echo $converter->encode('Edit');?>"><img src="images/register_steps/edit_icon.jpg" alt="" style="margin-top:5px;"></a>
                      ...
                      <?php
                       ...
                       <?php for($imember=$iLoop; $imember<4; $imember++){ ?>
						<li>
                            <div class="DvFloat">
           ...
           <div class="DvFloat" style="border-bottom: dashed 1px #000; border-top: dashed 1px #000; margin-bottom: 50px;">
