...
if(isset($_POST['btnSignSubmit']))	{
	...
	$user_email=GetValue("select user_email as col from tbl_users where user_email='".$register_user_email."'", "col");
	...
	else
	{
	 ...
	 $user_email=GetValue("select user_email as col from tbl_users where user_profile_id='".$user_profile_id."'", "col");
	...
	{
		$user_email=GetValue("select user_email as col from tbl_users where mobile='".$register_mobile."'", "col");
				...
				<div class="ali_div_right_step1"> 
				  ...
				  <div class="dvFloat formpadding" style="padding:0px;">
                    ...
                    <div class="formcontrol">
					  <input id="txt_Reg_Fullname" name="txt_Reg_Fullname" value="<?php echo $register_name?>" onblur="javascript:Signup_Registration('0');CreateProfileID('<?php echo $randomno;?>');" type="text" style="width:105px; margin-right:8px;" placeholder="First Name"/>
                        <input id="txt_Reg_Lastname" name="txt_Reg_Lastname" value="<?php echo $lastname?>" onblur="javascript:Signup_Registration('0');CreateProfileID('<?php echo $randomno;?>');" type="text"  style="width:105px;" placeholder="Last Name"/>
				  ...
				  <div class="dvFloat formpadding">
					...
					<div class="formcontrol">
					  	 <input type="text" name="txtProfileID" id="txtProfileID" value="<?php echo $user_profile_id?>" onblur="javscript:Signup_Registration('0');CheckDuplicationUsernameRegistered('0')">
				  ...
				  <div class="dvFloat formpadding">
					...
					<div class="formcontrol">
                   <input id="txt_Reg_Email" name="txt_Reg_Email" value="<?php echo $register_user_email;?>" title="email" type="text"  onblur="javascript:Signup_Registration('0');CheckNewEmailValid('0'); " />
                  ...
                  <div class="dvFloat formpadding">
					...
					<div class="formcontrol">
                   <input id="txt_Reg_Mobile_no" name="txt_Reg_Mobile_no" value="<?php echo $register_mobile?>" type="text"  onblur="javascript:Signup_Registration('0');CheckDuplicationMobile('txt_Reg_Mobile_no','0')"  maxlength="10" onkeydown="return ( event.ctrlKey || event.altKey 
