...
<!-- Facebook Conversion Code for First1000customers -->
<script>(function() {
...
window._fbq.push(['track', '6029963027476', {'value':'0.01','currency':'INR'}]);
</script>
<noscript><img height="1" width="1" alt="" style="display:none" src="https://www.facebook.com/tr?ev=6029963027476&amp;cd[value]=0.01&amp;cd[currency]=INR&amp;noscript=1" /></noscript>

<!-- Google Code for Track Registration Conversion Page -->
<script type="text/javascript">
/* <![CDATA[ */
var google_conversion_id = 963187478;
var google_conversion_language = "en";
var google_conversion_format = "2";
var google_conversion_color = "ffffff";
var google_conversion_label = "oFIhCMOG_1cQlqakywM";
...
<noscript>
  <div style="display:inline;">
      <img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/963187478/?label=oFIhCMOG_1cQlqakywM&amp;guid=ON&amp;script=0"/>
  </div>
</noscript>
<?php
	...
	if(!isset($_GET['record'])) {
		Alertandredirect("Please login to proceed further.", 'index.php');
	}
	...
	if(isset($_POST['btnSubmit']))
	{
		...
		if(!isset($_SESSION['UserID'])){
			if($recevied_message_1[0]!="")
			{
				...
				$messageText="Dear ".$name.", Welcome to Alivemeter. Your verification code ".$verification.". Enjoy premium benefits FREE upto 31st Jan 2015. Reach us on our social media handles!";
				$time=date('h:i:s');
            ...
            <div class="ali_div_right_step1">
              <div class="dvFloat formpadding" style="padding:0px;">
                ...
                <div class="formcontrol">
                  <input id="txt_Fullname" name="txt_Fullname" value="<?php echo $name?>" type="text" style="width:105px; margin-right:8px;" placeholder="First Name"/>
                  <input id="txt_Lastname" name="txt_Lastname" value="<?php echo $lastname?>"  type="text"  style="width:105px;" placeholder="Last Name"/>
                ...
                <div class="formcontrol">
                  <div class="dvFloat" style=" border: solid 0px #006633;">
                    ...
                    <div style="float:left; padding:0px 13px 0px 0px">
                      <select id="cmb_Month" name="cmb_Month"  title="" class="existing_event" style="width: 15px;" tabindex="3" >
                    ...
                    <div style="float:left; padding:0px 0px 0px 0px">
                      <select name="cmb_Year" id="cmb_Year"  title="" class="existing_event" style="width:30px;" tabindex="3" >
              ...
              <div class="dvFloat formpadding">
                ...
                <div class="formcontrol">
                  <select  id="cmb_Marital_Status" name="cmb_Marital_Status"  tabindex="1"  class="existing_event" style="width: 190px;" >
              ...
              <div class="dvFloat formpadding">
                ...
                <div class="formcontrol">
                  <input type="text" name="txt_Height" id="txt_Height" value="<?php echo $height?>" style="width:120px; margin-right:9px; height:20px;" />
                  <select  id="cmb_Height" name="cmb_Height" style="width: 50px;"  class="existing_event" tabindex="1" >
                    <option value="0">Select</option>
              ...
              <div class="dvFloat formpadding">
                ...
                <div class="formcontrol">
                  <input type="text" name="txt_Weight" id="txt_Weight" value="<?php echo $weight?>" placeholder="In Kg." />
              ...
              <div class="dvFloat formpadding">
                ...
                <div class="formcontrol">
                  <div style="float:left; padding:0px 15px 0px 0px">
                    <input type="text" name="txt_Mobile_code" id="txt_Mobile_code" value="<?php echo  $m_std_code?>" placeholder="+91" style="width:30px"  maxlength="14" readonly="readonly" >
                  </div>
                  <div style="float:left; padding:0px 0px 0px 0px">
                    <input type="text" readonly name="txt_Mobile_no" id="txt_Mobile_no" value="<?php echo $mobile?>"  style="width:172px" onkeydown="return ( event.ctrlKey || event.altKey 
                    || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false) 
                    || (95<event.keyCode && event.keyCode<106)
                    || (event.keyCode==8) || (event.keyCode==9) 
                    || (event.keyCode>34 && event.keyCode<40) 
              ...
              <div class="dvFloat formpadding">
                ...
                <div class="formcontrol">
                  <input type="text" name="txtPincode" id="txtPincode" value="<?php echo $pincode?>" maxlength="6"  onkeydown="return ( event.ctrlKey || event.altKey 
                    || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false) 
                    || (95<event.keyCode && event.keyCode<106)
                    || (event.keyCode==8) || (event.keyCode==9) 
                    || (event.keyCode>34 && event.keyCode<40) 
              ...
              <div class="dvFloat formpadding">
                ...
                <div class="formcontrol"  style="">
                  ...
                  <div style="float:left;width:85px;border:solid 0px red;">
                    <input type="submit" class="button1" id="btnSubmit" name="btnSubmit" value="Next"  />
                  </div>
                </div>
              </div>
              <div class="dvFloat formpadding">
