	...
	<div  style="width:99%; border:solid 0px red;">
                 <div class="dvFloat formpadding1" style="padding-top:20px">
                    <div class="formlabel1">
                      <label class="formlabel1"  style="padding-left:0px; padding-bottom:10px; width:500px;">
                      	 <h2 class="Tab_Title">View Dignosed Conditions</h2>
                     </label>
                    </div>
                    <div class="formcontrol2"> &nbsp; </div>
                  		...
                  		<table cellpadding="0" cellspacing="0"  style="width:100%;float:left;" >
                              <tr>
                                <td class="tbl_head" style="width:80%;">Dignosed Condition Title </td>
                              ...
                              <tr id="tr_dignosed_conditions_<?php echo $get_array['cond_id']*121?>">
                                <td class="tdborder" style="padding-left:20px;"><?php echo $get_array['cond_name']?> </td>
                                <td class="tdborder" style="padding-left:10px;">
                                <table cellpadding="0" cellspacing="0"  style="width:100%" >
                                    <tr>
                                      <td class="SubTd1" style="padding-left:0px;"><a href="<?php echo $strHostName;?>/page.php?dir=master/dignosed_conditions/add&cid=<?php echo $converter->encode($get_array['cond_id'])?>" style="cursor:pointer;"><img src="images/register_steps/edit_icon.jpg" alt=""></a></td>
                                      
                                      <td class="SubTd2"><a  style="cursor:pointer;" onclick="javascript:Dignosed_Conditions_Delete_By_Id('<?php echo $get_array['cond_id']?>','<?php echo $get_array['cond_id']*121?>')"><img src="images/register_steps/delete_icon.jpg" alt=""></a></td>
                                    </tr>
                                  </table></td>
