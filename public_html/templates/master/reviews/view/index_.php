                 ...
                 <div class="dvFloat formpadding1" style="padding-top:20px">
                    <div class="formlabel1" style="padding-left:0px; padding-bottom:10px;">
                      <label class="formlabel1">
                      	 <h2 class="Tab_Title">View Blog</h2>
                     </label>
                    </div>
                    <div class="formcontrol2"> &nbsp; </div>
                  		...
                  		<table cellpadding="0" cellspacing="0"  style="width:100%;float:left;" >
                              <tr>
                                <td class="tbl_head" style="width:20%;"> Title </td>
                                <td class="tbl_head" style="width:50%;"> Write To US </td>
                              ...
                              <tr id="tr_blog_<?php echo $get_array['blog_id']*121?>">
                                <td class="tdborder" style="padding-left:20px;"><?php echo $get_array['title']?> </td>
                                <td class="tdborder" style="padding-left:20px;"><?php echo $get_array['blog_id']?> </td>
                                <td class="tdborder" style="padding-left:10px;">
                                <table cellpadding="0" cellspacing="0"  style="width:100%" >
                                    <tr>
                                      <td class="SubTd1" style="padding-left:0px;"><a href="<?php echo $strHostName;?>/page.php?dir=master/blog/add&cid=<?php echo $converter->encode($get_array['blog_id'])?>" style="cursor:pointer;"><img src="images/register_steps/edit_icon.jpg" alt=""></a></td>
                                      
                                      <td class="SubTd2"><a  style="cursor:pointer;" onclick="javascript:Blog_Delete_By_Id('<?php echo $converter->encode($get_array['blog_id'])?>','<?php echo $get_array['blog_id']*121?>')"><img src="images/register_steps/delete_icon.jpg" alt=""></a></td>
                                    </tr>
                                  </table></td>
