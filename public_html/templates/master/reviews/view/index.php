...
function UnReviews()
{
	...
	if(confirm ("Are you sure want to unapprove selected comments?"))
	{
		...
		xmlhttp.open("GET","<?php echo $strHostName; ?>/includes/approve_review.inc.php?cmtid="+cmtid+"&type=Unapprove", true);
		xmlhttp.send();
	}
	else
	{
...
function Delete_UnReview_By_Id()
{
	...
	if(confirm ("Are you sure want to delete selected comments?"))
	{
		...
		xmlhttp.open("GET","<?php echo $strHostName; ?>/includes/delete_review.inc.php?cmtid="+cmtid+"&type=Unapprove", true);
		xmlhttp.send();
	}
	else
	{
                 ...
                 <div class="dvFloat formpadding1" style="padding-top:20px">
                    <div class="formcontrol2" style="padding-left:0px; padding-bottom:10px; ">
                      <label class="formcontrol2">
                      	 <h2 class="Tab_Title">View Reviews</h2>
                     </label>
                    </div>
                   
                    <div class="formcontrol2" style="padding-left:0px; padding-bottom:10px; ">
                      <label class="formcontrol2">
                      	 <div style="float:left; width:200px; margin-right:5px;"><a href="<?php echo $strHostName;?>/page.php?dir=master/reviews/view" class="button2" style="width:180px; background-color:#009999;">Approved Reviews</a></div>
                         <div style="float:left; width:300px;"><a href="<?php echo $strHostName;?>/page.php?dir=master/unapp_user_reviews/view" class="button2" style="width:250px;">Unapproved Reviews</a></div>
                     </label>
                    </div>
                  		...
                  		<table cellpadding="0" cellspacing="0"  style="width:100%;float:left;" >
                              <tr>
                                ...
                                <td class="tbl_head" style="width:40%;">Reviews</td>
                                <td class="tbl_head" style="width:20%;">Date</td>
                                <td class="tbl_head" style="width:20%;">Reviews for</td>
                               ...
                               <?php $retrive_Array=$get_retrive->Get_App_User_Reviews()  ?>
                              <?php  
							  $i=0;
							  $i=$i+1;
                              ...
                              <input type="hidden" id="txtCmtCount" name="txtCmtCount" value="<?php echo $i?>"/>
                               <div class="formcontrol2" style="width:400px; float:left; padding:15px 0;">   
                                  ...
                                  <?php 
								  	$total_app_cmt=GetValue("select Count(*) as col from ".User_Reviews."  where approved=1", "col");
									echo $total_app_cmt;
								  ?>
                                </div>
                                  ...
                                  <div class="formcontrol2" style="width:300px; float:right; padding:15px 0;">   
                                    <a  onclick="javascript:Delete_UnReview_By_Id()"  style="float:right; width:80px; font-size:14px; text-align:center;padding:5px 0px;" class="button">Delete</a>
                                    <a name="btnSubmit" id="btnSubmit" class="button" onclick="javascript:UnReviews();" style="float:right; width:80px; font-size:14px; text-align:center; padding:5px 0;  margin-right:10px; ">Submit </a>
