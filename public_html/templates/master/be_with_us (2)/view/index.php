                 ...
                 <div class="dvFloat formpadding1" style="padding-top:20px">
                    ...
                    <div class="formcontrol2"> &nbsp; </div>
                  		...
                  		<table cellpadding="0" cellspacing="0"  style="width:100%;float:left;" >
                              ...
                              <tr id="tr_be_with_us_<?php echo $get_array['write_to_us_id']*121?>">
                                <td class="tdborder" style="padding-left:20px;"><?php echo $get_array['title']?> </td>
                                <td class="tdborder" style="padding-left:20px;"><?php echo $get_array['be_with_us_id']?> </td>
                                <td class="tdborder" style="padding-left:10px;">
                                <table cellpadding="0" cellspacing="0"  style="width:100%" >
                                    <tr>
                                      <td class="SubTd1" style="padding-left:0px;"><a href="<?php echo $strHostName;?>/page.php?dir=master/be_with_us/add&cid=<?php echo $converter->encode($get_array['be_with_us_id'])?>" style="cursor:pointer;"><img src="images/register_steps/edit_icon.jpg" alt=""></a></td>
                                      
                                      <td class="SubTd2"><a  style="cursor:pointer;" onclick="javascript:Be_With_Us_Delete_By_Id('<?php echo $converter->encode($get_array['be_with_us_id'])?>','<?php echo $get_array['be_with_us_id']*121?>')"><img src="images/register_steps/delete_icon.jpg" alt=""></a></td>
                                    </tr>
                                  </table></td>
