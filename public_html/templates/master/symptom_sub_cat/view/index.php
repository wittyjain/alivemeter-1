                 ...
                 <div class="dvFloat formpadding1" style="padding-top:20px">
                    <div class="formlabel1" style="padding-left:0px; padding-bottom:10px;">
                      <label class="formlabel1">
                      	 <h2 class="Tab_Title">View Symptom Sub Category</h2>
                     </label>
                    </div>
                    <div class="formcontrol2"> &nbsp; </div>
                  		...
                  		<table cellpadding="0" cellspacing	="0"  style="width:100%;float:left;" >
                              <tr>
                               ...
                               <?php $retrive_Array=$get_retrive->GetSymptomSubCat()  ?>
                              <?php  while($get_array = mysql_fetch_array( $retrive_Array )){?>
                              <tr id="tr_symptom_sub_cat_<?php echo $get_array['sub_cat_id']*121?>">
                                <td class="tdborder" style="padding-left:20px;"><?php echo $get_array['sub_cat_name']?> </td>
                                <td class="tdborder" style="padding-left:10px;">
									<table cellpadding="0" cellspacing="0"  style="width:100%" >
										<tr>
										  <td class="SubTd1" style="padding-left:0px;"><a href="<?php echo $strHostName;?>/page.php?dir=master/symptom_sub_cat/add&cid=<?php echo $converter->encode($get_array['sub_cat_id'])?>" style="cursor:pointer;"><img src="images/register_steps/edit_icon.jpg" alt=""></a></td>										  
										  <td class="SubTd2"><a  style="cursor:pointer;" onclick="javascript:Symptom_Sub_Cat_Delete_By_Id('<?php echo $get_array['sub_cat_id']?>','<?php echo $get_array['sub_cat_id']*121?>')"><img src="images/register_steps/delete_icon.jpg" alt=""></a></td>
										</tr>
									 </table>
								 </td>
							   </tr>
