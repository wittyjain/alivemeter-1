...
function UnApproveAmb()
{
	...
	if(confirm ("Are you sure want to approve selected comments?"))
	{
		...
		alert("<?php echo $strHostName; ?>/includes/approve_ambassador.inc.php?cmtid="+cmtid+"&type=Approve");
		xmlhttp.open("GET","<?php echo $strHostName; ?>/includes/approve_ambassador.inc.php?cmtid="+cmtid+"&type=Approve", true);
		xmlhttp.send();
	}
	else
	{
...
function Delete_Blog_By_Id()
{
	...
	if(confirm ("Are you sure want to delete selected comments?"))
	{
		...
		xmlhttp.open("GET","<?php echo $strHostName; ?>/includes/delete_ambassador.inc.php?cmtid="+cmtid+"&type=Approve", true);
		xmlhttp.send();
	}
	else
	{
  ...
  <div class="dvFloat">
	...
	<div  style="width:99%; border:solid 0px red;">
                 <div class="dvFloat formpadding1" style="padding-top:20px">
                    ...
                    <div class="formcontrol2" style="padding-left:0px; padding-bottom:10px; ">
                      <label class="formcontrol2">
                      	 <div style="float:left; width:200px; margin-right:5px;"><a href="<?php echo $strHostName;?>/page.php?dir=master/be_with_us/view" class="button2" style="width:180px;">Approved Be With Us</a></div>
                         <div style="float:left; width:200px;"><a href="<?php echo $strHostName;?>/page.php?dir=master/unapp_be_with_us/view" class="button2" style="width:180px;  background-color:#009999;">Unapproved Be With Us</a></div>
                     </label>
                    </div>
                  		...
                  		<table cellpadding="0" cellspacing="0"  style="width:100%;float:left;" >
                              <tr>
                                ...
                                <td class="tbl_head" style="width:40%;">Comments</td>
                               ...
                               <?php $retrive_Array=$get_retrive->GetBeWithUsUnapproved()  ?>
                              <?php  
							  $i=0;
							  $i=$i+1;
                              ...
                              <input type="hidden" id="txtCmtCount" name="txtCmtCount" value="<?php echo $i?>"/>
                               <div class="formcontrol2" style="width:400px; float:left; padding:15px 0;">   
                                  Total Unapproved Be With Us : 
                                  <?php 
								  	$total_app_cmt=GetValue("select Count(*) as col from  ".Be_With_Us." where approved=0", "col");
									echo $total_app_cmt;
								  ?>
                                </div>
                                  ...
                                  <div class="formcontrol2" style="width:300px; float:right; padding:15px 0;">   
                                    ...
                                    <a name="btnSubmit" id="btnSubmit" class="button" onclick="javascript:UnApproveAmb();" style="float:right; width:80px; font-size:14px; text-align:center; padding:5px 0;  margin-right:10px; ">Submit </a>
