          ...
          <div class="TabDv">
            <div  style="background-color:#666666;padding:10px 5px;">
              ...
              <ul id="tabstabs" class="shadetabs" style="border:solid 0px red;">
				...
				<li id="dvDisableMedicaton" style="border:solid 0px green;" <?php if($doc_consult_count > 0) {echo"style='display:none'" ;}?>>
					<a href="#" rel="">Medication</a>
				</li>
				<li id="dvEnableMedicaton" <?php if($doc_consult_count == 0) {echo"style='display:none'"; }?>>
					<a href="#" rel="tabs2" class="''">Medication</a>
				</li>

				<li id="dvDisableAllergies" <?php if($medication_count > 0) {echo"style='display:none'" ;}?>>
					<a href="#" rel="">Allergies</a>
				</li>
				<li id="dvEnableAllergies" <?php if($medication_count == 0) {echo"style='display:none'"; }?>>
					<a href="#" rel="tabs3">Allergies</a>
				</li>

				<li id="dvDisableHospitalization" <?php if($allergies_count > 0) {echo"style='display:none'" ;}?>>
					<a href="#" rel="">Hospitalization</a>
				</li>
				<li id="dvEnableHospitalization" <?php if($allergies_count == 0) {echo"style='display:none'"; }?>>
					<a href="#" rel="tabs4">Hospitalization</a>
				</li>

				<li id="dvDisableImmunization" <?php if($hospitalization_count > 0) {echo"style='display:none'" ;}?>>
					<a href="#" rel="">Immunization</a>
				</li>
				<li id="dvEnableImmunization" <?php if($hospitalization_count == 0) {echo"style='display:none'"; }?>>
					<a href="#" rel="tabs5">Immunization</a>
				</li>

				<li id="dvDisableHealthProblems" <?php if($immunization_count > 0) {echo"style='display:none'" ;}?>>
					<a href="#" rel="">Health Problems</a>
				</li>
				<li id="dvEnableHealthProblems" <?php if($immunization_count == 0) {echo"style='display:none'"; }?>>
					<a href="#" rel="tabs6">Health Problems</a>
				</li>

				<li id="dvDisableFamilyHistory" <?php if($health_problem_count > 0) {echo"style='display:none'" ;}?>>
					<a href="#" rel="">Family History</a>
				</li>
				<li id="dvEnableFamilyHistory" <?php if($health_problem_count == 0) {echo"style='display:none'"; }?>>
					<a href="#" rel="tabs7">Family History</a>
				</li>

				<li id="dvDisableDailyTracking" <?php if($family_history_count > 0) {echo"style='display:none'" ;}?>>
					<a href="#" rel="">Daily Tracking</a>
				</li>
