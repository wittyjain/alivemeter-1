...
<section>
  <div class="top_ou">
    <div class="top_in" style="border: solid 0px #006666;">
      <div class="top">
        <div class="b_crumb">&nbsp;</div>
         <?php if ($login_count=="1" || $earning_member < 0 ) { ?>
         <div class="cal_12" style="padding-top: 0px; display:none;">
        ...
        <?php } ?>
         ...
         <div class="cal_12" style="padding-top: 0px; margin-top:-20px; display:none;">
        	<p style="padding:0px 0 0px 0; line-height:25px; font-size: 15px; ">Hi <?php echo $_SESSION['UserName'];?>,</p>
            <p style="padding:5px 0 10px 0; line-height:25px; font-size: 15px; ">You have not filled below mentioned points yet. Health Setup section is your introduction to MD to understand YOU and for Nutritionist to prepare diet plans for YOU. There are lots of fields to be entered in a sequential order to reach your dashboard and it will take time. After all, it’s for YOU.<br> In case you do not have time NOW : Click NOT APPLICABLE to navigate through each tab and reach your DASHBOARD.</p>
        ...
        <h1 style="text-transform: inherit; font-size: 24px; text-align: left; margin-top: -30px; font-family: 'FuturaMdBTMedium'; color: #565562; padding-left: 30px;">Hi <?php echo $_SESSION['UserName'];?>!</h1>
        <h1 style="text-transform: inherit; font-size: 20px; text-align: left; margin-left:30px; margin-top: -12px;">Update your <span class="f_green"> Health</span> setup</h1>
        <div class="hw_setupleft1">
            <div class="cal_12" style="padding-top: 15px; border: solid 0px #003300;">
              <div style="padding-left:0px; border: solid 0px #003300; float: left; padding: 0px 18px 0px 22px;">
                    <div style="width: 100%; float: left;">
                        <img src="images/health_setup.jpg" alt="" border="0" usemap="#Map" title="" />
                        <map name="Map" id="Map">
                      <area shape="rect" coords="627,539,747,568" href="#" onClick="javascript:Popup.showModal('dvpopup-form',null,null,{'screenColor':'#333333','screenOpacity':.6});" />
                      </map>
                    </div>
                
                
                <div style="width:100%; float: left; padding: 0px 0px 50px 0px; border:solid 0px green; margin-left:0px;">
                  <?php if($login_count>1) { ?>
                      <?php if ($doc_consult_count=="0" || $medication_count=="0" || $allergies_count=="0" || $hospitalization_count=="0" || $immunization_count=="0" || $health_problem_count=="0" || $family_history_count=="0" || $blood_pressure_count=="0" || $sugar_profile_count=="0" || $life_style_count=="0" || $lipid_profile_count=="0" ) { ?>
                      <div class="dvFloat" style="font-family: 'FuturaMdBTMedium'; color: #565562; font-size: 20px;">Pending Updates</div>
                      <?php } ?>
                      <ul style="border:solid 0px red; float:left;width: 33%;">
                        <?php if($doc_consult_count==0) { ?>
                             <li style="color:red;">Please complete Doctor Consultation.</li>
                        <?php } ?>
                        <?php if($medication_count==0 || $medication_count<0 ) { ?>
