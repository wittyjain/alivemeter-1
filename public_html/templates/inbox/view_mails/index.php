...
///Alert ($free_user_id);
///Alert ($user_total_nut_mail_count);
?>
...
<section>
  <div style="">
    <div class="cal_12" style="margin-left:172px;">
      <div class="m_outo">
      <div style="width:100%;">
        <div class="dvWrapper" style="float:left;">
            ...
            <div class="adviceonline_md">
             	<?php include "includes/inbox_left.inc.php";?>
                  <?php if($_SESSION['UserType']!="Nutritionist") { ?>
                            <div style="float:right; width:110px; border:solid 0px red; text-align:right">
                            <ul id="dd_nav2" style="width:150px;">
               			...
               			<?php } ?>
                <?php include "retrive_files/retrive_view_mails.inc.php";?>
            </div>
          </div>
        </div>
      </div>
