                ...
                <div class="TabContentDetails">
                  ...
                  <div id="tabs2" class="tabcontent">
                     ...
                     <!--Start-->
                        ...
                        <div class="TabDv">
                          ...
                          <div class="TabContentDetails2">
                             <div id="tabs1a1" class="tabcontent">
								...
								<input type="hidden" id="txtWeekDayspost_parandial_result" name="txtWeekDayspost_parandial_result" value="6"/>
                        ...
                        <div class="TabDv">
                          ...
                          <div class="TabContentDetails2">
                             <div id="tabs1a3" class="tabcontent">
								...
								<input type="hidden" id="txtWeekDaysurine_parandial_result" name="txtWeekDaysurine_parandial_result" value="6"/>
                      ...
                      <div style="padding:0px 5px 20px 5px;">
                        <div class="DvFloat" style="padding:20px 5px 0px 0px;">
                          <div style="width: 49%; float: left;padding-left:70px;"><span class="f_grey" style="font-size: 15px; "> Random Sugar (PPBS) Record</span></div>
                        </div>
                      </div>
                      <div class="DvFloat">
                        <div class="TabDv">
                          ...
                          <div class="TabContentDetails2">
                             <div id="tabs1a4" class="tabcontent">
								...
								<input type="hidden" id="txtWeekDaysrandom_parandial_result" name="txtWeekDaysrandom_parandial_result" value="6"/>
