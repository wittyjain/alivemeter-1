          ...
          <div class="DvFloat" style="border: solid 0px #0066CC;">
            ...
            <div style="border: 0px solid gray; width: 965px; float: left; margin-bottom: 1em; padding: 10px 0px; background-color: #FFFFFF; color: #666666;">
              <div class="DvFloat" style="margin:0 0 10px 0;">
              	<ul id="countrytabs" class="shadetabs">
                  <li><a href="<?php echo $strHostName;?>/patients_delayed.php" rel="country1"  class="selected">Delayed By Doctor</a></li>
                  <li><a href="<?php echo $strHostName;?>/patients_delayed_md.php" rel="country3" style="width:250px;">Delayed By MD</a></li>
              ...
              <div class="dvFloat"> 
              	<table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <?php  
						$query = "SELECT * FROM  ".Patients." where isactive=1 and isdeleted=0 and compose_id not in (select compose_id from tbl_doctor_comment) and  doctor_id in (select doctor_id from tbl_doctor where hospital_name=".$hospital_id.")";
