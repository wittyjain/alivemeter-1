                   ...
                   <div class="offerdiv"> <?php echo $offer;?> <span style="font-size: 18px;"></span></div>
                    ...
                    <div class="bx-content_Right">
                      <div class="bx-content_text">
                        ...
                        <p style="padding-top:15px"><a href="<?php echo $strHostName;?>/deals/<?php echo $row['url_title'];?>/<?php echo $converter->encode($row['deal_id']);?>" class="buttoncuponnoarrow" style="height:25px; width:102px; text-align: center;">Get Coupon</a></p>
                      </div>
