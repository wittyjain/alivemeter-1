...
<?php if($dir=="calories/setup2") { ?>
        <div class="dvFloat">
          <div style="float:left"><a href="<?php echo $strHostName;?>/page.php?dir=calories/setup2"><img src="images/calorie_setup/review_goals.png" alt=""></a></div>
        </div>
<?php } else { ?>
     <div class="dvFloat">
       <div style="float:left"><a href="<?php echo $strHostName;?>/page.php?dir=calories/setup2"><img src="images/calorie_setup/review_goals_h.png" alt=""></a></div>
     </div>
 <?php } ?>
