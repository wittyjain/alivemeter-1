              ...
              <div class="DvFloat f_grey" style="border-bottom: solid 1px #cccccc; font-size: 13px; text-align: left; padding-bottom: 5px; padding-top:10px;">
                <div class="DvFloat">
                  ...
                  <div class="DvFloat">
                   ...
                   <?php  
						$query = "SELECT * FROM  ".Diet_Food." where isactive=1 and isdeleted=0 and patient_id=".$user_id." and selected_date='".$today_date."'";
						//echo $query;
						$total_cal_1="0";
							$result = mysql_query($query);							
							if($result != "") {	
              ...
              <div class="DvFloat f_grey" style="border-bottom: solid 0px #cccccc; font-size: 13px; text-align: left; padding-top: 8px;">
                <div class="DvFloat">
                  ...
                  <div class="DvFloat">
                   ...
                   <?php  
				   $total_cal_exe_1="0";
						$query = "SELECT * FROM  ".Diet_Exercise." where isactive=1 and isdeleted=0 and patient_id=".$user_id." and selected_date='".$today_date."'";
					///	echo $query;
							$result = mysql_query($query);							
							if($result != "") {	
								$rowcount  = mysql_num_rows($result);
