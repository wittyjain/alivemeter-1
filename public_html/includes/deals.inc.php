...
<div class="box"> <i><?php echo $offer; ?><br/>
  ...
  <div class="box_in"> <img alt="<?php echo $row['thumb_img_title'];?>"  title="<?php echo $row['thumb_img_title'];?>" src="<?php echo $strHostName;?>/top_stories/<?php echo $row['thumb_img'];?>" width="265" height="90" >
    ...
    <div class="rate" style="border:solid 0px red; height:32px;">
      ...
      <div class="cupon_btn"><a href="<?php echo $strHostName;?>/deals/<?php echo $row['url_title']?>/<?php echo $converter->encode($row['deal_id']);?>" class="buttoncuponnoarrow" style="text-decoration:none; cursor:pointer;">Get Coupon</a></div>
    </div>
