      ...
      <div class="top">
        <div class="cal_12">
          <div class="DvFloat" style="padding-top: 2px;">
            <div class="health_greenbg_title_h" style="width:82%;"> <span style="text-align: center; text-transform: uppercase; font-size: 21px;" class="f_dwhite">Health</span> </div>
            ...
            <div class="hw_whitebg_title">
              <div class="contact_green_icon"><a href="<?php echo $strHostName;?>/page.php?dir=inbox/view_mails"  style="border:solid 0xp red;"><img src="images/contact_greenblue_icon.png" alt="" title="" border="0"></a></div>
