    ...
    <div class="DvFloat">
      <div class="DvFloat">
		...
		?>
          ...
          <a href="<?php echo $strHostName;?>/top_stories_details.php?cid=<?php echo $converter->encode($article_id); ?>&cateid=<?php echo $converter->encode($cateid); ?>"><span class="f_darkblack" style="font-size: 14px;"><?php echo $title;?></span></a> </div>
