...
$foldername=GetValue("select name as col from tbl_nutritionist_folder where id=".$folderid." and parentid=".$user_id, "col");
...
<table cellpadding="0" border="0" width="410px" align="center" style="background-color: #FFFFFF; border-radius:5px; font-size:15px; color:#a6a6a6; padding:0 15px 15px 15px;">
        ...
        <tr>
            <td style="padding:5px 5px 15px 15px; border-top: solid 0px #cccccc; border-bottom: solid 0px #cccccc;" valign="top">
                ...
                <input type="text" name="txtRename" id="txtRename" value="<?php echo $foldername;?>" style="width:280px; height:33px; margin:0 5px 0 0; font-size:15px;"><br /><br />
                ...
                <input type="submit" name="btnRename" id="btnRename" value="Rename" onclick="javascript:return ValidateRenameFolder();" style="width:25%; float:left; margin-top:22px;" class="button4"/>
