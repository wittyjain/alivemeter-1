...
function getPagingLinkBackEndFrontEnd($sqlrowscount, $itemPerPage = 10, $strGet = '',$newpagenumber ='',$strHostName='')
{
	...
	if ($totalPages > 0) {
		...
		if ($pageNumber > 1) {
			$page = $pageNumber - 1;
			if ($page > 1) {
				$prev = "<a  href=\"$self?page=$page&$strGet\" title='Next'><img src='images/next_md_paging.png' style='margin-top:10px;' alt='Next' /></a>&nbsp;&nbsp;";
			} else {
				$prev = "<a href=\"$self?$strGet\" ><img src='images/prev_md_paging.png' alt='Previous' /></a>&nbsp;&nbsp;";
			}	
				
			$first = "<a href=\"$self?page=1&$strGet\"><img src='images/prev_md_paging.png' alt='Previous'  /></a>";
		} else {
			$prev  = '<a><span class="disabled" style="color:#f0eeec; font-size:12px;"><img src="images/next_md_paging.png" alt="Next"  /></span></a>&nbsp;&nbsp;'; // we're on page one, don't show 'previous' link
			$first = '<a><span class="disabled"  style="color:#f0eeec; font-size:12px;"><img src="images/prev_md_paging.png" alt="Previous"  /></span></a>&nbsp;&nbsp;'; // nor 'first page' link
		}
		...
		if ($pageNumber < $totalPages) {
			$page = $pageNumber + 1;
			$next = "&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"$self?page=$page&$strGet\"><img src='images/prev_md_paging.png' alt='Previous'  /></a>&nbsp;&nbsp;";
			$last = "<a href=\"$self?page=$totalPages&$strGet\"><img src=images/next_md_paging.png /></a>";
		} else {
			$next = '&nbsp;&nbsp;&nbsp;&nbsp;<a><span class="disabled" style="color:#f0eeec; font-size:12px;"><img src="images/prev_md_paging.png" alt="Previous"  /></span></a>&nbsp;&nbsp;&nbsp;&nbsp;'; // we're on the last page, don't show 'next' link
			$last = '<a><span class="disabled" style="color:#f0eeec; font-size:12px;"><img src="images/next_md_paging.png" alt="Next"/></span></a>&nbsp;&nbsp;&nbsp;&nbsp;'; // nor 'last page' link
		}
		$start = $pageNumber - ($pageNumber % $numLinks) + 1;
		$end   = $start + $numLinks - 1;		
