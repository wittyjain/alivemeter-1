...
<table cellpadding="4" cellspacing="4"  style="width:100%" >
	  ...
	  <?php  while($get_array = mysql_fetch_array( $retrive_Array )){
	 	 $doc_upload_count=GetValue("select Count(*) as col from tbl_doc_consult_gallery where  userid=$user_id and report_type=3", "col");
	  ...
	  <?php  } ?>
	   ...
	   <tr>
      	<td colspan="4" style="text-align:right; font-size:12px; padding-top:10px;"><a href="<?php echo $strHostName;?>/page.php?dir=health/radiology_report" style="text-decoration:underline;">View More</a></td>
      </tr>
      <?php } ?>
