...
<?php
	$page=1;$page_count=12;$newpagenumber="2";$retrive_Array=array();$get_array=array(); $doctor_name="";
	if(isset($_GET['page'])){
		$page=$_GET['page'];
	}
	else
	...
	$pagingLink = getPagingLinkBackEndFrontEnd($nume,$page_count,'dir=inbox/view_mails&status='.$_GET['status'].'&folderid='.$_GET['folderid'].'',$newpagenumber,$strHostName."/page.php");
						...
						<td class="lightInboxbg21" style="width:100px;">
                         ...
                         <td class="lightInboxbg3"> 
							<?php  
								...
								if ($get_array['mail_type']=="Nutritionist_Reply" || $get_array['mail_type']=="Nutritionist")
								{
									echo "Nutritionist";
								}
								else
								...
								if ($doctor_name=="" && $get_array['mail_type']!="Nutritionist_Reply" && $get_array['mail_type']!="Nutritionist")
								{
...
<?php } ?>
       <?php if ($nume > 12) { ?>     
 			<div class="DvFloat" style="display:'';">
