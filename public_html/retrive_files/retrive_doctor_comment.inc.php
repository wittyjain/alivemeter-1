  ...
  <div class="DvFloat" style="margin-bottom:30px;">
    <table class="tablecont" cellpadding="2" cellspacing="1" width="100%" border="0">
      <tbody>
        ...
        <?php  } ?>
        <tr>
          <td colspan="6" style="text-align:right; padding:10px 0;"><a href="<?php echo $strHostName;?>/page_doctor.php?dir=doctor/my_comments&patient_id=<?php echo $converter->encode($_GET['patient_id']);?>" class="button4" style="width:200px; text-align:center; float:right;" target="_blank">View All My Comments </a></td>
        </tr>
        <tr>
