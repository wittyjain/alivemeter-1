        ...
        <div class="cal_12" style="text-align: justify; padding:45px 0;">
          <div class="DvFloat" style="border: solid 0px #0066CC;">
            <ul id="countrytabs" class="shadetabs">
              ...
              <li><a href="<?php echo $strHostName;?>/patients_doctor.php" rel="country2" style="width:250px;"  class="selected">Patients Accepted By Doctor</a></li>
            ...
            <div style="border: 0px solid gray; width: 965px; float: left; margin-bottom: 1em; padding: 10px 0px; background-color: #FFFFFF; color: #666666;">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                       <tr>
                          ...
                          <td class="tbl_head">Comment Date</td>
                          <td class="tbl_head">Doctor Name</td>
                       </tr>
                      
                      <?php  
					$query = "SELECT * FROM  ".Patients." where isactive=1 and isdeleted=0 and doctor_id in (select doctor_id from tbl_doctor where hospital_name=".$hospital_id.")";
						//echo $query;
							...
							if($result != "") {	
								...
								if($rowcount > 0) {
									while($row = mysql_fetch_assoc($result)) {
										...
										$doc_name=GetValue("select doctor_name as col from ".Doctor." where doctor_id=".$doctor_id."", "col");
                       ...
                       <tr>
                              ...
                              <td class="tdborder" style="padding:10px 20px;"><?php echo $doc_name;?> </td>
                       </tr>
                     <?php }}} ?> 
