...
<div class="cal_12 m_outo">
      ...
      <div style="float:left; padding:0px 0px 0px 0px; height:50px; border:solid 0px red;">
        <ul class="calorie_setup">
          <li class="active"  style="width:350px;">
            <div>
              <div class="Step_title_d_Grey"><a href="#" title="Step 2" style="padding:0px; margin:0px; text-align:left;color:#7ca500">Health dashboard </a></div>
              <span><a href="#" title=""><img src="images/calorie_setup/health_dashboard_icon.png" alt="" /></a></span><a href="calorie_setup1.html" title=""> </a></div>
          </li>
  ...
  <div class="dvFloat">
            ...
            <div class="DvFloat">
              ...
              <div class="DvFloat" style="padding: 15px 0px; border-bottom: solid 1px #c5c5c5;">
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td class="nutri_caloriecount_box1"><div class="hover"> <img src="images/nutritionist/green_chat_icon.png" alt="" title="" border="0">
                        <div class="tooltip">
                          <div class="DvFloat">
                            <textarea name="Commenthere" id="Commenthere" style="width: 415px; height: 95px; background-color: #FFFFFF; box-shadow: none; border: solid 0px #cccccc;">Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit.
                            </textarea>
                          </div>
                          <div style="border: solid 0px #003300; width: 88%; float: left;">
                            <div style="width: 22px; height: 22px; float: left;border: solid 0px #00CC00;"><img src="images/prev_md_paging.png" alt="" title="" border="0"></div>
                            <div style="width: 381px; height: 22px; float: left;border: solid 0px #0000FF; text-align: center; font-weight: bold; padding-top: 3px;"><a href="#" class="f_green">1</a> / 2</div>
                            <div style="width: 22px; height: 22px; float: left;border: solid 0px #330099;"><img src="images/next_md_paging.png" alt="" title="" border="0"></div>
                          </div>
                          <!--<div class="DvFloat">
                            <div style="padding-left: 150px; float: left; padding-top: 3px;">
                              <div style=" width:85px; height:30px; float:left; text-align: center"> <a href="register_step2.html" class="button1" style="text-align:center">Send</a> </div>
                            </div>
                          </div>-->
                        </div>
                      </div></td>
                    ...
                    <td class="nutri_caloriecount_box3"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td style="width: 65%; text-align: center; line-height: 14px;"><span style="font-size: 16px;">4630</span><br>
                    ...
                    <td class="nutri_sep"></td>
                    <td class="nutri_caloriecount_box4" style="text-align: center; line-height: 14px;"><span style="font-size: 16px; text-align: center; ">4630</span><br>
                      <span style="font-size: 10px;">Calories</span></td>
                    <td class="nutri_sep"></td>
    ...
    position: absolute;"></div>
                      ...
                      <div style="width: 320px; height: 38px; float: left; background-image: url(images/nutritionist/grey_line.png); background-repeat: repeat-x; padding: 0px; border: solid 0px #000000;">
                        <div style="width: 202px; height: 22px; float: left; background-color: #f0f0f0; padding:8px 0px;">&nbsp;</div>
                        <div style="width: 167px; float: left; height: 12px; background-color: #99cc00; margin: 13px 0px 0px 0px; position: absolute;"></div>
                     </div>
                      </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td class="nutri_caloriecount_box3"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td style="width: 65%; text-align: center; line-height: 14px;"><span style="font-size: 16px;">1820</span><br>
                            <span style="font-size: 10px;">Calories</span></td>
                    ...
                    <td class="nutri_sep"></td>
                    <td class="nutri_caloriecount_box4" style="text-align: center; line-height: 14px;"><span style="font-size: 16px; text-align: center; ">779</span><br>
                      <span style="font-size: 10px;">Calories</span></td>
                    <td class="nutri_sep"></td>
                    <td class="nutri_caloriecount_box5">
                    <!--<div style="width: 189px; float: left; background-color: #f0f0f0; padding:8px 0px;">&nbsp;</div>
    ...
    position: absolute;"></div>
                      ...
                      <div style="width: 320px; height: 38px; float: left; background-image: url(images/nutritionist/grey_line.png); background-repeat: repeat-x; padding: 0px; border: solid 0px #000000;">
                        ...
                        <div style="width: 134px; float: left; height: 12px; background-color: #99cc00; margin: 13px 0px 0px 0px; position: absolute;"></div>
                     </div>
                      </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td class="nutri_caloriecount_box3"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td style="width: 65%; text-align: center; line-height: 14px;"><span style="font-size: 16px;">01:19</span><br>
                    ...
                    <td class="nutri_sep"></td>
                    <td class="nutri_caloriecount_box4" style="text-align: center; line-height: 14px;"><span style="font-size: 16px; text-align: center; ">02:15</span><br>
                      <span style="font-size: 10px;">HH:MM</span></td>
                    <td class="nutri_sep"></td>
                    <td class="nutri_caloriecount_box5">
                    	<!--<div style="width: 189px; float: left; background-color: #f0f0f0; padding:8px 0px;">&nbsp;</div>
    ...
    position: absolute;"></div>
                      ...
                      <div style="width: 320px; height: 38px; float: left; background-image: url(images/nutritionist/grey_line.png); background-repeat: repeat-x; padding: 0px; border: solid 0px #000000;">
                        ...
                        <div style="width: 288px; float: left; height: 12px; background-color: #99cc00; margin: 13px 0px 0px 0px; position: absolute;"></div>
                     </div>
                      </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td class="nutri_caloriecount_box1"><img src="images/nutritionist/grey_chat_icon.png" alt="" title="" border="0"></td>
                    <td class="nutri_sep"></td>
                    <td class="nutri_caloriecount_box2"><select id="Weight" name="Weight" tabindex="1" class="existing_event" style="width: 45px;">
                    ...
                    <td class="nutri_caloriecount_box3"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td style="width: 65%; text-align: center; line-height: 14px;"><span style="font-size: 16px; text-align: center; ">No Data</span><br>
                            <span style="font-size: 10px;">Current size</span></td>
                          <td style="width: 35%; text-align: center; vertical-align:top"><img src="images/nutritionist/weight_icon.png" alt="" title="" border="0"></td>
                        </tr>
                      </table></td>
                    <td class="nutri_sep"></td>
                    <td class="nutri_caloriecount_box4" style="text-align: center; line-height: 14px;"><span style="font-size: 16px; text-align: center; ">5324</span><br>
                      <span style="font-size: 10px;">Current size</span></td>
                    <td class="nutri_sep"></td>
                    <td style="width: 312px;"><div style="float: left; padding: 0px 5px; width: 97%; background-color: #f0f0f0;">
                        <div style="float: left; background-color: #f0f0f0; padding:8px 5px; font-size: 11px;"><span class="f_grey">You have not logged your waist.</span><br>
                          <span class="f_green">Add Waist Measurement</span></div>
                      </div>
                      <!--<div style="width: 270px; float: left; height: 12px; background-color: #99cc00; margin: 13px 0px 0px 0px;
    position: absolute;"></div>
                                                                        <div style="width: 105px; float: right; background-image: url(images/nutritionist/grey_line.png); background-repeat: repeat-x; height: 38px;"></div>-->
    ...
    position: absolute;"></div>
                  ...
                  <tr>
                    <td colspan="8" style="background-color: #FFFFFF; padding: 8px 0px;">
                    	<table width="100%" border="0" cellpadding="0" cellspacing="0">
                        	<tr>
                            	<td style="font-weight: bold;">Add to list:</td>
                                <td><img src="images/nutritionist/plus_icon.png" alt="" title="" border="0"></td>
                                <td>Cholesterol,</td>
                                <td><img src="images/nutritionist/plus_icon.png" alt="" title="" border="0"></td>
                                <td>Triglyceride,</td>
                                <td><img src="images/nutritionist/plus_icon.png" alt="" title="" border="0"></td>
                  ...
                  <div id="tabs1" class="tabcontent">
                    ...
                    <div  style="width:755px; border:solid 0px red;margin-left:5px;">
                              ...
                              <div class="DvFloat" style="padding: 15px 0px; border-bottom: solid 1px #c5c5c5;">
                                                                                    ...
                                                                                    </div><div class="DvFloat" style="padding-top:20px">
                                                                                        	<span class="f_green" style="font-size: 18px; font-weight: bold;">Medical reports  and Presscription </span>
                                                                                        </div>
