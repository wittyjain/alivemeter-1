...
<meta property="og:url" content="<?php echo $strHostName;?>/top_stories_details.php?cid=<?php echo $_GET['cid'];?>&cateid=<?php echo $strGetCatId;?>" />
                        ...
                        <div class="DvFloat" style="padding-bottom: 15px;">
                            <div class="titledv">
                             ...
                             <div class="titlefollowdv">
								  ...
								  <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $strHostName;?>/stories/<?php echo $get_array['url_title']?>/<?php echo $_GET['cid'];?>" target="_blank"><img src="<?php echo $strHostName;?>/images/facebook_btn.png" alt="" title=""></a>
