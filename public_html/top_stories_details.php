...
<meta property="og:url" content="<?php echo $strHostName;?>/stories/<?php echo $row_1['url_title']?>/<?php echo $converter->encode($row_1['cover_story_id']); ?>" />
...
<?php include 'includes/top.php'?>
 ...
 $cid="0";
	...
	$cat_name=GetValue("select category_name as col from tbl_category where category_id=".$strGetCatId, "col");
	$pagingLink="";
	$doc_consult_count="";
    ...
    <div class="top_in" style="border: solid 0px #000066;">
     ...
     <ul id="dd_nav">
		...
		<li><a href="#" style="background: #d9c727;width:120px; text-decoration:none; text-align:center;padding-left:0px">Happiness stories</a></li>
                        ...
                        <div class="DvFloat" style="padding-bottom: 15px;">
                            <div class="titledv">
                             ...
                             <div class="titlefollowdv">
								  ...
								  <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $strHostName;?>/stories/<?php echo $_GET['url_code']?>/<?php echo $_GET['cid'];?>" target="_blank"><img src="<?php echo $strHostName;?>/images/facebook_btn.png" alt="" title=""></a>
			...
			$dcid=$cid-1;
			$query_p = "SELECT * FROM  ".Top_Story." where isactive=1 and isdeleted=0 and category_id=".$strGetCatId." and cover_story_id <> ".$cid." and cover_story_id > ".$cid." order by  cover_story_id limit  1";
			//// echo $query_c;
		...
		?>
                                 <?php if($rowcount_p!="" && $rowcount_p!="0") { ?>
                                        <div style="width: 49%; float: left; border: solid 0px #000000;">
                                           <a href="<?php echo $strHostName;?>/stories/<?php echo $row_p['url_title']?>/<?php echo $converter->encode($row_p['cover_story_id']); ?>">
                                                <div style="width: 43px; float: left; border: solid 0px #0000FF;">
                                                        
                                                            <img src="<?php echo $strHostName?>/images/prev_paging.png" alt="" title="" border="0">
			...
			$dcid=$cid-1;
			$query_p_1 = "SELECT * FROM  ".Top_Story." where isactive=1 and isdeleted=0 and category_id < ".$strGetCatId." order by category_id desc limit 1";
		 //  echo $query_p_1;
		...
		?>
									  <?php if($rowcount_p_1!="" && $rowcount_p_1!="0") { ?>
                                    	 <div style="width: 49%; float: left; border: solid 0px #000000;">
                                           <a href="<?php echo $strHostName;?>/stories/<?php echo $row_n_1['url_title']?>/<?php echo $converter->encode($row_n_1['cover_story_id']); ?>">
			...
			$dcid=$cid-1;
			$query_n = "SELECT * FROM  ".Top_Story." where isactive=1 and isdeleted=0 and category_id=".$strGetCatId." and cover_story_id <> ".$cid." and cover_story_id < ".$cid." order by  cover_story_id desc limit  1";
		//  echo $query_c;
		...
		?>
									  <?php if($rowcount_n!="" && $rowcount_n!="0") { ?>
                                       ...
                                       <a href="<?php echo $strHostName;?>/stories/<?php echo $row_n['url_title']?>/<?php echo $converter->encode($row_n['cover_story_id']); ?>">
                                            ...
                                            <div style="width: 43px; float: left; border: solid 0px #0000FF; text-align: right;">
                                                  ...
                                                  <img src="<?php echo $strHostName?>/images/next_paging.png" alt="" title="" border="0">
		...
		?>
									  <?php if($rowcount_p_2!="" && $rowcount_p_2!="0") { ?>
                                        ...
                                        <?php ////echo $cateid_n;?>
                                         <div style="width: 50%; float: right; border: solid 0px #000000;">
                                       <a href="<?php echo $strHostName;?>/stories/<?php echo $row_n_2['url_title']?>/<?php echo $converter->encode($row_n_2['cover_story_id']); ?>">
                                            <div style="width: 272px; float: left; border: solid 0px #996600;">
                                                <div class="DvFloat">
                                                    <div class="DvFloat" style="text-align:right;"><span class="npgreentext">Next story</span></div>
                                                    <div class="DvFloat" style="padding-top: 5px; text-align:right;"><span class="f_darkblack"><?php echo $title_n;?><br /></span></div>
