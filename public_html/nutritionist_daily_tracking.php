      ...
      <div class="dvFloat">
        <div class="dvWrapper">
          <div style=" padding:0px 0px 35px 0px">
              ...
              <div class="dvFloat">
                <div style="float:left; padding:0px 0px 10px 0px;"> <a href="nutritionist_medication.html"><img src="images/nutritionist/medication.jpg" alt=""></a> </div>
              </div>
              <div class="dvFloat">
                <div style="float:left; padding:0px 0px 10px 0px;"> <a href="nutritionist_hospitalization.html"><img src="images/nutritionist/hospitalization.jpg" alt=""></a> </div>
              </div>
              <div class="dvFloat">
                <div style="float:left; padding:0px 0px 10px 0px;"> <a href="nutritionist_immunization.html"><img src="images/nutritionist/immunization.jpg" alt=""></a> </div>
              </div>
              <div class="dvFloat">
                <div style="float:left; padding:0px 0px 10px 0px;"> <a href="nutritionist_health_problem.html"><img src="images/nutritionist/health_problems.jpg" alt=""></a> </div>
              </div>
              <div class="dvFloat">
                <div style="float:left; padding:0px 0px 10px 0px;"> <a href="nutritionist_daily_tracking.html"><img src="images/nutritionist/daily_tracking.jpg" alt=""></a> </div>
              </div>
              <div class="dvFloat">
                                                	<div style="float:left; padding:0px 0px 10px 0px;">
                                                    	<a href="nutritionist_allergies.html"><img src="images/nutritionist/allergies_h.jpg" alt=""></a>
                                                    </div>
                                                </div>
              <div class="dvFloat">
                                                	<div style="float:left; padding:0px 0px 0px 0px;">
                                                    	<a href="nutritionist_family_history.html"><img src="images/nutritionist/family_history.jpg" alt=""></a>
                                                    </div>
                                                </div>
            </div>
              ...
              <div class="TabDv">
                <div>
                  <ul id="tabstabs" class="shadetabs">
                    <li  class="selected"><a href="#" rel="tabs1" class="selected" >Blood Pressure</a></li>
                    <li><a href="#" rel="tabs2"  >Sugar Profile</a></li>
                    <li><a href="#" rel="tabs3">Lipid Profile</a></li>
                    <li><a href="#" rel="tabs4">Lifestyle</a></li>
                  </ul>
                </div>
                <div class="TabContentDetails">
                    ...
                    <div style="width:760px; border:solid 0px red;" id="divtab8">
                      ...
                      <div class="DvFloat">
                        <div  style="width:98%; border:solid 0px red;">
                          <div class="dvFloat formpadding1" style="padding:0px 0px 5px 0px; border-bottom: solid 1px #e1e1e1;"> <a  onClick="showform();" style="cursor:pointer"><img src="images/nutritionist/add_to_list.jpg" alt="" /></a> </div><div id="divShowHideForm" style="display: none">
                  ...
                  <div id="tabs2" class="tabcontent">
                    <div style="width:760px; border:solid 0px red;" id="divtab9">
                      ...
                      <div class="DvFloat">
                        <div  style="width:98%; border:solid 0px red;">
                          <div class="dvFloat formpadding1" style="padding:0px 0px 5px 0px; border-bottom: solid 1px #e1e1e1;"> <a  onClick="showform1();" style="cursor:pointer"><img src="images/nutritionist/add_to_list.jpg" alt=""></a></div>
                  ...
                  <div id="tabs3" class="tabcontent">
                    <div style="width:760px; border:solid 0px red;" id="divtab10">
                      ...
                      <div class="DvFloat">
                        <div  style="width:98%; border:solid 0px red;">
                          <div class="dvFloat formpadding1" style="padding:0px 0px 5px 0px; border-bottom: solid 1px #e1e1e1;"> <a  onClick="showform2();" style="cursor:pointer"><img src="images/nutritionist/add_to_list.jpg" alt=""></a> </div>
                  ...
                  <div id="tabs4" class="tabcontent">
                    <div style="width:760px; border:solid 0px red;" id="divtab11">
                      ...
                      <div class="DvFloat">
                        <div class="dvFloat formpadding1" style="padding:0px 0px 5px 0px; border-bottom: solid 1px #e1e1e1;"> <a  onClick="showform3();" style="cursor:pointer"><img src="images/nutritionist/add_to_list.jpg" alt=""></a> </div>
                      </div>
