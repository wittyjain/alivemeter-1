...
document.getElementById("txt_HD_immunization_Name").focus();
</script>
<script>
...
<header>
  ...
  <div class="head">
    <div style="width: 25px; position: fixed; top: 140px; right: 0px;"><img src="images/search_icon.png" alt="" title="" border="0"></div>
    <div style="width: 25px; position: fixed; top: 175px; right: 0px;"><img src="images/mail_icon.png" alt="" title="" border="0"></div>
      ...
      <div class="dvFloat">
        <div class="dvWrapper">
          <div style=" padding:0px 0px 35px 0px">
              ...
              <div class="dvFloat">
                <div style="float:left; padding:0px 0px 10px 0px;"> <a href="health_dash_board_immunization.html"><img src="images/nutritionist/immunization_h.jpg" alt=""></a> </div>
              </div>
              <div class="dvFloat">
              ...
              <div style="width:99%; border:solid 0px red;">
                  ...
                  <div class="dvFloat formpadding1">
                    <div class="formlabelHDB1">
                      <label class="formlabelHDB">Name<span class="redtxt">*</span> </label>
                    </div>
                    <div class="formcontrol2-2">
                      <textarea id="txt_HD_immunization_Name" name="txt_HD_immunization_Name"></textarea>
                    </div>
                  </div>
                  <div class="dvFloat formpadding1">
                    <div class="formlabelHDB1">
                      <label class="formlabelHDB">Date Administered<span class="redtxt">*</span> </label>
                    </div>
                    <div class="formcontrol2">
                      <div class="dvFloat">
                        <div style="float:left; padding:0px 15px 0px 0px">
                          <select  id="txt_HD_immunization_Date"  name="txt_HD_immunization_Date" tabindex="1" class="existing_event" style="width: 0px;">
                        ...
                        <div style="float:left; padding:0px 15px 0px 0px">
                          <select  id="txt_HD_immunization_Month"  name="txt_HD_immunization_Month" tabindex="1" class="existing_event" style="width: 0px;">
                        ...
                        <div style="float:left; padding:0px 0px 0px 0px">
                          <select  id="txt_HD_immunization_Year"  name="txt_HD_immunization_Year" tabindex="1" class="existing_event" style="width: 5px;">
                  ...
                  <div class="dvFloat formpadding1">
                    <div class="formlabelHDB1">
                      <label class="formlabelHDB">Next Visit Reminder </label>
                    </div>
                    <div class="formcontrol2">
                      <div class="dvFloat">
                        <div style="float:left; padding:0px 15px 0px 0px">
                          <select  id="txt_HD_immunization_Date1"  name="txt_HD_immunization_Date1" tabindex="1" class="existing_event" style="width: 0px;">
                            <option value="DD">DD</option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                        ...
                        <div style="float:left; padding:0px 15px 0px 0px">
                          <select  id="txt_HD_immunization_Month1"  name="txt_HD_immunization_Month1" tabindex="1" class="existing_event" style="width: 0px;">
                            <option value="MM">MM</option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                        ...
                        <div style="float:left; padding:0px 15px 0px 0px">
                          <select  id="txt_HD_immunization_Year1"  name="txt_HD_immunization_Year1" tabindex="1" class="existing_event" style="width: 0px;">
                            <option value="YYYY">YYYY</option>
                            <option>2006</option>
                            <option>2007</option>
                            <option>2008</option>
                        ...
                        <div style="float:left; padding:0px 15px 0px 0px">
                          <select  id="txt_HD_immunization_hour"  name="txt_HD_immunization_hour" tabindex="1" class="existing_event" style="width: 0px;">
                            <option value="HH">HH</option>
                          </select>
                        </div>
                        <div style="float:left; padding:0px 0px 0px 0px">
                          <select  id="txt_HD_immunization_Min"  name="txt_HD_immunization_Min" tabindex="1" class="existing_event" style="width: 0px;">
