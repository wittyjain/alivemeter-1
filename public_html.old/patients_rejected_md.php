          ...
          <div class="DvFloat" style="border: solid 0px #0066CC;">
            ...
            <div style="border: 0px solid gray; width: 965px; float: left; margin-bottom: 1em; padding: 10px 0px; background-color: #FFFFFF; color: #666666;">
              <div class="DvFloat" style="margin:0 0 10px 0;">
                  ...
                  <li><a href="<?php echo $strHostName;?>/patients_rejected_md.php" rel="country3" style="width:250px;"  class="selected">Rejected By MD</a></li>
              ...
              <div class="dvFloat"> 
              	<table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <?php  
						$query = "SELECT * FROM  ".MD_Comment." where rejected=1 and  ref_doctor_id in (select doctor_id from tbl_doctor where hospital_name=".$hospital_id.")";
						//echo $query;
