...
document.getElementById("cmb_HD_Hospitalization_Date").focus();
        ...
        <div class="dvWrapper">
          <div style=" padding:0px 0px 35px 0px">
              ...
              <div class="dvFloat">
                ...
                <div style="float:left; padding:0px 0px 10px 0px;"> <a href="health_dash_board_hospitalization.html"><img src="images/nutritionist/hospitalization_h.jpg" alt=""></a> </div>
              </div>
              <div class="dvFloat">
            ...
            <div class="health_dashboard_div_right">
              ...
              <div  style="width:99%; border:solid 0px red;">
                 <div class="dvFloat formpadding" style="padding:10px 0px 0px 0px">
                    <div class="formlabel1" style="padding:0px">
                      <label class="formlabel1" style="padding:0px">
                    ...
                    <table cellpadding="0" cellspacing="0"  style="width:100%" >
                      ...
                      <tr>
                        ...
                        <td class="tdborder" style="padding-left:20px;"><table cellpadding="0" cellspacing="0"  style="width:100%" >
                            <tr>
                              <td class="SubTd"><a id="fancybox-manual-c" style="cursor: pointer;"><img src="images/register_steps/view_icon.jpg" alt=""></a></td>
                  ...
                  <div class="dvFloat formpadding1" style="padding:10px 0px 5px 0px; border-bottom: solid 1px #e1e1e1;">
                           
                              <a onClick="showform();" style="cursor:pointer"><img src="images/nutritionist/add_to_list.jpg" alt="" /></a>
                             
                          </div><div id="divShowHideForm" style="display: none">
                  <div class="dvFloat formpadding1">
                    <div class="formlabelHDB1">
                      <label class="formlabelHDB">Date of Hospitalization <span class="redtxt">*</span> </label>
                    </div>
                    <div class="formcontrol2">
                      <div class="dvFloat">
                        <div style="float:left; padding:0px 15px 0px 0px">
                          <select id="cmb_HD_Hospitalization_Date" name="cmb_HD_Hospitalization_Date" tabindex="1" class="existing_event" style="width: 5px;">
                        ...
                        <div style="float:left; padding:0px 15px 0px 0px">
                          <select id="cmb_HD_Hospitalization_Month" name="cmb_HD_Hospitalization_Month" tabindex="1" class="existing_event" style="width: 0px;">
                        ...
                        <div style="float:left; padding:0px 0px 0px 0px">
                          <select id="cmb_HD_Hospitalization_Year" name="cmb_HD_Hospitalization_Year" tabindex="1" class="existing_event" style="width: 5px;">
                  ...
                  <div class="dvFloat formpadding1">
                    <div class="formlabelHDB1">
                      <label class="formlabelHDB">Hospital Name<span class="redtxt">*</span> </label>
                    </div>
                    <div class="formcontrol2">
                      <textarea id="txt_HD_Hospital_Name" name="txt_HD_Hospitalization_Hospital_Name"></textarea>
                    </div>
                  </div>
                  <div class="dvFloat formpadding1">
                    <div class="formlabelHDB1">
                      <label class="formlabelHDB">Doctor Consulted <span class="redtxt">*</span> </label>
                    </div>
                    <div class="formcontrol2">
                      <select id="cmb_HD_Hospitalization_Doctor_Consulted" name="cmb_HD_Hospitalization_Doctor_Consulted" tabindex="1" class="existing_event" style="width: 35px;">
                        <option value="Select">Select</option>
                      </select>
                      <div class="div_input_text1" style="font-size: 12px;">Did not find your Doctor in List? <span style="text-decoration: underline;"><a href="" class="btnclickhere">Click  here</a></span> to Add One 
                            <div class="frmclickhere">
                  ...
                  <div class="dvFloat formpadding1">
                    <div class="formlabelHDB1">
                      <label class="formlabelHDB">Reason of Admission<span class="redtxt">*</span> </label>
                    </div>
                    <div class="formcontrol2">
                      <textarea id="txt_HD_Hospital_Name" name="txt_HD_Hospitalization_Reason_of_Admission"></textarea>
                    </div>
                  </div>
                  <div class="dvFloat formpadding1">
                    <div class="formlabelHDB1">
                      <label class="formlabelHDB">Diagnosis </label>
                    </div>
                    <div class="formcontrol2">
                      <textarea id="txt_HD_Hospital_Name" name="txt_HD_Hospitalization_Diagnosis"></textarea>
                    </div>
                  </div>
                  <div class="dvFloat formpadding1">
                    <div class="formlabelHDB1">
                      <label class="formlabelHDB">Discharge Details </label>
                    </div>
                    <div class="formcontrol2"> </div>
                  </div>
                  <div class="dvFloat formpadding1">
                    <div class="formlabelHDB1">
                      <label class="formlabelHDB">Discharge Date<span class="redtxt">*</span></label>
                    </div>
                    <div class="formcontrol2">
                      <div class="dvFloat">
                        <div style="float:left; padding:0px 15px 0px 0px">
                          <select id="cmb_HD_Hospitalization_Discharge_Date" name="cmb_HD_Hospitalization_Discharge_Date" tabindex="1" class="existing_event" style="width: 2px;">
                            <option value="DD">DD</option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                        ...
                        <div style="float:left; padding:0px 15px 0px 0px">
                          <select id="cmb_HD_Hospitalization_Discharge_Month" name="cmb_HD_Hospitalization_Discharge_Month" tabindex="1" class="existing_event" style="width: 2px;">
                            <option value="MM">MM</option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                        ...
                        <div style="float:left; padding:0px 0px 0px 0px">
                          <select id="cmb_HD_Hospitalization_Discharge_Year" name="cmb_HD_Hospitalization_Discharge_Year" tabindex="1" class="existing_event" style="width: 5px;">
                            <option value="YYYY">YYYY</option>
                            <option>2006</option>
                            <option>2007</option>
                            <option>2008</option>
                  ...
                  <div class="dvFloat formpadding1">
                    <div class="formlabelHDB1">
                      <label class="formlabelHDB">Diagnosis Summary </label>
                    </div>
                    <div class="formcontrol2">
                      <textarea id="txt_HD_Hospitalization_Diagnosis_Summary" name="txt_HD_Instruction_For_Medicine"></textarea>
                    </div>
                  </div>
                  <div class="dvFloat formpadding1">
                    <div class="formlabelHDB1">
                      <label class="formlabelHDB">Follow-up Details </label>
                    </div>
                    <div class="formcontrol2"> </div>
                  </div>
                  <div class="dvFloat formpadding1">
                    <div class="formlabelHDB1">
                      <label class="formlabelHDB">Doctor Instruction </label>
                    </div>
                    <div class="formcontrol2">
                      <textarea id="txt_HD_Hospitalization_Doctor_Instruction" name="txt_HD_Instruction_For_Medicine"></textarea>
                    </div>
                  </div>
                  <div class="dvFloat formpadding1">
                    <div class="formlabelHDB1">
                      <label class="formlabelHDB">Next Visit Date </label>
                    </div>
                    <div class="formcontrol2">
                      <div class="dvFloat">
                        <div style="float:left; padding:0px 15px 0px 0px">
                          <select id="cmb_HD_Hospitalization_Next_Visit_Date" name="cmb_HD_Hospitalization_Next_Visit_Date" tabindex="1" class="existing_event" style="width: 0px;">
                            <option value="DD">DD</option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                        ...
                        <div style="float:left; padding:0px 15px 0px 0px">
                          <select id="cmb_HD_Hospitalization_Next_Visit_Month" name="cmb_HD_Hospitalization_Next_Visit_Month" tabindex="1" class="existing_event" style="width: 0px;">
                            <option value="MM">MM</option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                        ...
                        <div style="float:left; padding:0px 0px 0px 0px">
                          <select id="cmb_HD_Hospitalization_Next_Visit_Year" name="cmb_HD_Hospitalization_Next_Visit_Year" tabindex="1" class="existing_event" style="width: 5px;">
                            <option value="YYYY">YYYY</option>
                            <option>2006</option>
                            <option>2007</option>
                            <option>2008</option>
                  ...
                  <div class="dvFloat formpadding1">
                    <div class="formlabelHDB1">
                      <label class="formlabelHDB">Reminder Date</label>
                    </div>
                    <div class="formcontrol2">
                      <div class="dvFloat">
                        <div style="float:left; padding:0px 15px 0px 0px">
                          <select id="cmb_HD_Hospitalization_Reminder_Date" name="cmb_HD_Hospitalization_Reminder_Date" tabindex="1" class="existing_event" style="width: 0px;">
                            <option value="DD">DD</option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                        ...
                        <div style="float:left; padding:0px 15px 0px 0px">
                          <select id="cmb_HD_Hospitalization_Reminder_Date_Month" name="cmb_HD_Hospitalization_Reminder_Date_Month" tabindex="1" class="existing_event" style="width: 0px;">
                            <option value="MM">MM</option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                        ...
                        <div style="float:left; padding:0px 0px 0px 0px">
                          <select id="cmb_HD_Hospitalization_Reminder_Date_Year" name="cmb_HD_Hospitalization_Reminder_Date_Year" tabindex="1" class="existing_event" style="width: 0px;">
                            <option value="YYYY">YYYY</option>
                            <option>2006</option>
                            <option>2007</option>
                            <option>2008</option>
