            ...
            <li>
                <a href="#" class="button_s"> <span class="txt"><?php echo $_SESSION['UserDocName']; ?></span> <span class="ar">&#9660;</span> </a>
                     ...
                     <ul style="width: 247px; background-color: #83a819;">
                        ...
                        <li style="border-top: solid 1px #aac457;padding-top:0px;margin-top:5px;"><a href="<?php echo $strHostName;?>/page_doctor.php?dir=team/change_password">Change Password</a></li>
                       <?php  if($_SESSION['UserType']=="Doctor" || $_SESSION['UserType']=="MD") { ?>
                        	<li style="border-top: solid 1px #aac457;padding-top:0px;margin-top:5px;"><a href="#">Video Query</a></li>
                        <?php } ?>
                        <li style="border-top: solid 1px #aac457;padding-top:0px;margin-top:5px;"><a href="index.php?type=<?php echo $converter->encode("logout") ?>">Logout</a></li>
                    </ul>
