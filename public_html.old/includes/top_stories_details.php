...
<meta property="og:url" content="<?php echo $strHostName;?>/deals_detailspage.php?cid=<?php echo $_GET['cid'];?>&cateid=<?php echo $_GET['cateid'];?>" />
                        ...
                        <div class="DvFloat" style="padding-bottom: 15px;">
                            <div class="titledv">
                             ...
                             <div class="titlefollowdv">
								  ...
								  <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $strHostName;?>/top_stories_details.php?cid=<?php echo $_GET['cid'];?>%26cateid=<?php echo $_GET['cateid'];?>&t=<?php echo $meta_title?>" target="_blank"><img src="<?php echo $strHostName;?>/images/facebook_btn.png" alt="" title=""></a>
