...
class db_class {
   ...
   function dump_query($sql) {
      ...
      $r = $this->select($sql);
      if (!$r) return false;
      echo "<div style=\"border: 1px solid blue;  margin: 8px;\">\n";
   ...
   function insert_array($table, $data) {
      ...
      foreach ($data as $key=>$value) {     // iterate values to input
		 ...
		 //Alert ($key.$col_type); // get column type
 ...
 // echo $sql;
   ...
   function print_last_error($show_query=true) {
      ...
      ?>
      <div style="border: 1px solid red; font-size: 9pt;  color: red; padding: .5em; margin: 8px; background-color: #FFE2E2">
   ...
   function print_last_query() {
      ...
      ?>
      <div style="border: 1px solid blue; font-size: 9pt;  color: blue; padding: .5em; margin: 8px; background-color: #E6E5FF">
