<?php
$strDietPlanDisplay=""; $total_cal="0"; $total_burnt_cal="0";
?>
...
$total_burnt_cal=GetValue("select sum(cal*min) as col from tbl_diet_exercise where patient_id=".$patient_id." and selected_date='".$cur_date."'", "col");

////echo "select sum(cal*min) as col from tbl_diet_exercise where patient_id=".$patient_id." and selected_date='".$cur_date."'";
...
<div class="DvFloat">
  <div class="DvFloat">
   ...
   <span style="display:<?php echo $strDietPlanDisplay;?>" id="dvMainTotalCalorie"> 
    ...
    &nbsp;&nbsp;&nbsp;&nbsp; 
    <span style="display:<?php echo $strDietPlanDisplay;?>" id="dvMainTotalBurntCalorie">  
    Total burnt calories : 
	 <span id="dvTotalBurntCalorie">
	<?php if($total_burnt_cal=="" || $total_burnt_cal=="null")
	{
		echo "0";
	} 
	else
	{
		echo $total_burnt_cal;	
	}?> cal
    </span>
  ...
  <div class="DvFloat" style="display:<?php echo $strDietPlanDisplay?>">
    ...
    <div class="DvFloat" style="margin-top:30px;">
     ...
     <tr>
          ...
          <td valign="top"><textarea id="txtNote" name="txtNote" style="width:765px; height:40px;"></textarea>
     ...
     <tr>
          ...
          <td valign="top"><textarea id="txtMessage" name="txtMessage" style="width:765px; height:350px;" rows="10" cols="100"></textarea>
