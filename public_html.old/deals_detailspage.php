          ...
          <div class="middv">
            ...
            <div class="rdv" style="border: solid 0px #006699; width: 49%; float: left; text-align: right; z-index:9999; position:relative;">
            	<img src="<?php echo $strHostName;?>/images/share_btn.png" alt="" title="">
								  <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $strHostName;?>/deals_detailspage.php?cid=<?php echo $_GET['cid'];?>&cateid=<?php echo $_GET['cateid'];?>&t=<?php echo $meta_title?>" target="_blank"><img src="<?php echo $strHostName;?>/images/facebook_btn.png" alt="" title=""></a>
