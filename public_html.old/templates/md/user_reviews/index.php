                        ...
                        <table border="0" cellpadding="0" cellspacing="0" style="width:1000px;">
                           ...
                           <tr>
                            ...
                            <td class="lightInboxbg5">
                            	  <a onClick="javascript:View_Reviews('<?php echo $get_array['user_id']; ?>','<?php echo $get_array['comment']; ?>');" style="cursor:pointer; font-size:13px; text-transform:none" > <?php echo truncate($get_array['comment'],50);?> </a></td>
