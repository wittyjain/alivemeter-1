...
function ApproveComment()
{
	...
	if(confirm ("Are you sure want to approve selected comments?"))
	{
		...
		//alert("<?php echo $strHostName; ?>/includes/approve_comment.inc.php?cmtid="+cmtid+"&artid="+artid+"&type=Approve");
		xmlhttp.open("GET","<?php echo $strHostName; ?>/includes/approve_comment.inc.php?cmtid="+cmtid+"&artid="+artid+"&type=Approve", true);
		xmlhttp.send();
	}
	else
	{
...
function Delete_Comments_By_Id()
{
	...
	if(confirm ("Are you sure want to delete selected comments?"))
	{
		...
		xmlhttp.open("GET","<?php echo $strHostName; ?>/includes/delete_comment.inc.php?cmtid="+cmtid+"&type=Approve", true);
		xmlhttp.send();
	}
	else
	{
  ...
  <div class="dvFloat">
	...
	<div  style="width:99%; border:solid 0px red;">
                 <div class="dvFloat formpadding1" style="padding-top:20px">
                    ...
                    <div class="formcontrol2" style="padding-left:0px; padding-bottom:10px; ">
                      <label class="formcontrol2">
                      	 <div style="float:left; width:200px; margin-right:5px;"><a href="<?php echo $strHostName;?>/page.php?dir=master/comments/view" class="button2" style="width:180px;">Approved Comments</a></div>
                         <div style="float:left; width:200px;"><a href="<?php echo $strHostName;?>/page.php?dir=master/unapp_comments/view" class="button2" style="width:180px; background-color:#009999;">Unapproved Comments</a></div>
                     </label>
                    </div>
                  		...
                  		<table cellpadding="0" cellspacing="0"  style="width:100%;float:left;" >
                              ...
                              <?php $retrive_Array=$get_retrive->GetPostCommentUnapproved()  ?>
                              <?php  
							  $i=0;
							  $i=$i+1;
                              ...
                              <tr id="tr_post_comment_<?php echo $get_array['post_comment_id']*121?>">
                                 ...
                                 <td class="tdborder" style="padding-left:20px;">
                                 	<?php /*?><input type="checkbox" name="chkApproval" id="chkApproval<?php echo $i?>" <?php if($get_array['approved']=="1") { echo "checked";}?> /><?php */?>
                                      ...
                                      <input type="hidden" id="txtCommentid<?php echo $i?>" name="txtCommentid<?php echo $i?>" value="<?php echo $get_array['post_comment_id']?>" style="width:20px;"/>
                                        <input type="hidden" id="txtArticleid<?php echo $i?>" name="txtArticleid<?php echo $i?>" value="<?php echo $get_array['article_id']?>" style="width:20px;"/>
                                 </td>
                                ...
                                <table cellpadding="0" cellspacing="0"  style="width:100%" >
                                    <tr>
                                       ...
                                       <td class="SubTd2">
                                      	 <input type="checkbox" name="chkDelete" id="chkDelete<?php echo $i?>"/>
                                       </td>
                                       
                                       
                                       <!--<td class="SubTd2"><a  style="cursor:pointer;" onclick="javascript:Comments_Delete_By_Id('<?php echo $converter->encode($get_array['post_comment_id'])?>','<?php echo $get_array['post_comment_id']*121?>')"><img src="images/register_steps/delete_icon.jpg" alt=""></a></td>-->
                                    </tr>
                                  </table></td>
                              ...
                              <input type="hidden" id="txtCmtCount" name="txtCmtCount" value="<?php echo $i?>"/>
                                  ...
                                  <?php 
								  	$total_app_cmt=GetValue("select Count(*) as col from tbl_post_comment where approved=0", "col");
									echo $total_app_cmt;
								  ?>
                                </div>
                               <div class="formcontrol2" style="width:300px; float:right; padding:15px 0;">   
                                    <a  onclick="javascript:Delete_Comments_By_Id()"  style="float:right; width:80px; font-size:14px; text-align:center;padding:5px 0px;" class="button">Delete</a>
                                    <a name="btnSubmit" id="btnSubmit" class="button" onclick="javascript:ApproveComment();" style="float:right; width:80px; font-size:14px; text-align:center; padding:5px 0;  margin-right:10px; ">Submit </a>
