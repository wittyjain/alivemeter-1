...
//	echo $checkPassSql;
	...
	if($check > 0){
		...
		//$result = mysql_query($updatePassSql);
			#################################################################
				...
				$string=$string."</tr>";
				$string=$string."<tr>";
				$string=$string."<td style='padding:0 15px 15px 15px; color:#000000; font-size:13px; line-height:18px;'>We have ".$family_mem_count." accounts aligned to your email ID and find below details of all the accounts:</td>";
				$string=$string."</tr>";
				$string=$string."<tr>";
	...
	{
		AlertandRedirect('Provided Email ID is not available in database.', "page.php?dir=account/forgot_password");
	}
