    ...
    <div class="dvWrapper">
      <div style=" padding:0px 0px 35px 0px">
          ...
          <div style="padding:25px 0px 25px 0px">
            <div class="DvFloat" style="padding-bottom:50px;padding-left: 0px;margin-left: -5px;">
              <div class="TabDv">
                <div>
                  <ul id="tabstabs" class="shadetabs">
                    <li class="selected"><a href="<?php echo $strHostName;?>/page.php?dir=health/lab_report" class="selected"> Lab Reports </a></li>
                ...
                <div class="TabContentDetails" style="display:'';">
                    ...
                    <div class="DvFloat" style="padding:10px 0px">
                      ...
                      <div class="dvFloat formpadding1" id="dvLabReport" style="border-bottom: solid 0px #e1e1e1;">
                        <?php
						...
						$retrive_Array=$get_retrive->Get_Lab_Report($parent_id,$page_count);
						...
						$pagingLink = getPagingLinkBackEndFrontEnd($nume,$page_count,'dir=health/lab_report',$newpagenumber,$strHostName."/page.php");
					?>
					...
					else
					{
                     ...
                     <?php } ?>
                      ...
                      <div id="divShowHideForm" style="display: none">
                        <div class="dvFloat formpadding1">
                          ...
                          <div class="formcontrol2">
                           <input type="text" name="txt_Test_Name" id="txt_Test_Name" value="" style="width: 207px;" />
                            ...
                            <input id="cmb_Prescription_Reports_Doc_pres" name="cmb_Prescription_Reports_Doc_pres" value="2" type="hidden"/>
                          </div>
                        </div>
                        <div class="dvFloat formpadding1">
                          <div class="formlabel1">
                        ...
                        <div class="dvFloat formpadding1">
                          <div class="formlabel1">
                            <label class="formlabel1">Lab Results of test prescribed by doctor</label>
                          </div>
                          <div class="formcontrol2">
          ...
          <div id="dvViewFile" name="dvViewFile" style="display:none; width:800px; padding-top:0px; float:left; margin-left:250px; text-align:left; margin-top:-25px;"><a id="aViewFile" name="aViewFile" target="_blank">View File</a>
                    <img src="<?php echo $strHostName;?>/images/loading.gif" style="display:none; margin-top:-10px;" id="imgLoader"  />
                        ...
                        <div class="dvFloat formpadding1"  style="padding:10px 0px 25px 0px; border-bottom:solid 0px #e1e1e1">
