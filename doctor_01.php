                	...
                	<div class="DvFloat">
                    	<div class="DvFloat">
                            ...
                            <div class="nutritionistright">
                            	<div class="DvFloat">
                                	<div class="DvFloat f_grey" style="font-size: 18px;">Welcome! Dr. Abcd Efghyt</div>
                                    <div class="f_grey welcomedv">
                                        ...
                                        <div class="DvFloat" style="padding: 20px 0px;"><div style="width:312px; height:30px; float:left;"> <a href="#" class="button" style="text-align:center; padding: 0px 25px 0px 20px;" onClick="showform();">CLICK HERE TO GET QUERIES</a></div></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
</section><div id="divShowHideForm" style="display: none">
  <section>
  <div class="cal_full_size">
    <div class="cal_12 m_outo">
      <div class="dvFloat">
        <div class="dvWrapper">
          <div class="DvFloat" style="padding-top:70px;border-top: solid 3px #990033">
          	<div class="adviceonline_md">
                <div class="photoareabg">
          ...
          <div style="width:100%; border:solid 0px red;">
            <div class="dvFloat formpadding1" style="padding-top:0px;">
              ...
              <div class="formcontrol21" style="padding-top: 7px;"> Fresh </div>
            </div>
            <div class="dvFloat formpadding1">
              <div class="formlabel1">
                <div style="padding-left: 10px; float: left;">Body Area</div>
              </div>
              <div class="formcontrol21" style="padding-top: 7px;">Abdomen &amp; Pelvis</div>
            </div>
            <div class="dvFloat formpadding1">
              <div class="formlabel1">
                <div style="padding-left: 10px; float: left;">Complaint</div>
              </div>
              <div class="formcontrol21" style="padding-top: 7px;">This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non  mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris in erat justo. Nullam ac urna eu felis dapibus </div>
            </div>
            <div class="dvFloat formpadding1">
              <div class="formlabel1">
                <div style="padding-left: 10px; float: left;">Symptoms </div>
              </div>
              <div class="formcontrol21" style="padding-top: 7px;">Bleeding sore      Burning pain       Arm numbness       Bleeding mole or sore      Bone pain      
            ...
            <div class="dvFloat formpadding1">
              ...
              <div class="formcontrol21" style="padding-top: 7px;">Frequently</div>
            </div>
            <div class="dvFloat formpadding1">
              <div class="formlabel1">
            ...
            <div class="dvFloat formpadding1">
              ...
              <div class="formcontrol21" style="padding-top: 7px;">Sahana shetty</div>
            </div>
            <div class="dvFloat formpadding1">
              <div class="formlabel1">
                <div style="padding-left: 10px; float: left;">Doctor Comment</div>
              </div>
              <div class="formcontrol21" style="padding-top: 7px;">Take the previous prescribed medicene on time</div>
            </div>
            <div class="dvFloat formpadding1">
              <div class="formlabel1">
            ...
            <div class="DvFloat">
              <div class="DvFloat">
                ...
                <div class="DvFloat" style="padding: 15px 0px; border-bottom: solid 1px #c5c5c5;">
                  ...
                  <tr>
                    <td class="nutri_dailyreport_box1"><span class="f_grey" style="font-size: 13px;">Blood Pressure</span></td>
                    <td class="dailyreport_sep"></td>
    ...
    position: absolute;"></div>
                  ...
                  <tr>
                    <td class="nutri_dailyreport_box1"><span class="f_grey" style="font-size: 13px;">Fasting Blood Sugar</span></td>
                    <td class="dailyreport_sep"></td>
    ...
    position: absolute;"></div>
                  ...
                  <tr>
                    <td class="nutri_dailyreport_box1"><span class="f_grey" style="font-size: 13px;">Blood Sugar After Meal (PPBS)</span></td>
                    <td class="dailyreport_sep"></td>
    ...
    position: absolute;"></div>
                  ...
                  <tr>
                    <td class="nutri_dailyreport_box1"><span class="f_grey" style="font-size: 13px;">Random Blood Sugar</span></td>
                    <td class="dailyreport_sep"></td>
    ...
    position: absolute;"></div>
                  ...
                  <tr>
                    <td class="nutri_dailyreport_box1"><span class="f_grey" style="font-size: 13px;">Urine Blood Sugar </span></td>
                    <td class="dailyreport_sep"></td>
    ...
    position: absolute;"></div>
                  ...
                  <tr>
                    <td class="nutri_dailyreport_box1"><span class="f_grey" style="font-size: 13px;">Cholesterol </span></td>
                    <td class="dailyreport_sep"></td>
    ...
    position: absolute;"></div>
                  ...
                  <tr>
                    <td class="nutri_dailyreport_box1"><span class="f_grey" style="font-size: 13px;">Triglyceride</span></td>
                    <td class="dailyreport_sep"></td>
                  ...
                  <tr>
                    <td class="nutri_dailyreport_box1"><span class="f_grey" style="font-size: 13px;">HDL</span></td>
                    <td class="dailyreport_sep"></td>
                  ...
                  <tr>
                    <td class="nutri_dailyreport_box1"><span class="f_grey" style="font-size: 13px;">LDL</span></td>
                    <td class="dailyreport_sep"></td>
                  ...
                  <tr>
                    <td class="nutri_dailyreport_box1"><span class="f_grey" style="font-size: 13px;">Cigerette</span></td>
                    <td class="dailyreport_sep"></td>
                  ...
                  <tr>
                    <td class="nutri_dailyreport_box1"><span class="f_grey" style="font-size: 13px;">Beer</span></td>
                    <td class="dailyreport_sep"></td>
                  ...
                  <tr>
                    <td class="nutri_dailyreport_box1"><span class="f_grey" style="font-size: 13px;">Spirit</span></td>
                    <td class="dailyreport_sep"></td>
          ...
          <div style="float:left; width:450px; border:solid 0px red;">
            ...
            <div class="DvFloat">
              ...
              <div style="float:left">
                <select id="lipid_Triglyceride1" name="lipid_Triglyceride1" class="existing_event" tabindex="1" title="" style="width: 95px;">
      ...
      <td valign="top" align="center" style="padding: 10px 10px 10px 10px;"><div class="DvFloat">
          <div class="dvWhitePopup_Box">
            <table cellpadding="0" cellspacing="0" style="width:90%; border:solid 0px #000000">
              ...
              <tr>
                <td  style="text-align:center; padding:0px 10px;vertical-align:middle"><div style=" width:250px; height:20px; float:left;padding-right:10px; font-size:13px;"> <a href="doctor_01.html" class="button" style="font-size:13px; line-height:25px">Click here to get queries</a></div>
              <div style=" width:180px; height:30px; float:left;padding-right:10px;"> <a href="#" class="button2" style="font-size:13px;" >view old queries</a></div>
              <div style=" width:100px; height:30px; float:left;padding-right:10px;"> <a href="doctor_01.html" class="button2" style="font-size:13px;">cancel</a></div></td>
