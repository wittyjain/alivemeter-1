...
<?php
	...
	/*for jupiter asia use */
	 $strHostName = "http://".$_SERVER['SERVER_NAME']."/~alivemeter/nutrion";


	$SiteTitle="Shoppingcart";
	$strPageTitle = "nutrion";
...
<?php
	...
	function GetPageName() {
		$pagename = str_replace("nutrion/", "", $_SERVER['SCRIPT_NAME']);
	...
	function uploadFile($inputName, $uploadDir, $random) {
		move_uploaded_file($_FILES[$inputName]['tmp_name'], $uploadDir.$random."_".$_FILES[$inputName]['name']);
	}
