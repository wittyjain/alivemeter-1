        ...
        <div class="dvWrapper">
          <div style=" padding:35px 0px 35px 0px">
            <div class="health_dashboard_div_left">
              ...
              <div class="dvFloat">
                <div style="float:left; padding:0px 0px 10px 0px;"> <a href="nutritionist_daily_tracking.html"><img src="images/nutritionist/daily_tracking_h.jpg" alt=""></a> </div>
              </div>
              <div class="dvFloat">
                                                	<div style="float:left; padding:0px 0px 10px 0px;">
                                                    	<a href="nutritionist_allergies.html"><img src="images/nutritionist/allergies.jpg" alt=""></a>
                                                    </div>
                                                </div>
              <div class="dvFloat">
              ...
              <div  style="width:99%; border:solid 0px red;">
                <div class="dvFloat">
                  <div class="formlabel1">
                    ...
                    <h2 class="Tab_Title">daily tracking</h2>
                    </label>
                  </div>
