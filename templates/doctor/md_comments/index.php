...
<?php
	...
	$pagingLink = getPagingLinkBackEndFrontEnd($nume,$page_count,'dir=doctor/md_comments&patient_id='.$_GET['patient_id'].'',$newpagenumber,$strHostName."/page_doctor.php");
...
<center>
  ...
  <div class="DvFloat" style="margin-bottom:30px;">
          ...
          <tbody>
            ...
            <?php 
			$page=1;$page_count=100;$newpagenumber="2"; $nume="0";
