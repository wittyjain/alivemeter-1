...
{ 
	document.getElementById('ShowPatientDiv1').style.display = 'block';
	
	document.getElementById('HidePatientDivLink').style.display = ''; 
	
	document.getElementById('ShowPatientDivLink').style.display = 'none'; 
	
	
	
}

function showPatientCancel()
{ 
	document.getElementById('ShowPatientDiv1').style.display = 'none'; 
	
		document.getElementById('ShowPatientDivLink').style.display = ''; 
	
		document.getElementById('HidePatientDivLink').style.display = 'none'; 
  ...
  <div class="top_ou">
    <div class="top_in">
      ...
      <div class="DvFloat" style="border-bottom: solid 1px #c5c5c5; padding-top:20px; float:left;">
            	<div style="width: 50%; float: left; margin-bottom: 0px;"><h1 class="f_red" style="text-align: left; font-size: 18px;  margin-bottom: 7px; font-weight:bold; ">USER DETAILS</h1></div>
                <div style="width: 50%; float: right; text-align: right; margin-bottom: -3px;">
           	    	<div style=" width:190px; height:20px; float:right;"> <a href="<?php echo $strHostName?>/page_doctor.php?dir=doctor/client" class="buttonreset" style="text-align:center">BACK TO Clients</a></div>
                </div>
            </div>
            
        <?php include "includes/patient_details.inc.php";?>
       
        <div class="DvFloat" style="border-bottom: solid 1px #e4e4e4;border-top: solid 0px #e4e4e4; margin:15px 0px 30px 0px;">
          <a  onClick="showpatientform();" style="cursor:pointer"><img src="images/nutritionist/add_12.png" alt="" title="" border="0" style="float:left; margin-right:10px; margin-top: 7px; vertical-align: middle;"  id="ShowPatientDivLink"></a>
                             <a  onClick="showPatientCancel();" style="cursor:pointer">
                    	<img src="images/nutritionist/add_11.png" alt="" title="" border="0" style="float:left; margin-right:10px; margin-top: 7px; vertical-align: middle; display:none;"  id="HidePatientDivLink">
                    </a>
          <h1 class="f_red" style="text-align: left; font-size: 18px; font-weight:bold;  margin: 7px;">Patient Complete Details</h1>
        </div>
        
        <div class="DvFloat" id="ShowPatientDiv1" style="display:none;">
