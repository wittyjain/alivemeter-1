        ...
        <div class="DvFloat" style="padding-bottom:20px; font-size:15px;">
           ...
           <div class="DvFloat" style="border: solid 0px #0066CC;">
            <ul id="countrytabs" class="shadetabs" style="margin-left:-5px;">
              <li><a href="<?php echo $strHostName;?>/page.php?dir=hospital/details&hospital_id=<?php echo $_GET['hospital_id']?>" rel="country3" style="width:250px;"  class="selected">Doctor</a></li>
            ...
            <div style="border: 0px solid gray; width: 965px; float: left; margin-bottom: 1em; padding: 10px 0px; background-color: #FFFFFF; color: #666666;">
               <div class="dvFloat"> 
              	<table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <?php  
						$query = "SELECT * FROM  ".Doctor." where isactive=1 and isdeleted=0 and type='Doctor' and user_type='Admin' and hospital_name=".$hospital_id;
                       ...
                       <tr>
                              ...
                              <td class="tdborder" style="padding:10px 20px 5px 20px;">
                              	<table width="100%" border="0" cellspacing="0" cellpadding="0" style="line-height:20px;">
                                      <?php
									  	$accepted_count = $db->select("SELECT * FROM  ".Patients." where isactive=1 and isdeleted=0 and doctor_id=".$row['doctor_id']); 
                     ...
                     <?php } } else { ?>
                      	<tr>
                        	<td colspan="6" style="padding:10px; color:red;">Doctor is not available in <?php echo $hospital_name;?></td>
                        </tr>
                      <?php }} ?>
