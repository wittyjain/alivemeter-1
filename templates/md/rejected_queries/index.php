...
?>
  <?php 
                                $query_count=$get_retrive->GetRejectedQueriesMDCount();
								$retrive_Array=$get_retrive->GetRejectedQueriesMD();
                                //Alert ($query_count);
                            ?>
