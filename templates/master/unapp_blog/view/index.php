...
function UnApproveComment()
{
	...
	if(confirm ("Are you sure want to approve selected comments?"))
	{
		...
		xmlhttp.open("GET","<?php echo $strHostName; ?>/includes/approve_blog.inc.php?cmtid="+cmtid+"&type=Approve", true);
		xmlhttp.send();
	}
	else
	{
...
function Delete_Blog_By_Id()
{
	...
	if(confirm ("Are you sure want to delete selected comments?"))
	{
		...
		xmlhttp.open("GET","<?php echo $strHostName; ?>/includes/delete_blog.inc.php?cmtid="+cmtid+"&type=Approve", true);
		xmlhttp.send();
	}
	else
	{
  ...
  <div class="dvFloat">
	...
	<div  style="width:99%; border:solid 0px red;">
                 <div class="dvFloat formpadding1" style="padding-top:20px">
                    ...
                    <div class="formcontrol2" style="padding-left:0px; padding-bottom:10px; ">
                      <label class="formcontrol2">
                      	 <div style="float:left; width:200px; margin-right:5px;"><a href="<?php echo $strHostName;?>/page.php?dir=master/blog/view" class="button2" style="width:180px;">Approved Blogs</a></div>
                         <div style="float:left; width:200px;"><a href="<?php echo $strHostName;?>/page.php?dir=master/unapp_blog/view" class="button2" style="width:180px;  background-color:#009999;">Unapproved Blogs</a></div>
                     </label>
                    </div>
                  		...
                  		<table cellpadding="0" cellspacing="0"  style="width:100%;float:left;" >
                              <tr>
                               ...
                               <?php $retrive_Array=$get_retrive->GetBlogUnapproved()  ?>
                              <?php  
							  $i=0;
							  $i=$i+1;
                              ...
                              <input type="hidden" id="txtCmtCount" name="txtCmtCount" value="<?php echo $i?>"/>
                               <div class="formcontrol2" style="width:400px; float:left; padding:15px 0;">   
                                  ...
                                  <?php 
								  	$total_app_cmt=GetValue("select Count(*) as col from tbl_blog where approved=0", "col");
									echo $total_app_cmt;
								  ?>
                                </div>
