...
function UnBlogComment()
{
	...
	if(confirm ("Are you sure want to unapprove selected comments?"))
	{
		...
		xmlhttp.open("GET","<?php echo $strHostName; ?>/includes/approve_blog.inc.php?cmtid="+cmtid+"&type=Unapprove", true);
		xmlhttp.send();
	}
	else
	{
...
function Delete_UnBlog_By_Id()
{
	...
	if(confirm ("Are you sure want to delete selected comments?"))
	{
		...
		xmlhttp.open("GET","<?php echo $strHostName; ?>/includes/delete_blog.inc.php?cmtid="+cmtid+"&type=Unapprove", true);
		xmlhttp.send();
	}
	else
	{
                 ...
                 <div class="dvFloat formpadding1" style="padding-top:20px">
                    <div class="formcontrol2" style="padding-left:0px; padding-bottom:10px; ">
                      <label class="formcontrol2">
                      	 <h2 class="Tab_Title">View Blogs</h2>
                     </label>
                    </div>
                   
                    <div class="formcontrol2" style="padding-left:0px; padding-bottom:10px; ">
                      <label class="formcontrol2">
                      	 <div style="float:left; width:200px; margin-right:5px;"><a href="<?php echo $strHostName;?>/page.php?dir=master/blog/view" class="button2" style="width:180px; background-color:#009999;">Approved Blogs</a></div>
                         <div style="float:left; width:200px;"><a href="<?php echo $strHostName;?>/page.php?dir=master/unapp_blog/view" class="button2" style="width:180px;">Unapproved Blogs</a></div>
                     </label>
                    </div>
                  		...
                  		<table cellpadding="0" cellspacing="0"  style="width:100%;float:left;" >
                              <tr>
                                ...
                                <td class="tbl_head" style="width:40%;">Blogs</td>
                               ...
                               <?php $retrive_Array=$get_retrive->GetBlog()  ?>
                              <?php  
							  $i=0;
							  $i=$i+1;
							  while($get_array = mysql_fetch_array( $retrive_Array )){?>
                              <tr id="tr_post_comment_<?php echo $get_array['blog_id']*121?>">
                               ...
                               <td class="tdborder" style="padding-left:20px;"><?php echo $get_array['title']?> </td>
                                 ...
                                 <?php /*?>	<input type="checkbox" name="chkApproval" id="chkApproval<?php echo $i?>" <?php if($get_array['approved']=="1") { echo "checked";}?> /><?php */?>
                                    ...
                                    <input type="checkbox" name="chkApproval" id="chkApproval<?php echo $i?>"/>
                                      ...
                                      <input type="hidden" id="txtCommentid<?php echo $i?>" name="txtCommentid<?php echo $i?>" value="<?php echo $get_array['blog_id']?>" style="width:20px;"/>
                                 </td>
                                <td class="tdborder" style="padding-left:10px;">
                                <table cellpadding="0" cellspacing="0"  style="width:100%" >
                                    <tr>
                                     <td class="SubTd2"><a  style="cursor:pointer;" href="<?php echo $strHostName;?>/write_a_blog.php?cid=<?php echo $converter->encode($get_array['blog_id'])?>" target="_blank"><img src="images/register_steps/view_icon.jpg" alt=""></a></td>
                              ...
                              <input type="hidden" id="txtCmtCount" name="txtCmtCount" value="<?php echo $i?>"/>
                               <div class="formcontrol2" style="width:400px; float:left; padding:15px 0;">   
                                  ...
                                  <?php 
								  	$total_app_cmt=GetValue("select Count(*) as col from tbl_blog where approved=1", "col");
									echo $total_app_cmt;
								  ?>
                                </div>
                                  ...
                                  <div class="formcontrol2" style="width:300px; float:right; padding:15px 0;">   
                                    <a  onclick="javascript:Delete_UnBlog_By_Id()"  style="float:right; width:80px; font-size:14px; text-align:center;padding:5px 0px;" class="button">Delete</a>
                                    <a name="btnSubmit" id="btnSubmit" class="button" onclick="javascript:UnBlogComment();" style="float:right; width:80px; font-size:14px; text-align:center; padding:5px 0;  margin-right:10px; ">Submit </a>
