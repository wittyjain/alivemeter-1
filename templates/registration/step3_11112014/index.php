              ...
              <div class="ali_div_left">
                <div class="dvFloat formpadding">
                  ...
                  <div class="formcontrol">
                    <select  id="cmb_accountholder" name="cmb_accountholder" class="existing_event" style="width: 192px;" tabindex="1">
                  ...
                  <div class="dvFloat formpadding" style="display:'';">
					...
					<div class="formcontrol">
                        ...
                        <?php } else { ?>
                        	 <input type="text" name="txtMemberProfileID" id="txtMemberProfileID" value="" onblur="javscript:CheckDuplicationMemberUsernameRegistered('0')" >
					...
					<div class="formcontrol">
					  <div class="dvFloat" style=" border: solid 0px #006633;">
						<div style="float:left; padding:0px 14px 0px 0px; border: solid 0px #006633;">
						  <select name="cmb_Date" id="cmb_Date" class="existing_event" style="width: 18px;" tabindex="3" >
						...
						<div style="float:left; padding:0px 13px 0px 0px">
						  <select id="cmb_Month" name="cmb_Month"  title="" class="existing_event" style="width: 18px;" tabindex="3" >
						...
						<div style="float:left; padding:0px 0px 0px 0px">
						  <select name="cmb_Year" id="cmb_Year"  title="" class="existing_event" style="width: 26px;" tabindex="3" >
				  ...
				  <div class="dvFloat formpadding">
					...
					<div class="formcontrol">
					  <div style="float:left; padding:0px 15px 0px 0px">
						<input type="text" name="txt_Mobile_code" id="txt_Mobile_code" value="<?php echo  $m_std_code?>"  placeholder="+91" style="width:30px"  maxlength="3">
					  </div>
					  <div style="float:left; padding:0px 0px 0px 0px">
						<input type="text" name="txt_Mobile_no" id="txt_Mobile_no" value="<?php echo $mobile?>"  placeholder="" style="width:172px"  maxlength="12">
					  </div>
                  ...
                  <div class="formcontrol">
                  	<input type="password" name="txtPassword" id="txtPassword" value="<?php echo $converter->decode($password)?>"  />
