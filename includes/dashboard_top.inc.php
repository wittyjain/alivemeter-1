        ...
        <div class="cal_12">
          <div class="DvFloat" style="padding-top: 2px;">
            ...
            <div class="hw_whitebg_title">
              <div class="contact_green_icon"><a href="<?php echo $strHostName;?>/page.php?dir=inbox/view_mails&status=inbox&folderid=<?php echo $converter->encode($inbox_id)?>"  style="border:solid 0xp red;"><img src="images/contact_greenblue_icon.png" alt="" title="" border="0"></a></div>
